var compassDatatable = compassDatatable || (function(){
		return {
			construct : function(tableClass, fileName, isExportable,moduleCode,columnDetails,resetColumnFlag,numberOfFreezedColumn){
				...
				tableColNames += "<div class='dropdown-menu resetAndIndexingColumnDiv' ><table width='100%' style='margin-right: 15px;'><tr width='100%'><td class='resetColsDiv' width='50%'><ul class='compassResetCols' >";
