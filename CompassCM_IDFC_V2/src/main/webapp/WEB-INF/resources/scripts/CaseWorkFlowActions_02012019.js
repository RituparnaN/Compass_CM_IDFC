	...
	return {
		...
		closeWithSTR : function(tableParentDivId, divId){
		   ...
		   // var url = "/amlCaseWorkFlow/addViewComments?CaseNos="+selectedCase+"&CaseStatus=6&FlagType=Y&formId="+formId;
			...
			var flagType = "Y";
			var url = "/amlCaseWorkFlow/getCaseWorkflowModuleDetails?moduleCode="+moduleCode+"&moduleHeader="+moduleHeader+"&moduleValue="+moduleValue+"&detailPage="+detailPage+"&actionType="+actionType+"&caseStatus="+caseStatus+"&flagType="+flagType+"&formId="+formId;
			caseWorkFlowActions.openModalForCaseWorkFlow("Add Comment For Raise Case "+selectedCase+" For STR", url);
		},
		closeWithoutSTR : function(tableParentDivId, divId){
			...
			var flagType = "Y";
			var url = "/amlCaseWorkFlow/getCaseWorkflowModuleDetails?moduleCode="+moduleCode+"&moduleHeader="+moduleHeader+"&moduleValue="+moduleValue+"&detailPage="+detailPage+"&actionType="+actionType+"&caseStatus="+caseStatus+"&flagType="+flagType+"&formId="+formId;
			caseWorkFlowActions.openModalForCaseWorkFlow("Add Comment For Raise Case  "+selectedCase+" For Without STR", url);
		},
		...
		bonafideOkay : function(tableParentDivId, divId){
			...
			var intSelectedCount = ((selectedCases.split(",").length)-1);
			if(intSelectedCount == 0 ) {
			   alert('Please select atleast one case to mark as bonafide okay');
			   return false;
			}
		...
		raisedForReviewByAMLUser : function(tableParentDivId, divId){
			...
			var intSelectedCount = ((selectedCases.split(",").length)-1);
			if(intSelectedCount == 0 ) {
			   alert('Please select atleast one case to raise for review.');
			   return false;
			} else if(intSelectedCount > 1 ) {
			   alert('Please select only one case to raise for review.');
			   return false;
			}
		...
		raisedForSTRByAMLUser : function(tableParentDivId, divId){
			...
			var intSelectedCount = ((selectedCases.split(",").length)-1);
			if(intSelectedCount == 0 ) {
			   alert('Please select atleast one case to raise for STR.');
			   return false;
			} else if(intSelectedCount > 1 ) {
			   alert('Please select only one case to raise for STR.');
			   return false;
			}
		...
		recommendForSuppressionByAMLUser : function(tableParentDivId, divId){
			...
			var intSelectedCount = ((selectedCases.split(",").length)-1);
			if(intSelectedCount == 0 ) {
			   alert('Please select atleast one case to recommend for suppression.');
			   return false;
			} else if(intSelectedCount > 1 ) {
			   alert('Please select only one case to recommend for suppression.');
			   return false;
			}
		...
		approvedByAMLO: function(tableParentDivId, divId){
			...
			var intSelectedCount = ((selectedCases.split(",").length)-1);
			if(intSelectedCount == 0 ) {
			   alert('Please select atleast one case to approve.');
			   return false;
			} else if(intSelectedCount > 1 ) {
			   alert('Please select only one case to approve.');
			   return false;
			}
		...
		rejectedByAMLO: function(tableParentDivId, divId){
			...
			var intSelectedCount = ((selectedCases.split(",").length)-1);
			if(intSelectedCount == 0 ) {
			   alert('Please select atleast one case to reject.');
			   return false;
			} else if(intSelectedCount > 1 ) {
			   alert('Please select only one case to reject.');
			   return false;
			}
