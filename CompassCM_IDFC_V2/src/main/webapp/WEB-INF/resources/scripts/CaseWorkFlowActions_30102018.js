	...
	return {
		...
		closeWithSTR : function(tableParentDivId, divId){
		   ...
		   // var url = "/amlCaseWorkFlow/addViewComments?CaseNos="+selectedCase+"&CaseStatus=6&FlagType=Y&formId="+formId;
			...
			var url = "/amlCaseWorkFlow/getCaseWorkflowModuleDetails?moduleCode="+moduleCode+"&moduleHeader="+moduleHeader+"&moduleValue="+moduleValue+"&actionType="+actionType+"&detailPage="+detailPage;
		...
		viewComments : function(tableParentDivId, divId){
			...
			var actionType = "";
			var detailPage = "AMLCaseWorkFlow/AddViewCommentsWithHistory";
			var action = "viewComments";
			var url = "/amlCaseWorkFlow/getCaseWorkflowModuleDetails?moduleCode="+moduleCode+"&moduleHeader="+moduleHeader+"&moduleValue="+moduleValue+"&detailPage="+detailPage+"&action="+action;
