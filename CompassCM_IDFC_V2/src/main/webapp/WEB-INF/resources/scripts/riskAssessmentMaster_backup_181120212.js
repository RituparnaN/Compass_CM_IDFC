					...
					categories[category].forEach((subCategory,subCategoryIndex)=>{
						...
						if(fSubCateg == toAddSubCategory){
							...
							var newQuestionObject = {
														...
														"QUESTION":"",
														"INPUTTYPE":"numeric",
														"INPUTOPTIONSLIST":"null^1||null^1||null^1",
														"HASRISKIMPACT":"N",
														"HASPARENT":"N",
														"PARENTQSIDS":"",
														"DISABLED":"N"}
		...
		createInputOptionList: function (optionValues,qId,unqId,category,subCategory){
			if(optionValues == undefined || optionValues.length == 0){
				...
				optionBody += `<table class="table table-striped" id = '`+category+`||`+subCategory+`||`+qId+`||`+`inputOptionsTable'>
									<tr>
										...
										<td width="10%"></td>
										<td width="15%">Impact Criteria</td>
										<td width="30%">
											<select class="form-control input-sm" name = '0||1' onchange = "riskAssessmentMaster.handleOptionsInputChange(this,'`+unqId+`','`+category+`','`+subCategory+`','`+qId+`')") id = '`+category+`||`+subCategory+`||`+qId+`||`+`inputOption1' >
									...
									<tr>
										...
										<td width="15%">Impact Criteria</td>
										<td width="30%">
											<select class="form-control input-sm" name = '1||1' onchange = "riskAssessmentMaster.handleOptionsInputChange(this,'`+unqId+`','`+category+`','`+subCategory+`','`+qId+`')") id = '`+category+`||`+subCategory+`||`+qId+`||`+`inputOption1' >
												<option value = '' >Please Select</option>
												<option value = '1' >Low</option>
												<option value = '2' >Medium</option>
												<option value = '3' >High</option>
									...
									<tr>
										...
										<td width="15%">Impact Criteria</td>
										<td width="30%">
											<select class="form-control input-sm" name = '2||1' onchange = "riskAssessmentMaster.handleOptionsInputChange(this,'`+unqId+`','`+category+`','`+subCategory+`','`+qId+`')") id = '`+category+`||`+subCategory+`||`+qId+`||`+`inputOption1' >
												<option value = '' >Please Select</option>
												<option value = '1' >Low</option>
												<option value = '2' >Medium</option>
												<option value = '3' >High</option>
			...
			optionValues.split("||").forEach((option,i)=>{
				...
				optionBody +=  `<tr>
									...
									<td width="15%">Impact Criteria</td>
									<td width="30%">
										<select class="form-control input-sm" name = '`+i+`||1' onchange = "riskAssessmentMaster.handleOptionsInputChange(this,'`+unqId+`','`+category+`','`+subCategory+`','`+qId+`')") id = "`+qId+`||inputOptionValue`+i+`">
