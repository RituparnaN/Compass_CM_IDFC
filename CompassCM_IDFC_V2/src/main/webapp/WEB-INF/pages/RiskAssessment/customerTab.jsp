	...
	$(document).ready(function() {
		...
		$("#calculateCustomerRisk"+id).click(function(){
			...
			for (var i = 0; i < questionCount; i++) {
				...
				if(multipliedRiskArr[i] != 0){
					answeredQsCount++;
				}
			}
			
			var averageRiskRating = (totalRisk/answeredQsCount).toFixed(2);
			...
			console.log(temp)
			console.log(multipliedRiskArr)
			console.log(totalRisk)
			console.log(CUSTOMER_WEIGHTAGE)
			console.log(provisionalRiskRating)
...
<style>
body:not(.nohover) .customerTabTbody tr:hover {
