			...
			<div class="pull-${dirR} clearfix" style="margin:10px;">
					...
					<div class="btn-group dropdown" role="group">
						...
						<ul class="dropdown-menu" role="menu">
							<li><a href="javascript:void(0)" onclick="caseWorkFlowActions.approvedByMLRO('amlUserPendingCaseSerachResult${UNQID}','${UNQID}')">Approve</a></li>
							<li><a href="javascript:void(0)" onclick="caseWorkFlowActions.rejectedByMLRO('amlUserPendingCaseSerachResult${UNQID}','${UNQID}')">Reject</a></li>
						</ul>
					</div>
