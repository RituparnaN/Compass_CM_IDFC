...
else if(groupCode.contains("AMLUSER")){
	hierarchyCode = 3;
}
else if(groupCode.contains("AMLO")){
	hierarchyCode = 2;
}
else {
	hierarchyCode = 1;
...
<table><tr>
<td>
<b><font face="Arial" color="#ED3237" size="3">Suspicion Indicator&nbsp;*&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</font>
...
<option value='SBRR1'>Confirmed non-suspicious activity</option>
<option value='SBRR2'>Potential laundering attempt but unsuccessful</option>
<option value='SBRR3'>Sniffing activity aimed to test</option>
<option value='SBRR4'>False positive</option>
<option value='SBRR5'>Referred in error</option>
<option value='SBRR6'>Potential suspicion investigated but disproved</option>
<option value='SBRR7'>Suspicion indicated against incorrect party</option>
<option value='SBRR8'>Laundering intention but transaction allowed</option>
<option value='SBRR9'>Potentially non-suspicious</option>
<option value='OTHERS'>Others</option>
</select>
...
<b><font face="Arial" color="#ED3237" size="3">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;High-Risk Reason Code</font>
...
<option value='NUPH'>Suspicion activity not upheld</option>
<option value='FRDP'>Case disproved</option>
<option value='ADIP'>Added against incorrect party</option>
<option value='SBRR1'>Confirmed non-suspicious activity</option>
<option value='SBRR2'>Potential laundering attempt but unsuccessful</option>
<option value='SBRR3'>Sniffing activity aimed to test</option>
<option value='SBRR4'>False positive</option>
...
<form name="form1" id="saveCommentForm" METHOD='POST' target='_self' action="${pageContext.request.contextPath}/amlCaseWorkFlow/saveComments">
