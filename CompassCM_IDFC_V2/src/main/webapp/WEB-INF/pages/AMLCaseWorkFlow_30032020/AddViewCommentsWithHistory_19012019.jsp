	...
	$(document).ready(function(){
	 ...
	 $("#addAlertComments"+id).click(function(){
		...
		$("#saveComments"+id).click(function(){
			...
			else if(userRole == 'ROLE_AMLUSER' || userRole == 'ROLE_AMLUSER1' || userRole == 'ROLE_AMLUSER2' || userRole == 'ROLE_AMLUSER3'){
			...
			else if(userRole == 'ROLE_MLRO' || userRole == 'ROLE_MLRO1' || userRole == 'ROLE_MLRO2'){
												...
												<td width="20%">
													<select class="form-control input-sm" name="amloList" id="amloList${UNQID}" style="width:100%">
													    <c:forEach var="AllUsersListMappings" items="${ALLUSERSLIST}">
															<option value="${AllUsersListMappings.USERCODE1}" <c:if test="${AllUsersListMappings.USERCODE1 eq userCode}">selected="selected"</c:if>>${AllUsersListMappings.USERCODE2}</option>
														</c:forEach>
													</select>
												</td>
											<td colspan="3">&nbsp;</td>
