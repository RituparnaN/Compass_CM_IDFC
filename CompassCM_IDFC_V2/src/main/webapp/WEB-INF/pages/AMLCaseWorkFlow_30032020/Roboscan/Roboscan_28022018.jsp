	...
	$(document).ready(function(){
		 ...
		 $("#collapseAll").click(function(){
			 ...
			 if($(this).attr("rel") == "collapse-in")
			 {
				 ...
				 $(".collapse").arrt("aria-expanded",false);
			 ...
			 else if($(this).attr("rel") == "collapse-out")
		     {
				...
				$(".collapse").arrt("aria-expanded",true);
			...
			<table class="table ">
				<tr>
					...
					<td><img class="pull-right"
						src="${pageContext.request.contextPath}/includes/images/qde/QDE-Logo-Full.png" style="height:50px;margin-top:8px;" alt="QDE"></td>
				</tr>
			</table>
