...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		$(".custom_textbox").keyup(function(){
		 ...
		 //for cloopase and collapse-in for all div together 
	...
	<div class=" col-sm-offset-1 col-sm-10" id="topheader">		
			<table class="table ">
				<tr>
					...
					<td><%-- <img class="pull-right" src="${pageContext.request.contextPath}/includes/images/qde/QDE-Logo-Full.png" style="height:50px;margin-top:8px;" alt="QDE"> --%></td>
				</tr>
			</table>
...
<!-- 		<div class=" col-sm-offset-1 col-sm-10">
 -->		<div style="border:1px solid #337ab7;">
			...
			<hr size="2">
			<b style="margin-left:10px; ">Executive Summary:</b>
	...
	<div class=" col-sm-offset-1 col-sm-10 " style="margin-top:20px;">
		<!-- <div class=" col-sm-offset-1 col-sm-10"> -->
			<div class="col-sm-12 section-heading" data-toggle="collapse" data-target="#customerDetails">
				...
				<span class="pull-right collapse-icon"><i class="collapsable fa fa-chevron-up"></i></span>
			</div>
		...
		<div class="col-sm-12 collapse in" id="realTimeScreening" style="padding-top:10px;">
			...
			<table class="table withOutLineTable">
				<tr>
					...
					<td width="30%"><p>Last transaction update date:</p></td>
			...
			<div >
				<div class="col-sm-6">
					<h4><b>Real Time Screening Search Details:</b></h4>
				</div>
				...
				<table class="table withOutLineTable " width="100%">
					<tr>
						<td width="30%">Name</td>
						<td width="20%"><input class="form-control input-sm" type="text" name="SECTWO_NAME" value="Shinchan San Chao" value="${SECTION_TWO['SECTWO_NAME']}"/></td>
				...
				<div class="col-sm-12">
					<h4><b>Real Time Screening Result Details:</b></h4>
			...
			<div id="transactiondetails" class="col-sm-12 collapse in" style="padding-top:10px;">
				<table class="table no-border">
					<tr>
						...
						<td width="30%"><input class="form-control input-sm datepicker" type="text" name="SECTHREE_TXN_DATE" value="${SECTION_THREE['SECTHREE_TXN_DATE']}" /></td>
						<td width="20%">Value:</td>
						<td width="30%"><input class="form-control input-sm" type="text" name="SECTHREE_VALUE" value="${SECTION_THREE['SECTHREE_VALUE']}" /></td>
					</tr>
