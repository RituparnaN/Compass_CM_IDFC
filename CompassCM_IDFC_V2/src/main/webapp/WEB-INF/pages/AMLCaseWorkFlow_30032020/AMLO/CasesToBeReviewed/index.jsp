			...
			<div class="pull-${dirR} clearfix" style="margin:10px;">
					...
					<div class="btn-group dropdown" role="group">
						...
						<ul class="dropdown-menu" role="menu">
							<li><a href="javascript:void(0)" onclick="caseWorkFlowActions.okayByAMLO('amlUserPendingCaseSerachResult${UNQID}','${UNQID}')">Review found to be ok</a></li>
							<li><a href="javascript:void(0)" onclick="caseWorkFlowActions.toBeReviewedByAMLO('amlUserPendingCaseSerachResult${UNQID}','${UNQID}')">Re-open Case</a></li>
						</ul>
					</div>
