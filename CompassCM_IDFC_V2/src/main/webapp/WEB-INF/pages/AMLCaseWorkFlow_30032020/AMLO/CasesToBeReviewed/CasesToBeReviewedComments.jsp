					...
					<tr>
						...
						<td width="30%">
							...
							<c:if test="${action eq 'toBeReviewedByAMLO'}">
								<option value="INADEQUATE_REVIEW_CLOSURE_COMMENTS">Inadequate Review/ Closure Comment</option>
								<option value="BUSINESS_RESPONSE_TO_BE_OBTAINED">Business response to be obtained</option>
								<option value="OTHERS">Others</option>
							</c:if>
							<c:if test="${action eq 'okayByAMLO'}">
								<option value="FOUND_TO_BE_OKAY">Found to be Okay</option>
								<option value="OTHERS">Others</option>
							</c:if>
							</select>
						</td>
