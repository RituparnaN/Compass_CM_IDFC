...
<div class="row compassrow${UNQID}">
	<div class="col-sm-12">
		<div class="card card-primary panel_amlUserPendingCase">
			...
			<input type="hidden" name="bottomPageUrl" value="AMLCaseWorkFlow/AMLO/ClosedCasesBySelf/SearchBottomPage">
		...
		<div class="card card-primary" id="amlUserPendingCaseSerachResultPanel${UNQID}" style="display: none;">
			...
			<div class="card-footer action-footer clearfix">
				<div class="pull-${dirR} clearfix">
					...
					<!-- <button type="button" class="btn btn-primary btn-sm" id="assignToBranchUse${UNQID}r">Assign To BranchUser</button>-->
