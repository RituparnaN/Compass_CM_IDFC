		...
		<div class="card card-primary" id="amlUserClosedCaseSerachResultPanel${UNQID}" style="display: none;">
			...
			<div class="card-footer action-footer clearfix">
				<div class="pull-${dirR} clearfix">
					...
					<!--
					<button type="button" class="btn btn-primary btn-sm" onclick="caseWorkFlowActions.reAssignBackToUser('amlUserClosedCaseSerachResult${UNQID}','${UNQID}')">ReAssign To AMLUser</button>
					-->
					<button type="button" class="btn btn-primary btn-sm" onclick="caseWorkFlowActions.reAssignToAMLUSER('amlUserClosedCaseSerachResult${UNQID}','${UNQID}')">ReAssign To AMLUser</button>
