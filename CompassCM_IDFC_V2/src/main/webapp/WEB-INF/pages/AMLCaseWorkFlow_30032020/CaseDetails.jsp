...
<script type="text/javascript">
	...
	/* function openAlertTransactions(elm){
		...
		var url = "${pageContext.request.contextPath}/amlCaseWorkFlow/getLinkedTransactionsForAlerts?alertNo="+alertNo;
		window.open(url,'Alerted Transaction Details','height=500px,width=1200px');
