			...
			<div class="panelSearchForm">
				<table class="table table-striped compassModuleDetailsSearchTable${UNQID}" style="margin-bottom: 0px;">
					<tr>
						...
						<td width="25%">
							<select class="form-control input-sm" name="fraudIndicator" id="fraudIndicator${UNQID}" style="width:200px;">
								<!--
								...
								<option value="HSCOR">High Alert ScoreCard</option>
								-->
								<option value="BONAFIDE_OK">Bonafide Ok</option>
								<option value="CASE_CLOSED_WITH_STR">Case Closed With STR</option>
								<option value="CASE_CLOSED_WITH_BRANCH_INVESTIGATION">Case Closed With Branch Investigation</option>
...
<div class="card-footer clearfix">
	<div class="pull-${dirR}">
		...
		<input  type="button" id="saveComments${UNQID}" class="btn btn-success btn-sm" onclick="saveComments()" value="Post">
		<%} %>
		<input type="button" id="closeAddViewCommentsModal${UNQID}" class="btn btn-danger btn-sm" value="Close Window"/>
	</div>
</div>
</form>
<form name="form1" id="saveCommentForm" method='POST' action="${pageContext.request.contextPath}/amlCaseWorkFlow/saveOtherComments">
