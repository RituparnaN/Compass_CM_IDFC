									...
									<tr>
										...
										<td width="17%">
											<label for="REPORT_TYPE_FATCA4">
												Amended report <input type="checkbox" id="F1042S_AMENDEDREPORT" name="F1042S_AMENDEDREPORT" value="1024S_AMENDED"
												<% if("1024S_AMENDED".equals(formData.get("F1042S_AMENDEDREPORT"))){ %> checked="checked" <%} %>/>
											</label>
										</td>
										<td width="49%">
				...
				<table class="table">
					...
					<tr>
						<td colspan="5">
							...
							<input type="radio" class="input-sm form-control" id="F1042S_CHAPTER3INDICATOR" name="F1042S_CHAPTERINDICATOR" value="3"
							<%if("3".equals(formData.get("F1042S_CHAPTERINDICATOR"))){ %> checked="checked" <%} %>/>
							or "4"
							<input type="radio" class="input-sm form-control" id="F1042S_CHAPTER4INDICATOR" name="F1042S_CHAPTERINDICATOR" value="4"
							<%if("4".equals(formData.get("F1042S_CHAPTERINDICATOR"))){ %> checked="checked" <%} %>/>)
					...
					<tr>
						...
						<td colspan="2">
							...
							<input type="checkbox" class="input-sm form-control" id="F1042S_NOTAX_DEPOSIT" name="F1042S_NOTAX_DEPOSIT" value="NOTAX_DEPOSITED" 
					...
					<tr>
						<td colspan="2">
							...
							<input type="checkbox" class="input-sm form-control" id="F1042S_PRORATA" name="F1042S_PRORATA" value="PRORATA" 
