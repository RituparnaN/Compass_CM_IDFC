			...
			<form action="javascript:void(0)" method="POST" id="searchMasterForm${UNQID}">
				<table class="table compassModuleDetailsSearchTable${UNQID}" style="margin-bottom: 0px;">
					<tr>
						...
						<td width="30%">
							<select class="form-control input-sm" id="mappingType" name="mappingType" style="width: 100%;">
						...
						<td width="30%">
							<select class="form-control input-sm" id="userLevel" name="userLevel" style="width: 100%;">
								<option value="ALL">ALL</option>
						...
						<tr id = "userListFields" style="display: none;">
							...
							<td width="30%">
								<select class="form-control input-sm" id="userList" name="userList" style="width: 100%;">
