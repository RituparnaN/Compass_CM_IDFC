...
$(document).ready(function(){
	$("#approveUserSearch").click(function(){
		...
		if(userDetails != ""){
			...
			$.ajax({
	    		url : "${pageContext.request.contextPath}/cmUAMChecker/getUserDetailsForChecker?userDetails="+userDetails,
	    		cache : false,
	    		type : 'POST',
	...
	<div class="col-sm-12">
		<div class="card card-primary">
			...
			<div class="card-search-card">
				<table class="table table-striped formSearchTable approveUserTable" style="margin-bottom: 0px;">
					<tbody>
						<tr>
			...
			<div class="card-footer clearfix">
				<div class="pull-${dirR}">
					<a href="javascript:void(0)" id="approveUserSearch" class="btn btn-primary btn-sm">Search</a>
				</div>
			</div>
		</div>
	</div>
