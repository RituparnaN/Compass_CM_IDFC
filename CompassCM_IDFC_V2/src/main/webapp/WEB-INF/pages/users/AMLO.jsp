...
<script type="text/javascript">
	$(document).ready(function() {
		...
		$("#viewNewDashboard").click(function(){
			var fromDate = $(".dashboardFromDate").val();
			var toDate = $(".dashboardToDate").val();
			var sourceSystem = $(".dashboardSourceSystem").val();
			$.ajax({
				url: "${pageContext.request.contextPath}/common/getDashboardNewTabView",
				cache: false,
				type: "POST",
				data: "fromDate="+fromDate+"&toDate="+toDate+"&sourceSystem="+sourceSystem,
				success: function(res){
									...
									<div class="panelSearchForm">
										...
										<div class="card-footer clearfix">
											<div class="pull-${dirR}" >
												...
												<!-- <button type="button" id="viewNewDashboard" class="btn btn-primary btn-sm">New Dashboard</button> -->
