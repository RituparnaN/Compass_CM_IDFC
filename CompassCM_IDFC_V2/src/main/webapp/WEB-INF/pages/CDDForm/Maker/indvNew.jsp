...
String prefix = CURRENTROLE+"_IN_";
//System.out.println("PepDetails ? "+(prefix+"ADDPEPDETAILS")+" value "+CDDDisabledFieldsMap.isFieldDisabled(prefix+"ADDPEPDETAILS"));
%>
...
<script type="text/javascript">
	$(document).ready(function() {
		...
		var USERCURRENTROLE = '${CURRENTROLE}';
	...
	/*	$('input[type=radio]').parent("label").on('mouseover', function(event) {
			...
			var isDisabled = $(radio).prop("disabled");
		...
		*/
		...
		$(".saveCDDForm").click(function(){
			...
			*/
			...
			if(!($("#ASEMATCH_Y"+id).prop("checked")) && !($("#ASEMATCH_N"+id).prop("checked"))){
				alert('Anti Social Elements is a mandatory field.');
				return false;	
			}
			}
		...
		$("#screenCustomerNames"+id).click(function(){
			...
			//alert('COMPASSREFERENCENO:  '+COMPASSREFERENCENO);
			if(CUSTOMERNAMETOSCREEN != ""){
				var fullData = "COMPASSREFERENCENO="+COMPASSREFERENCENO+"&NAME1="+CUSTOMERNAMETOSCREEN+"&NAME2="+CUSTOMERALIASNAMETOSCREEN+"&NAME3=&NAME4=&NAME5=&DATEOFBIRTH=&PASSPORTNO=&PANNO=&ACCOUNTNO=&CUSTOMERID=&userCode=NA&BlackListCheck=Y&SelectedBlackListCheck=Y"+
	...
	function screen(elm, nameType, lineNo){
		...
		if(nameType == "CUSTOMERNAME"){
			var CUSTOMERNAMETOSCREEN = $("#CUSTOMERNAMETOSCREEN"+id).val();
			var CUSTOMERALIASNAMETOSCREEN = $("#CUSTOMERALIASNAMETOSCREEN"+id).val();
			fullData = "CDDFORMTYPE=INDIVIDUALNEW&COMPASSREFERENCENO="+COMPASSREFERENCENO+"&CDDNAMETYPE="+nameType+"&CDDNAMELINENO="+lineNo+"&NAME1="+CUSTOMERNAMETOSCREEN+"&NAME2="+CUSTOMERALIASNAMETOSCREEN+"&NAME3=&NAME4=&NAME5=&DATEOFBIRTH=&PASSPORTNO=&PANNO=&ACCOUNTNO=&CUSTOMERID=&userCode=NA&BlackListCheck=Y&SelectedBlackListCheck=Y"+
			   "&CustomerDataBaseCheck=Y&RejectedListCheck=Y&EmployeeDataBaseCheck=N";
		}
		else {
			fullData = "CDDFORMTYPE=INDIVIDUALNEW&COMPASSREFERENCENO="+COMPASSREFERENCENO+"&CDDNAMETYPE="+nameType+"&CDDNAMELINENO="+lineNo+"&NAME1="+name+"&NAME2=&NAME3=&NAME4=&NAME5=&DATEOFBIRTH=&PASSPORTNO=&PANNO=&ACCOUNTNO=&CUSTOMERID=&userCode=NA&BlackListCheck=Y&SelectedBlackListCheck=Y"+
			   "&CustomerDataBaseCheck=Y&RejectedListCheck=Y&EmployeeDataBaseCheck=N";
		}
		// alert(fullData);
		screenName(fullData);
	...
	function loadIdentificationForm(COMPASSREFERENCENO, LINENO){
		...
		$.ajax({
			...
			type : "POST",
			cache : false,
			data : "COMPASSREFERENCENO="+COMPASSREFERENCENO+"&LINENO="+LINENO+"&TYPE=INVDNEW",
			success : function(res){
	...
	function openIDF(elm){
		...
		$.ajax({
			...
			type : "POST",
			cache : false,
			data : "COMPASSREFERENCENO="+compassRefNo+"&LINENO="+lineNo+"&IDFORMTYPE="+entityType+"&FORMTYPE=INVDNEW&FORMLINENO="+formLineNo,
			success : function(res){
				$("#compassMediumGenericModal-body").html(res);
			},
			error : function(){
...
<div class="col-sm-12">
	<div class="card card-primary panel_CDDForm">
		<div class="card-header panelSlidingCDDForm${UNQID} clearfix">
			<h6 class="card-title pull-${dirL}">CDD Form for New Individual Customer For Compass ReferenceNo : ${COMPASSREFERENCENO}</h6>
		</div>
					...
					<div class="tab-content">
						<div role="tabpanel" class="tab-pane active" id="cdd">
							...
							<table class="table table-bordered table-striped" style="margin-bottom: 0px;" id="GeneralInformationTable">
								<tbody>
									...
									<tr>
										<td colspan="2">If there was no face-to-face interaction, please state reason </td>
										<td colspan="3">
											<textarea rows="2" cols="2" class="form-control" name="REASONFORNOINTRACTION"  <% if(CDDDisabledFieldsMap.isFieldDisabled(prefix+"REASONFORNOINTRACTION")){ %> disabled <% } %> id="REASONFORNOINTRACTION${UNQID}">${FORMDATA['REASONFORNOINTRACTION']}</textarea>
										</td>
									</tr>
									<tr>
									...
									<tr>
										...
										<td width="33%">
											<table class="table" style="margin: 0px;">
												<tr>
													...
													<td>
														<textarea rows="2" cols="2" class="form-control" name="RESIDENTIALADDRESS"  <% if(CDDDisabledFieldsMap.isFieldDisabled(prefix+"RESIDENTIALADDRESS")){ %> disabled <% } %> id="RESIDENTIALADDRESS${UNQID}">${FORMDATA['RESIDENTIALADDRESS']}</textarea>
													</td>
												</tr>
												<tr>
													<td>
													...
													<td>
														<input type="text" class="form-control input-sm" name="RESIDENTIALADDRESS2"  <% if(CDDDisabledFieldsMap.isFieldDisabled(prefix+"RESIDENTIALADDRESS2")){ %> disabled <% } %> id="RESIDENTIALADDRESS2${UNQID}" value="${FORMDATA['RESIDENTIALADDRESS2']}"/>
													</td>
												</tr>
												<tr>
													<td>
										...
										<td width="4%" style="text-align: center; vertical-align: middle;">
											<button type="button" class="btn btn-primary btn-sm" id="copyRAtoMA${UNQID}" <% if(CDDDisabledFieldsMap.isFieldDisabled(prefix+"RESIDENTIALADDRESS")){ %> disabled <% } %>>
										...
										<td width="33%">
											<table class="table" style="margin: 0px;">
												<tr>
													...
													<td>
														<textarea rows="2" cols="2" class="form-control" name="MAILINGADDRESS"  <% if(CDDDisabledFieldsMap.isFieldDisabled(prefix+"MAILINGADDRESS")){ %> disabled <% } %> id="MAILINGADDRESS${UNQID}">${FORMDATA['MAILINGADDRESS']}</textarea>
													</td>
												</tr>
												<tr>
													<td>
													...
													<td>
														<input type="text" class="form-control input-sm" name="MAILINGADDRESS2"  <% if(CDDDisabledFieldsMap.isFieldDisabled(prefix+"MAILINGADDRESS2")){ %> disabled <% } %> id="MAILINGADDRESS2${UNQID}" value="${FORMDATA['MAILINGADDRESS2']}"/>
													</td>
												</tr>
												<tr>
													<td>
													...
													<td>
														<input type="text" class="form-control input-sm" name="MAILINGADDRESS3"  <% if(CDDDisabledFieldsMap.isFieldDisabled(prefix+"MAILINGADDRESS3")){ %> disabled <% } %> id="MAILINGADDRESS3${UNQID}" value="${FORMDATA['MAILINGADDRESS3']}"/>
													</td>
												</tr>
											</table>
										</td>
									...
									<tr>
										...
										<td>
											<button type="button" class="btn btn-primary btn-sm" id="checkCustomerPANNo${UNQID}"  <% if(CDDDisabledFieldsMap.isFieldDisabled(prefix+"PANNO")){ %> disabled <% } %>>Check PAN</button>
										</td>
										<td>
											NSDL Response
										</td>
												...
												<tr>
													<td width="17%">
														<label class="btn btn-outline btn-primary btn-sm radio-inline" for="INTERMEDIARIESTYPE_AGNT${UNQID}">
														  <input type="radio" id="INTERMEDIARIESTYPE_AGNT${UNQID}"  name="INTERMEDIARIESTYPE"  <% if(CDDDisabledFieldsMap.isFieldDisabled(prefix+"INTERMEDIARIESTYPE")){ %> disabled <% } %> value="BROKER"
													...
													<td width="17%">
														<label class="btn btn-outline btn-primary btn-sm radio-inline" for="INTERMEDIARIESTYPE_POA${UNQID}">
														  <input type="radio" id="INTERMEDIARIESTYPE_POA${UNQID}"  name="INTERMEDIARIESTYPE"  <% if(CDDDisabledFieldsMap.isFieldDisabled(prefix+"INTERMEDIARIESTYPE")){ %> disabled <% } %> value="POA"
													...
													<td width="17%">
														<label class="btn btn-outline btn-primary btn-sm radio-inline" for="INTERMEDIARIESTYPE_INT${UNQID}">
														  <input type="radio" id="INTERMEDIARIESTYPE_INT${UNQID}"  name="INTERMEDIARIESTYPE"  <% if(CDDDisabledFieldsMap.isFieldDisabled(prefix+"INTERMEDIARIESTYPE")){ %> disabled <% } %> value="INT"
													...
													<td width="17%">
														<label class="btn btn-outline btn-primary btn-sm radio-inline" for="INTERMEDIARIESTYPE_NA${UNQID}">
														  <input type="radio" id="INTERMEDIARIESTYPE_NA${UNQID}"  name="INTERMEDIARIESTYPE"  <% if(CDDDisabledFieldsMap.isFieldDisabled(prefix+"INTERMEDIARIESTYPE")){ %> disabled <% } %> value="NA"
													...
													<td width="17%">
														<label class="btn btn-outline btn-primary btn-sm radio-inline" for="INTERMEDIARIESTYPE_OTH${UNQID}">
														  <input type="radio" id="INTERMEDIARIESTYPE_OTH${UNQID}"  name="INTERMEDIARIESTYPE"  <% if(CDDDisabledFieldsMap.isFieldDisabled(prefix+"INTERMEDIARIESTYPE")){ %> disabled <% } %> value="OTH"
													...
													<td width="15%">
														<input type="text" class="form-control input-sm" name="INTERMEDIARIESTYPEOTHER" id="INTERMEDIARIESTYPEOTHER${UNQID}"  <% if(CDDDisabledFieldsMap.isFieldDisabled(prefix+"INTERMEDIARIESTYPEOTHER")){ %> disabled <% } %> value="${FORMDATA['INTERMEDIARIESTYPEOTHER']}">
													</td>
												</tr>
											</table>
										</td>
						...
						<div role="tabpanel" class="tab-pane" id="screening">
							...
							<table class="table table-bordered table-striped" style="margin-bottom: 0px;">
								<tbody>
									<tr>
										<td colspan="1" width="15%"><c:if test="${FORMDATA['SCREENINGREFERENCENO'] ne null}"><font color="red">Customer Full Name</font></c:if>
										<c:if test="${FORMDATA['SCREENINGREFERENCENO'] eq null}">Customer Full Name</c:if>
										</td>
									...
									<tr>
										<td colspan="2" >Adverse Information is relation to ML/TF, Sanctions</td>
										<td colspan="1">
									...
									<tr>
										...
										<td colspan="3">
											...
											>${FORMDATA['SANCTIONCOUNTRIES']}</textarea>
										</td>
									</tr>
									<tr>
						...
						<div role="tabpanel" class="tab-pane" id="checkList">
							...
							<table class="table table-bordered table-striped checkListTable" id="checkListTable${UNQID}" style="margin-bottom: 0px;">
								...
								<tr>
									<td colspan="5" style="background-color: #BBB">Check List for BANK STAFF</td>
								</tr>
								<tr>
									<td>2</td>
									<td>
	...
	`									If, there is a name change, due to marriage or otherwise, a marriage Certificateissued by the State Government or a Gazette notification, indicating such  a change of name
								...
								<tr>
									<td rowspan="9" style="vertical-align: middle;">12</td>
									<td>
								...
								<c:if test="${(FORMDATA['STATUS'] eq 'BPA-P' && CURRENTROLE eq 'ROLE_BPAMAKER') || (FORMDATA['STATUS'] eq 'BPD-P' && CURRENTROLE eq 'ROLE_BPDMAKER')}">
									<tr>
										<td colspan="5" style="text-align: right;">
											<button type="button" class="btn btn-success btn-sm saveDraftCDDForm" id="saveDraftCDDForm6${UNQID}">Save Draft</button>
