...
<script type="text/javascript">
	$(document).ready(function() {
		var id = '${UNQID}';
		var tableClass = 'falsePositive${UNQID}';
		compassDatatable.construct(tableClass, "FalsePositive", true);
		compassDatatable.enableCheckBoxSelection();
		
	});
</script>
<table class="table table-bordered table-striped searchResultGenericTable falsePositive${UNQID}" style="margin-bottom: 0px;">
	<thead>
		<tr>
			<th class="info no-sort" style="text-align: center;">
				<input type="checkbox" class="checkbox-check-all" compassTable="falsePositive${UNQID}" id="falsePositive${UNQID}" />
			</th>
