...
<!-- Fixed Column -->
<script type="text/javascript"	src="${pageContext.request.contextPath}/includes/scripts/dataTables.fixedColumns.min.js"></script>
		...
		if(isMultiple == 0){
			...
			if(isMultiple == 1){
				...
				if($(".compass-nav-tabs > li.litab"+accid).length > 0){
					...
					$(".compass-nav-tabs > li:last").closest('li').after('<li class="litab'+finalId+'" id="litab'+finalId+'"><a data-toggle="tab" href="#'+finalId+ '">'+displayName+'&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</a><span class="refresh" display="'+finalId+','+accid+','+Url+'"> <i class="fa fa-refresh"></i></span><span class="close"> <i class="fa fa-times"></i></span></li>');
...
function navigate(displayName, accid, Url, isMultiple){
	if($(".nav-tabs > li.litab"+accid).length > 0 && isMultiple == 0){
		...
		$(".nav-tabs > li:last").closest('li').after('<li class="litab'+finalId+'"><a href="#'+finalId+ '">'+displayName+'&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</a><span class="refresh" display="'+finalId+','+accid+','+Url+'"> <i class="fa fa-refresh"></i></span><span class="close"> <i class="fa fa-times"></i></span></li>');
