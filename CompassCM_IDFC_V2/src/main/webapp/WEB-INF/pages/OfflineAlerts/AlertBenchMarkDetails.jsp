		...
		<div class="card card-primary panel_alertBenchMarkDtls">
										...
										<td width="30%">
											...
											<c:if test="${ALLLABELSMAP['MODULEPARAMDATATYPE'] eq 'search'}">
												<div class="input-group" style="z-index: 1">
													...
													<span class="input-group-addon formSearchIcon" id="basic-addon${UNQID}" onclick="compassTopFrame.moduleSearch('${ALLLABELSMAP['MODULEPARAMIDNAME']}_${UNQID}','${ALLLABELSMAP['MODULEPARAMIDNAME']}','${ALLLABELSMAP['MODULEPARAMVIEWNAME']}','${ALLLABELSMAP['MODULEPARAMVALIDATIONFIELD']}','${pageContext.request.contextPath}')"  style="cursor: pointer;" title="Search">
										...
										<td width="30%">
											...
											<c:if test="${ALLLABELSMAP['MODULEPARAMDATATYPE'] eq 'search'}">
												<div class="input-group" style="z-index: 1">
													...
													<span class="input-group-addon formSearchIcon" id="basic-addon2" onclick="compassTopFrame.moduleSearch('${ALLLABELSMAP['MODULEPARAMIDNAME']}_${UNQID}','${ALLLABELSMAP['MODULEPARAMIDNAME']}','${ALLLABELSMAP['MODULEPARAMVIEWNAME']}','${ALLLABELSMAP['MODULEPARAMVALIDATIONFIELD']}','${pageContext.request.contextPath}')"  style="cursor: pointer;" title="Search">
														<i class="fa fa-search"></i>
													</span>
												</div>											
											</c:if>
			...
			<div class="card-footer clearfix">
				<div class="pull-${dirR}">
					...
					<c:if test="${parameterType eq 'CONFIGURATION'}">
					...
					<c:if test="${parameterType eq 'SIMULATION'}">
