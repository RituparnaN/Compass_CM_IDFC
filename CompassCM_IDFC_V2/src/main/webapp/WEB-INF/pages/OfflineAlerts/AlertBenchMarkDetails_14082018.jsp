		...
		$("#approvealertBenchMarkDtls"+id).click(function(e){
			if(confirm("Are you sure you want to Save?")){
				...
				$.ajax({
					...
					cache: false,
					data: formData+"&alertId="+alertId+"&id="+id+"&viewType="+viewType+"&alertSerialNo="+alertSerialNo+"&requestType="+requestType+"&benchMarkStatus="+benchMarkStatus,
					type: 'POST',
					success: function(res){
						$("#compassGenericModal").modal("hide");
						alert("Successfully Saved")
	...
	<div class="col-sm-12">
		<div class="card card-primary panel_alertBenchMarkDtls">
			...
			<div class="card-footer clearfix">
				<div class="pull-${dirR}">
					<c:if test="${(CURRENTROLE eq 'ROLE_ADMIN')}">
