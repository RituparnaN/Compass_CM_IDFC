				...
				<table class="table table-striped" style="margin-bottom: 0px;">
					...
					<tr>
						...
						<td width="30%">
							...
							<textarea class="form-control input-sm" name="alertSubGroup" readonly="readonly" id="alertSubGroup${UNQID}">${ALERTDETAILS['ALERTSUBGROUP']}</textarea>
						</td>
						<td width="10%">&nbsp;</td>
						<td width="15%">
						...
						<td width="30%">
							<input type="text" class="form-control input-sm" name="alertSubGroupOrder" id="alertSubGroupOrder${UNQID}" readonly="readonly" value="${ALERTDETAILS['ALERTSUBGROUPORDER']}"/>
						</td>
					</tr>
					<tr>
						<td width="15%">
						...
						<td width="30%">
							<input type="text" class="form-control input-sm" name="seqNo" id="seqNo${UNQID}" readonly="readonly" value="${ALERTDETAILS['SEQNO']}"/>
						</td>
					</tr>
					<tr>
						<td width="15%">
					...
					<tr>
						...
						<td width="30%">
							<input type="text" class="form-control input-sm" name="sourceSystem" id="sourceSystem${UNQID}" readonly="readonly" value="${ALERTDETAILS['SOURCESYSTEM']}"/>
						</td>
						<td width="10%">&nbsp;</td>
						<td width="15%">
							Version No
