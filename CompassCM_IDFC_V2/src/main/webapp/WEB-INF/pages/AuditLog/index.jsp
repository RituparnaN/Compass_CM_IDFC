...
<script type="text/javascript">
	$(document).ready(function() {
		var id = '${UNQID}';
		compassTopFrame.init(id, 'auditLogTable'+id, 'dd/mm/yy');
		
		$(".panelSlidingMVTTReport"+id).on("click", function(e){
			var mainRow = $(this).parents(".compassrow"+id);
			compassTopFrame.searchPanelSliding(id, mainRow, 'auditLogSerachResultPanel');
		});
		
		$("#searchMasterForm"+id).submit(function(e){
			var submitButton = $("#searchMVTTReport"+id);
			compassTopFrame.submitForm(id, e, submitButton, 'auditLogSerachResultPanel',
					'auditLogSerachResult', '${pageContext.request.contextPath}/common/searchGenericMaster',
		...
		$("#exportReportingMVTTRFile").click(function(){
			...
			if(confirm("Are you sure you want to Generate Text Reporting File?")){
				$.fileDownload("${pageContext.request.contextPath}/common/generateAuditLogFile?"+formData+"&reportType="+reportType+"&reportingFileType="+reportingFileType, {
				    httpMethod : "GET",
...
<div class="row compassrow${UNQID}">
	<div class="col-sm-12">
		<div class="card card-primary panel_auditLog">
			<div class="card-header panelSlidingMVTTReport${UNQID} clearfix">
				<h6 class="card-title pull-${dirL}"><spring:message code="app.common.auditLogSearchHeader"/></h6>
			...
			<div class="card-search-card" >
				<table class="table table-striped formSearchTable auditLogTable${UNQID}" style="margin-bottom: 0px;">
					<tbody>
		...
		<div class="card card-primary" id="auditLogSerachResultPanel${UNQID}" style="display: none;">
			<div class="card-header panelSlidingMVTTReport${UNQID} clearfix">
				<h6 class="card-title pull-${dirL}"><spring:message code="app.common.auditLogResultHeader"/></h6>
				<div class="btn-group pull-${dirR} clearfix">
					<span class="pull-right"><i class="collapsable fa fa-chevron-up"></i></span>
				</div>
			</div>
			<div id="auditLogSerachResult${UNQID}"></div>
