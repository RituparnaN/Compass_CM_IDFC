...
else if(groupCode.equalsIgnoreCase("ROLE_BRANCHUSER") || groupCode.equalsIgnoreCase("ROLE_FATCARMUSER") || groupCode.equalsIgnoreCase("BRANCHUSER")){
	hierarchyCode = 4;
}
				...
				<table class="table table-striped compassModuleDetailsSearchTable${UNQID}" style="margin-bottom: 0px;">
					<tr>
						<td width="20%">Account Reviewed Date</td>
							<td width="25%">
								<input type="text" class="form-control input-sm datepicker" name="userAcctReviewedDate" id="userAcctReviewedDate${UNQID}" value="<%=l_strUSERAcctReviewDate%>" <%=l_strUserDisabled%>/>
							</td>
						<td width="10%">&nbsp;</td>
						<td width="20%">FATCA/CRS Indicator</td>
						<td width="25%">
							<select class="form-control input-sm" name="userFraudIndicator" id="userFraudIndicator${UNQID}" <%=l_strUserDisabled%>>
	 ...
	 <div class="col-sm-12" >
		<div class="card card-primary panel_addViewComments" id= "panelRaisedToBranch${UNQID}" style="margin-top: 2px; margin-bottom: 0px;">
			<div class="card-header panelSlidingRaisedToBranch${UNQID} clearfix">
				<h6 class="card-title pull-${dirL}">Raised to RM Comment</h6>
			...
			<div class="panelSearchForm">
				<table class="table table-striped compassModuleDetailsSearchTable${UNQID}" style="margin-bottom: 0px;">
					<tr>
						<td width="20%">Account Reviewed Date</td>
							<td width="25%">
								<input type="text" class="form-control input-sm datepicker" name="amlUserBRAcctReviewedDate" id="amlUserBRAcctReviewedDate${UNQID}" value="<%=l_strAMLUserBRReviewDate%>"  <%=l_strAMLUserDisabled%>/>
							</td>
						<td width="10%">&nbsp;</td>
						<td width="20%">FATCA/CRS Indicator</td>
						<td width="25%">
							<select class="form-control input-sm" name="bRFraudIndicator" id="bRFraudIndicator${UNQID}"  <%=l_strAMLUserDisabled%>>
								<option value='PFPM'>Documentary Evidence, Received but not attached</option>
								<option value='PFAP'>Documentary Evidence, Received and attached </option>
								<option value='PFND'>Documentary Evidence, Received and mark as US/Other Accounts</option>
								<option value='PFCI'>Documentary Evidence, Not Received and mark as Undocumented Accounts</option>
			...
			<div class="panelSearchForm">
				<table class="table table-striped compassModuleDetailsSearchTable${UNQID}" style="margin-bottom: 0px;">
					<tr>
						<td width="20%">Account Reviewed Date</td>
							<td width="25%">
								<input type="text" class="form-control input-sm datepicker" name="amlUserAcctReviewedDate" id="amlUserAcctReviewedDate${UNQID}" value="<%=l_strAMLUserAcctReviewDate%>"  <%=l_strAMLUserDisabled%>/>
							</td>
						<td width="10%">&nbsp;</td>
						<td width="20%">FATCA/CRS Indicator</td>
						<td width="25%">
							<select class="form-control input-sm" name="fraudIndicator" id="fraudIndicator${UNQID}"  <%=l_strAMLUserDisabled%>>
								<option value='PFPM'>Documentary Evidence, Received but not attached</option>
								<option value='PFAP'>Documentary Evidence, Received and attached </option>
								<option value='PFND'>Documentary Evidence, Received and mark as US/Other Accounts</option>
								<option value='PFCI'>Documentary Evidence, Not Received and mark as Undocumented Accounts</option>
			...
			<div class="panelSearchForm">
				<table class="table table-striped compassModuleDetailsSearchTable${UNQID}" style="margin-bottom: 0px;">
					<tr>
						<td width="20%">Account Reviewed Date</td>
							<td width="25%">
								<input type="text" class="form-control input-sm datepicker" name="amloAcctReviewedDate" id="amloAcctReviewedDate${UNQID}" value="<%=l_strAMLOAcctReviewDate%>"  <%=l_strAMLOUSERDisabled%>/>
							</td>
						<td width="10%">&nbsp;</td>
						...
						<td width="25%">
							<select class="form-control input-sm" name="amloRemovalReason" id="amloRemovalReason${UNQID}"  <%=l_strAMLOUSERDisabled%>>
					...
					<% if((l_strCaseStatus != null && l_strCaseStatus.trim().equalsIgnoreCase("8")) || (l_strAMLOOUTCOMEINDICATOR != null && !l_strAMLOOUTCOMEINDICATOR.trim().equalsIgnoreCase(""))) { %>
						...
						<td width="25%">
							<select name="amloOutcomeIndicator" id="amloOutcomeIndicator${UNQID}" class="form-control input-sm"  onChange="changeAMLOValues(this)"  <%=l_strAMLOUSERDisabled%>>
					...
					<%}if((l_strCaseStatus != null && l_strCaseStatus.trim().equalsIgnoreCase("8")) || (l_strAMLOHIGHRISKREASONCODE != null && !l_strAMLOHIGHRISKREASONCODE.trim().equalsIgnoreCase(""))) { %>
						<div id="div_AMLOHIGHRISKREASONCODE" style="display:block">
							<table>
								<tr>
									<td width="20%">Reason Code</td>
										<td width="25%">
											<select name="amloHighRiskReasonCode" id="amloHighRiskReasonCode${UNQID}" class="form-control input-sm"  <%=l_strAMLOUSERDisabled%>>
			...
			<div class="panelSearchForm">
				<table class="table table-striped compassModuleDetailsSearchTable${UNQID}" style="margin-bottom: 0px;">
					<tr>
						<td width="20%">Account Reviewed Date</td>
							<td width="25%">
								<input type="text" class="form-control input-sm datepicker" name="mlroAcctReviewedDate" id="mlroAcctReviewedDate${UNQID}" <%=l_strMLROUSERDisabled%> value="<%= l_strMLROAcctReviewDate %>" />
							</td>
						<td width="10%">&nbsp;</td>
						<% if(l_strCaseStatus != null && l_strCaseStatus.trim().equalsIgnoreCase("9")) { %>
						<td width="20%">Removal Reason</td>
						<td width="25%">
							<select class="form-control input-sm" name="mlroRemovalReason" id="mlroRemovalReason${UNQID}"  <%=l_strMLROUSERDisabled%>>
					...
					<% if(l_strCaseStatus != null && l_strCaseStatus.trim().equalsIgnoreCase("10")) { %>
						...
						<td width="20%">Outcome Indicator</td>
						<td width="25%">
							<select name="mlroOutcomeIndicator" id="mlroOutcomeIndicator${UNQID}" class="form-control input-sm"  onChange="changeMLROValues(this)"  <%=l_strMLROUSERDisabled%>>
								<option value='FUUA'>FATCA/CRS Status upheld and mark as US/Other Accounts</option>
								<option value='FURA'>FATCA/CRS Status upheld and mark as Undocumented Accounts</option>
							</select>		
						</td>
							...
							<div id="div_MLROHighRiskReasonCode"  style="display:block;">
								<table>
									<tr>
										<td width="20%">Reason Code</td>
											<td width="25%">
												<select name="mlroHighRiskReasonCode" id="mlroHighRiskReasonCode${UNQID}" class="form-control input-sm"  <%=l_strMLROUSERDisabled%>>
												<!--<option value="HRA">Mark As High Risk Accounts</option>-->
													<option value='MLA'>Received and verified W8/W9 form</option>
													<option value='WAT'>Customer reluctant to share the information</option>
													<option value='CPA'>Customer reluctant to share the W8/W9 Form</option>
...
<form name="form1" id="saveCommentForm" method='POST' action="${pageContext.request.contextPath}/fatcaCaseWorkFlow/fatcaSaveComments">
