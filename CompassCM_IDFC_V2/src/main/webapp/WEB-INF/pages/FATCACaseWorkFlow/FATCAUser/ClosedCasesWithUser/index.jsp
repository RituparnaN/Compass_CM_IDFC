...
<script type="text/javascript">
	$(document).ready(function() {
		var id = '${UNQID}';
		compassTopFrame.init(id, 'fatcaUserClosedCaseTable'+id, 'dd/mm/yy');
		
		$('.panelSlidingFATCAUserClosedCase'+id).on("click", function (e) {
			var mainRow = $(this).parents(".compassrow"+id);
			compassTopFrame.searchPanelSliding(id, mainRow, 'fatcaUserClosedCaseSerachResultPanel');
	    });
		
		$("#searchMasterForm"+id).submit(function(e){
			var submitButton = $("#searchFATCAUserClosedCase"+id);
			compassTopFrame.submitForm(id, e, submitButton, 'fatcaUserClosedCaseSerachResultPanel', 
					'fatcaUserClosedCaseSerachResult', '${pageContext.request.contextPath}/fatcaCaseWorkFlow/searchClosedCases',
		...
		$("#attachEvedence").click(function(){
			var caseNo = "";
			var count = 0;
			$("#fatcaUserClosedCaseSerachResult"+id).find("table").children("tbody").children("tr").each(function(){
			...
			compassFileUpload.init("attachEvedence","${pageContext.request.contextPath}","5678","fatcaUserClosedCaseSerachResult"+id,"Y","Y");
			}
		});
...
<div class="row compassrow${UNQID}">
	<div class="col-sm-12">
		<div class="card card-primary panel_fatcaUserClosedCase">
			<div class="card-header panelSlidingFATCAUserClosedCase${UNQID} clearfix">
				<h6 class="card-title pull-${dirL}"><spring:message code="app.common.fatcaUserClosedCaseSearchHeader"/></h6>
			...
			<input type="hidden" name="bottomPageUrl" value="FATCACaseWorkFlow/FATCAUser/ClosedCasesWithUser/SearchBottomPage">
			<div class="card-search-card" >
				<table class="table table-striped formSearchTable fatcaUserClosedCaseTable${UNQID}" style="margin-bottom: 0px;">
					<tbody>
			...
			<div class="card-footer clearfix">
				<div class="pull-${dirR}">
					<button  type="submit" id="searchFATCAUserClosedCase${UNQID}" class="btn btn-success btn-sm"><spring:message code="app.common.searchButton"/></button>
				</div>
			</div>
			</form>
			</div>
		</div>
		<div class="card card-primary" id="fatcaUserClosedCaseSerachResultPanel${UNQID}" style="display: none;">
			<div class="card-header panelSlidingFATCAUserClosedCase${UNQID} clearfix">
				<h6 class="card-title pull-${dirL}"><spring:message code="app.common.fatcaUserClosedCaseResultHeader"/></h6>
				<div class="btn-group pull-${dirR} clearfix">
					<span class="pull-right"><i class="collapsable fa fa-chevron-up"></i></span>
				</div>
			</div>
			<div id="fatcaUserClosedCaseSerachResult${UNQID}"></div>
			
			<div class="card-footer action-footer clearfix">
				<div class="pull-${dirR} clearfix">
					
					<button type="button" class="btn btn-primary btn-sm" onclick="caseWorkFlowActions.desktopCloser('fatcaUserClosedCaseSerachResult${UNQID}')">Desktop Closure</button>
					...
					<div class="btn-group dropup" role="group">
						...
						<ul class="dropdown-menu" role="menu">
							<li><a class="nav-link" href="javascript:void(0)" onclick="caseWorkFlowActions.closeWithSTR('fatcaUserClosedCaseSerachResult${UNQID}')">With STR</a></li>
							<li><a class="nav-link" href="javascript:void(0)" onclick="caseWorkFlowActions.closeWithoutSTR('fatcaUserClosedCaseSerachResult${UNQID}')">Without STR</a></li>
						</ul>
					</div>
					
					<button type="button" class="btn btn-primary btn-sm" onclick="caseWorkFlowActions.viewComments('fatcaUserClosedCaseSerachResult${UNQID}')">View Comment</button>
		            ...
		            <div class="btn-group dropup" role="group">
						...
						<ul class="dropdown-menu" role="menu">
							<li><a class="nav-link" href="javascript:void(0)" onclick="caseWorkFlowActions.viewIndianSTR('fatcaUserPendingCaseSerachResult${UNQID}')">Indian STR</a></li>
							<li><a class="nav-link" href="javascript:void(0)" onclick="caseWorkFlowActions.viewSriLankanSTR('fatcaUserPendingCaseSerachResult${UNQID}')">SL STR</a></li>
							<li><a class="nav-link" href="javascript:void(0)" onclick="caseWorkFlowActions.viewUKSTR('fatcaUserPendingCaseSerachResult${UNQID}')">UK SAR</a></li>
						</ul>
					</div>
					...
					<button type="button" class="btn btn-primary btn-sm" onclick="caseWorkFlowActions.assignToBranchUserByAMLuser('fatcaUserClosedCaseSerachResult${UNQID}')">Assign To BranchUser</button>
