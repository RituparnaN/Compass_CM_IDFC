		...
		<div class="card card-primary" id="fatcaManagerPendingCaseSerachResultPanel${UNQID}" style="display: none;">
			...
			<div class="card-footer action-footer clearfix">
				<div class="pull-${dirR} clearfix">
					...
					<button type="button" class="btn btn-primary btn-sm" onclick="caseWorkFlowActions.rejectCaseByFATCAManager('fatcaManagerPendingCaseSerachResult${UNQID}')">Reject Report</button>
					
					<button type="button" class="btn btn-primary btn-sm" onclick="caseWorkFlowActions.fileCaseByFATCAManager('fatcaManagerPendingCaseSerachResult${UNQID}')">File Report</button>
					
					<button type="button" class="btn btn-primary btn-sm" onclick="caseWorkFlowActions.viewFatcaComments('fatcaManagerPendingCaseSerachResult${UNQID}')">View Comment</button>
					...
					<button type="button" class="btn btn-primary btn-sm" id="assignToAMLO">Assign To Officer</button>
