...
<script type="text/javascript">
	$(document).ready(function() {
		...
		var formId = '${formId}';		
  		...
  		compassTopFrame.init(id, 'compassAssignToRMUserTable'+id, 'dd/mm/yy');
  		var parentFormId = '<%=(String) request.getAttribute("parentFormId")%>';
		
		
		$("#assignCaseToRMUser"+id).click(function(){
			//alert(caseNo);
			...
			$.ajax({
				url: "${pageContext.request.contextPath}/fatcaCaseWorkFlow/assignCaseToRMUser",
				cache: false,
				type: "POST",
...
<div class="row compassrow${UNQID}">
	<div class="col-sm-12">
		<div class="card card-primary panel_assignToRMUser">
			<div class="card-header  clearfix">
				<h6 class="card-title pull-${dirL}"><spring:message code="app.common.assignToRMUserTableHeader"/></h6>
			</div>
			<div class="panelSearchForm">
			<form action="javascript:void(0)" method="POST" id="searchMasterForm${UNQID}">
				<table class="table table-striped compassAssignToRMUserTable" style="margin-bottom: 0px;">
					<tr>
				...
				<div class="card-footer clearfix">
					<div class="pull-${dirR}">
						<input type="button" id="assignCaseToRMUser${UNQID}" class="btn btn-primary btn-sm" name="Assign" value="Assign">
