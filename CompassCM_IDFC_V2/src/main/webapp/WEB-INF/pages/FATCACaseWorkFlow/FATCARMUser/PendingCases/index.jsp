...
<div class="row compassrow${UNQID}">
	<div class="col-sm-12">
		<div class="card card-primary panel_amlUserPendingCase">
			...
			<input type="hidden" name="bottomPageUrl" value="FATCACaseWorkFlow/FATCARMUser/PendingCases/SearchBottomPage">
		...
		<div class="card card-primary" id="amlUserPendingCaseSerachResultPanel${UNQID}" style="display: none;">
			...
			<div class="card-footer action-footer clearfix">
				<div class="pull-${dirR} clearfix">
					...
					<button type="button" class="btn btn-primary btn-sm" onclick="caseWorkFlowActions.desktopCloserByFATCARMUser('amlUserPendingCaseSerachResult${UNQID}')">Desktop Closure</button>
					
					<button type="button" class="btn btn-primary btn-sm" onclick="caseWorkFlowActions.escalateCaseByFATCARMUser('amlUserPendingCaseSerachResult${UNQID}')">Escalate Case</button>
					
					<button type="button" class="btn btn-primary btn-sm" onclick="caseWorkFlowActions.viewFatcaComments('amlUserPendingCaseSerachResult${UNQID}')">View Comment</button>
