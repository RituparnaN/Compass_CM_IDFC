...
<script type="text/javascript">
	$(document).ready(function(){
		...
		$("#updateFalsePositiveModal"+id).click(function(){
			var adminComments = prompt("Please enter your comments before updating.");
		...
		<form action="javascript:void(0)" method="POST" id="updateFalsePositiveForm${UNQID}">
			<table class="table table-striped updateFalsePositiveTable${UNQID}" style="margin-bottom: 0px;">
				...
				<tr>	
					...
					<td width="30%"><input type="text" class="form-control input-sm" name="alertMsg" id="alertMsg${UNQID}" value="${RESULTMAP['ALERTMESSAGE']}"
						<c:if test="${isView eq 'Y'}">disabled="disabled"</c:if>/></td>
				</tr>
				<tr>	
