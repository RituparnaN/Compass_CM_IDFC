...
<script type="text/javascript">
	$(document).ready(function() {
		var id = '${UNQID}';
		compassTopFrame.init(id, 'systemLoginLogTable'+id, 'dd/mm/yy');
		
		$(".panelSlidingMVTTReport"+id).on("click", function(e){
			var mainRow = $(this).parents(".compassrow"+id);
			compassTopFrame.searchPanelSliding(id, mainRow, 'systemLoginLogSerachResultPanel');
		});
		
		$("#searchMasterForm"+id).submit(function(e){
			var submitButton = $("#searchMVTTReport"+id);
			compassTopFrame.submitForm(id, e, submitButton, 'systemLoginLogSerachResultPanel',
					'systemLoginLogSerachResult', '${pageContext.request.contextPath}/common/searchGenericMaster',
...
<div class="row compassrow${UNQID}">
	<div class="col-sm-12">
		<div class="card card-primary panel_systemLoginLog">
			<div class="card-header panelSlidingMVTTReport${UNQID} clearfix">
				<h6 class="card-title pull-${dirL}"><spring:message code="app.common.systemLoginLogSearchHeader"/></h6>
			...
			<div class="card-search-card" >
				<table class="table table-striped formSearchTable systemLoginLogTable${UNQID}" style="margin-bottom: 0px;">
					<tbody>
		...
		<div class="card card-primary" id="systemLoginLogSerachResultPanel${UNQID}" style="display: none;">
			<div class="card-header panelSlidingMVTTReport${UNQID} clearfix">
				<h6 class="card-title pull-${dirL}"><spring:message code="app.common.systemLoginLogResultHeader"/></h6>
				<div class="btn-group pull-${dirR} clearfix">
					<span class="pull-right"><i class="collapsable fa fa-chevron-up"></i></span>
				</div>
			</div>
			<div id="systemLoginLogSerachResult${UNQID}"></div>
