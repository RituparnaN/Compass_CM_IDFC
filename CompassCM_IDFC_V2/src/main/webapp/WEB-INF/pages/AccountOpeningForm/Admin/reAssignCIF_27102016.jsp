...
<script type="text/javascript">
	...
	function checkForm(){
		...
		cases = cases + "'";
		$("#L_CASES").val(cases);
		if(confirm("Do you want to reassign these "+count+" cases"))
			return true;
		else
			return false;
	}
	...
	<div class="row">
		...
		<div class="col-lg-12">
			<div class="card card-primary">
				...
				if(cases.size() > 0){
					%>
					<form action="<%=contextPath%>/reAssignCIFToCheckerMaker" method="POST" onsubmit="return checkForm()">
					...
					<table class="table table-bordered table-stripped">
						...
						<tr>
							<td colspan="5" style="text-align:center">
								<input type="submit" class="btn btn-primary btn-small" value="Re-assign"/>
							</td>
						</tr>
					<table>
