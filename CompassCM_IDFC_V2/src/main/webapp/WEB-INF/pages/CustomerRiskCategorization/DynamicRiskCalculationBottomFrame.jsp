...
$(document).ready(function(){
	var tableClass = 'dynamicRiskWeightageTable';
	compassDatatable.construct(tableClass, "Dynamic Risk Weightage", true);
});
</script>
<table class="table table-bordered table-striped dynamicRiskWeightageTable" style="margin-bottom: 0px;">
	<thead>
		<tr>
			<th>Parameter Id </th>
