...
$(document).ready(function(){
	...
	$.ajax({
		...
		success : function(resData){
			...
			$("#emailIdsForNonProfiledCRP").val(resData.EMAILIDSFORNONPROFILEDCRP);
			...
			if(resData.EMAILAUTOREFRESH == 'N'){
				...
				$("#emailIdsForNonProfiledCRP").attr("disabled","disabled");
	...
	/* 	if(userRole == 'MAKER' || userRole == 'CHECKER'){ */
			...
			//alert("lockoutAttempt"+lockoutAttempt);
			if(capitalLetter){
				patternCount++;
				passwordPattern = "CAP,";
			}			
		...
		/* }else{ */
			...
			emailIdsForNonProfiledCRP = $("#emailIdsForNonProfiledCRP").val();
		...
		if(isValid){
			...
			/* }else{ */
				fullData = fullData + "&ALERTRESOLUTIONDAYS="+alertResolutionDays+"&CASEESOLUTIONDAYS="+caseResolutionDays+
						   ...
						   "&SENDEREMAILID="+senderEmailId+"&EMAILIDSFORALERT="+emailIdsForAlert+"&EMAILIDSFORCRP="+emailIdsForCRP+"&EMAILIDSFORNONPROFILEDCRP="+emailIdsForNonProfiledCRP+
	    			...
	    			<%-- <c:choose>
	    				...
	    				<c:otherwise> --%>
		    				...
		    				<tr>
		    					...
		    					<td>&nbsp;</td>
		    					<td>Email Id's for NonProfiled CRP</td>
		    					<td>
		    						<input type="text" class="form-control input-sm" id="emailIdsForNonProfiledCRP" name="emailIdsForNonProfiledCRP"/>
		    					</td>
		    				</tr>
	    				<%-- </c:otherwise>
	    			</c:choose> --%>
