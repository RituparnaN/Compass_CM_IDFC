...
<script type="text/javascript">
	$(document).ready(function() {
		...
		$("#searchMasterForm"+id).submit(function(e){
			...
			compassTopFrame.submitForm(id, e, submitButton, 'amlUserPendingCaseSerachResultPanel', 
					'amlUserPendingCaseSerachResult', '${pageContext.request.contextPath}/common/riskAssessmentSearchPendingCasesNew',
	...
	/* function openDetails(elm,a,b,c,d){
		...
		$("#compassMediumGenericModal-body").html("<br/><center><img alt='Loading...' src='${pageContext.request.contextPath}/includes/images/qde-loadder.gif'></center><br/>");
		 $.ajax({
			...
			cache: false,
			type: "POST",
			/* data: "caseNo="+caseNo+"&caseId="+caseId.split(".")[0]+"&caseVersion="+caseId, */
			/*success: function(res) {
				$("#compassMediumGenericModal-body").html(res);
			},
			error: function(a,b,c) {
	...
	function handleEscalateCase(){
		...
		if(count == 0){
			...
			$("#compassMediumGenericModal-body").html("<br/><center><img alt='Loading...' src='${pageContext.request.contextPath}/includes/images/qde-loadder.gif'></center><br/>");
			$.ajax({
				url: "${pageContext.request.contextPath}/common/riskAssessmentPendingCasesNew/getCaseWorkflowModuleDetails",
				cache: false,
				type: "GET",
				data: "moduleValue="+caseNo+"&moduleCode="+"riskAssessmentViewCommentsNew"+"&detailPage="+escape("RiskAssessmentPendingCasesNew/AddViewCommentsWithHistory")+"&actionType="+"escalateCase"+"&caseId="+caseId+"&caseVersion="+caseId+"&compassRefNo="+crn,
				success: function(res) {
					$("#compassMediumGenericModal-body").html(res);
				},
				error: function(a,b,c) {
	...
	function handleViewCaseComments(){
		...
		if(count == 0){
			...
			$.ajax({
				...
				cache: false,
				type: "GET",
				data: "moduleValue="+caseNo+"&moduleCode="+"riskAssessmentViewCommentsNew"+"&detailPage="+escape("RiskAssessmentPendingCasesNew/AddViewCommentsWithHistory")+"&actionType="+"viewComments"+"&caseId="+caseId.split(".")[0]+"&caseVersion="+caseId+"&compassRefNo="+crn,
				success: function(res) {
					$("#compassMediumGenericModal-body").html(res);
				},
				error: function(a,b,c) {
	...
	function handleAction(){
		...
		if(count == 0){
			...
			$.ajax({
				...
				cache: false,
				type: "GET",
				data: "moduleValue="+caseNo+"&moduleCode="+"riskAssessmentViewCommentsNew"+"&detailPage="+escape("RiskAssessmentPendingCasesNew/AddViewCommentsWithHistory")+"&actionType="+"checkerAction"+"&caseId="+caseId+"&caseVersion="+caseId+"&compassRefNo="+crn,
...
<div class="row compassrow${UNQID}">
	<div class="col-sm-12">
		<div class="card card-primary panel_amlUserPendingCase">
			...
			<input type="hidden" name="bottomPageUrl" value="RiskAssessmentPendingCasesNew/SearchBottomPage">
