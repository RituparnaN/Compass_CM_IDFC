	...
	$(document).ready(function() {
		...
		$("#assignUserGroupModule").click(function(){
			...
			if(confirm("Are you sure you want to assign selected roles and modules to "+userCode)){
				...
				$.ajax({
		    		url : "${pageContext.request.contextPath}/adminMaker/assignRoleModule",
		    		cache : false,
		    		type : 'POST',
		    		data : fullData,
	...
	<div class="col-sm-12">
		<div class="card card-primary">
			<div class="card-header clearfix">
				<h6 class="card-title pull-${dirL}">Manage Modules for : ${GROUPCODE}</h6>
				<input type="hidden" id="groupCodeForGroupModuleMapping" value="${GROUPCODE}"/>
			</div>
			<div class="row" style="padding: 5px; height: 300px;">
				<div class="col-sm-6" style="overflow: auto; height: inherit;">
					<div class="card-group" id="accordion" role="tablist"	aria-multiselectable="true">
						<c:forEach var="role" items="${ALLMODULES}" begin="0" end="4">
