...
<script type="text/javascript">
	$(document).ready(function() {
		...
		$(".templateScan").click(function(){
			...
			alert('document.bottomFrame.isFreezedStatus.value '+document.bottomFrame.isFreezedStatus.value);
			alert('document.bottomFrame.screeningReferenceNo.value '+document.bottomFrame.screeningReferenceNo.value);
			
			//getScanningDetails(templateSeqNo, isFreezedStatus, isScreeningReferenceNo);
			//alert(isFreezedStatus);
			//alert(isScreeningReferenceNo);
		...
		function getScanningDetails(templateSeqNo, isFreezedStatus, isScreeningReferenceNo, callback) {
			alert('getScanningDetails');
			$.ajax({
				...
				success: function(res) {
					alert(res['isFreezed']+' , '+res['screeningReferenceNo']);
					...
					isFreezedStatus = res['isFreezed'];
					isScreeningReferenceNo = res['screeningReferenceNo'];
				},
				complete: function(){
					alert('in complete');
						callback();
