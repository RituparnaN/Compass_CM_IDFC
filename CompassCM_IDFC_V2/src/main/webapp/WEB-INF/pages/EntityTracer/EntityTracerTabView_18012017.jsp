...
<script>
	...
	function saveForceLink(forceLinkElm, accountNo, linkType, linkedAccountNo, linkedCustId, linkCustName){
		if(confirm("Do you want to save force link \""+forceLinkElm.value+"\" between \nAccount No: "+accountNo+" and \nAccount No: "+linkedAccountNo)){
			var fullData = "forceLink="+forceLinkElm.value+"&accountNo="+accountNo+"&linkType="+linkType+"&linkedAccountNo="+linkedAccountNo+"&linkedCustId="+linkedCustId+"&linkCustName="+linkCustName;
			$.ajax({
	...
	<div class="col-sm-12">
		<div class="card card-primary panel_entityLinkAnalysis">
			...
			<div class="panelSearchForm">
				<table class="table table-bordered table-stripped entityLinkAnalysis${UNQID}"  style="margin-bottom: 0px;">
					<tbody>
						<tr>
							<td width="15%">
								From Date
							...
							<td width="30%">
								<input type="text" class="form-control input-sm datepicker entityLinkAnalysisFromDate${UNQID}" id="FROMDATE" />
							</td>
							<td>&nbsp;</td>
							<td width="15%">
								To Date
							...
							<td width="30%">
								<input type="text" class="form-control input-sm datepicker entityLinkAnalysisToDate${UNQID}" id="TODATE" />
							</td>
						</tr>
						<tr>
							...
							<td>
								<div class="input-group" style="z-index: 1">
									<input type="text" class="form-control input-sm" aria-describedby="basic-addon-ela" id="entityLinkAnalysisAccountNo${UNQID}"/>
										<span class="input-group-addon" id="basic-addon-ela" onclick="alert('search')" style="cursor: pointer;" title="Search">
