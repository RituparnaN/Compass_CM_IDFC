						...
						<tr>
							...
							<td>
								<div class="input-group" style="z-index: 1">
									...
									<span class="input-group-addon" id="basic-addon-entityLinkAnalysisAccountNo${UNQID}" 
				...
				<div class="pull-${dirR}">
					...
					<div class="btn-group dropup" role="group">
						...
						<ul class="dropdown-menu" role="menu">
							<li><a href="javascript:void(0)" class= "SearchGraph" view="H">Horizontal View</a></li>
							<li><a href="javascript:void(0)"  class= "SearchGraph" view="V">Vertical View</a></li>
						</ul>
					</div>
