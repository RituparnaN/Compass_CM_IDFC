...
<script type="text/javascript">
	$(document).ready(function() {
		var id = '${UNQID}';
		var tableClass = 'screeningExceptions${UNQID}';
		compassDatatable.construct(tableClass, "ScreeningExceptions", true);
		compassDatatable.enableCheckBoxSelection();
		
	});
</script>
<table class="table table-bordered table-striped searchResultGenericTable screeningExceptions${UNQID}" style="margin-bottom: 0px;">
	<thead>
		<tr>
