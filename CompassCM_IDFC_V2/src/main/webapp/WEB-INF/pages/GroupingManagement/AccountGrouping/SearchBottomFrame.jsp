...
<script type="text/javascript">
	$(document).ready(function() {
		var id = '${UNQID}';
		var tableClass = 'accountGrouping${UNQID}';
		compassDatatable.construct(tableClass, "AccountGrouping", true);
		compassDatatable.enableCheckBoxSelection();
		
		$(".accountGrouping"+id).children("tbody").children("tr").each(function(){
		...
		$(".groupCodeLink"+id).click(function(){
			...
			var url = "${pageContext.request.contextPath}/common/AccountGroupingDetails?groupCode="+groupCode;
...
<table class="table table-bordered table-striped accountGrouping${UNQID}" style="margin-bottom: 0px;">
	<thead>
		<tr>
			<th class="info no-sort" style="text-align: center;">
				<input type="checkbox" class="checkbox-check-all" compassTable="accountGrouping${UNQID}" id="accountGrouping${UNQID}" />
			</th>
