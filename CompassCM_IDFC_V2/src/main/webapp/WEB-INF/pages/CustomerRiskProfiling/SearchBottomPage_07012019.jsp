...
<script type="text/javascript">
	...
	function openCRPRulesIDDetails(elm){
		...
		var mywin = window.open("${pageContext.request.contextPath}/admin/updateRule?ruleID="+reportId+"&CRPRuleStatus="+CRPRuleStatus,'CRPRuleUpdateFrame','height=900px,width=1600px,scrollbars=1,Full=Y,resizable=Yes');
	//	mywin.moveTo(10,02);
	}
