...
<body style="margin:5px; overflow-y: scroll;">
	<div class="card card-default card-primary" >
		<div class="col-sm-12 card-header" id="createRulePanelHeader" style="cursor:pointer;">
			<p style=" float: left;margin:0px;">Update Risk Rating Rule</p>
			...
			<div class="card-body" id="saveRulesModalDetails" style="max-height: 400px; overflow-y: auto; padding: 0;">
				 <table id='SaveReportTable' class='table table-striped'>
				 		...
				 		<tr>
				 			...
				 			<td ><textarea class="form-control input-sm resizeTextarea" id ="previousMakerComment" rows="2" disabled></textarea></td>
				 			<td width="10%"></td>
				 			<td width="20%">
				 				Rule For 
				 			</td>
