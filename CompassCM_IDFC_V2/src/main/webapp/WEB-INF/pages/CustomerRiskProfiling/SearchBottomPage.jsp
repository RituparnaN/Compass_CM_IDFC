...
<script type="text/javascript">
	...
	function gettingRuleStatus(elm){
		let tableClass = '${MODULETYPE}${UNQID}';
		var ruleStatusColumnIndex = $("."+tableClass).children("thead").children("tr").children("th#RULESTATUS").index();
		//alert(ruleStatusColumnIndex);
		var CRPRuleStatus = $(elm).closest("tr").children().eq(ruleStatusColumnIndex).text();
		//alert(CRPRuleStatus);
