...
<body style="margin:5px; overflow-y: scroll;">
	<div class="card card-default card-primary">
		<div class="card-header" id="createRulePanelHeader" style="cursor:pointer;">Create Risk Rating Rule</div>
				 		...
				 		<tr>
							...
							<td width="25%">
								<select class="form-control input-sm" id="CRPRuleFor">
									...
									<option value = "PROFILED_CUSTOMER"> Profiled Customer</option>
									<option value = "NONPROFILED_CUSTOMER">Non Profiled Customer</option>
				 				</select>
				 			</td>
							<td colspan="3">&nbsp;</td>
				 		</tr>
...
<script type = "text/javascript">
	...
	$("#SaveRulesFinal").click(function(){
		...
		//	alert(isEnabled);
			...
			type : "POST",
			cache : false,
			data : {ruleID:ruleID,ruleName:ruleName,ruleCode:ruleCode,risk:risk,isEnabled:isEnabled,rule:rule,ruleConditionHTML:ruleConditionHTML,makerComments:makerComments},
