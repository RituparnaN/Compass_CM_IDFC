	...
	<div class="col-sm-12">
		<div class="card card-primary panel_swiftAdminPendingCase">
			<div class="card-header panelSlidingSwiftAdminPendingCase${UNQID} clearfix">
				<h6 class="card-title pull-${dirL}"><spring:message code="app.common.swiftAdminPendingCaseSearchHeader"/></h6>
			...
			<input type="hidden" name="bottomPageUrl" value="SwiftModules/SwiftWorkFlow/SwiftAdmin/PendingMessages/SearchBottomPage">
		...
		<div class="card card-primary" id="swiftAdminPendingCaseSerachResultPanel${UNQID}" style="display: none;">
			<div class="card-header panelSlidingSwiftAdminPendingCase${UNQID} clearfix">
				<h6 class="card-title pull-${dirL}"><spring:message code="app.common.swiftAdminPendingCaseResultHeader"/></h6>
				<div class="btn-group pull-${dirR} clearfix">
					<span class="pull-right"><i class="collapsable fa fa-chevron-up"></i></span>
				</div>
			</div>
