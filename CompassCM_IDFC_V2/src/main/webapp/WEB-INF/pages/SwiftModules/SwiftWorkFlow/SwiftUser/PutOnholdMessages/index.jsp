	...
	<div class="col-sm-12">
		<div class="card card-primary panel_swiftUserPendingCase">
			<div class="card-header panelSlidingSwiftUserPendingCase${UNQID} clearfix">
				<h6 class="card-title pull-${dirL}"><spring:message code="app.common.swiftUserPutOnholdCaseSearchHeader"/></h6>
			...
			<input type="hidden" name="bottomPageUrl" value="SwiftModules/SwiftWorkFlow/SwiftUser/PutOnholdMessages/SearchBottomPage">
		...
		<div class="card card-primary" id="swiftUserPendingCaseSerachResultPanel${UNQID}" style="display: none;">
			<div class="card-header panelSlidingSwiftUserPendingCase${UNQID} clearfix">
				<h6 class="card-title pull-${dirL}"><spring:message code="app.common.swiftUserPutOnholdCaseResultHeader"/></h6>
				<div class="btn-group pull-${dirR} clearfix">
					<span class="pull-right"><i class="collapsable fa fa-chevron-up"></i></span>
				</div>
			</div>
