...
<div class="row compassrow${UNQID}">
	<div class="col-sm-12">
		<div class="card card-primary panel_amlUserClosedCase">
			...
			<input type="hidden" name="bottomPageUrl" value="AMLCaseWorkFlow/AMLUser/ClosedCasesWithUser/SearchBottomPage">
				...
				<div class="pull-${dirR} clearfix">
					...
					<div class="btn-group dropup" role="group">
						...
						<ul class="dropdown-menu" role="menu">
							<li><a class="nav-link" href="javascript:void(0)" onclick="caseWorkFlowActions.closeWithSTR('amlUserClosedCaseSerachResult${UNQID}','${UNQID}')">With STR</a></li>
							<li><a class="nav-link" href="javascript:void(0)" onclick="caseWorkFlowActions.closeWithoutSTR('amlUserClosedCaseSerachResult${UNQID}','${UNQID}')">Without STR</a></li>
						</ul>
					</div>
		            ...
		            <div class="btn-group dropup" role="group">
						...
						<ul class="dropdown-menu" role="menu">
							...
							<li><a class="nav-link" href="javascript:void(0)" onclick="caseWorkFlowActions.viewSriLankanSTR('amlUserPendingCaseSerachResult${UNQID}','${UNQID}')">SL STR</a></li>
						</ul>
					</div>
