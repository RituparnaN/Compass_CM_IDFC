			...
			<div class="pull-${dirR} clearfix" style="margin:10px;">
					...
					<div class="btn-group dropup" role="group">
						...
						<ul class="dropdown-menu" role="menu">
							...
							<li><a href="javascript:void(0)" onclick="caseWorkFlowActions.viewIndianSTR('amlUserPendingCaseSerachResult${UNQID}','${UNQID}')">Indian STR-ARF</a></li>
							<li><a href="javascript:void(0)" onclick="caseWorkFlowActions.viewIndianSTRTRF('amlUserPendingCaseSerachResult${UNQID}','${UNQID}')">Indian STR-TRF</a></li>
						</ul>
					</div>
