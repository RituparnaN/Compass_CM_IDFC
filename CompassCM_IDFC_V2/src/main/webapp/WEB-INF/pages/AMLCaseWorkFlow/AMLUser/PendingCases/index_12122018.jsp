				...
				<div class="pull-${dirR} clearfix">
					...
					<div class="btn-group dropup" role="group">
						...
						<ul class="dropdown-menu" role="menu">
							<li><a href="javascript:void(0)" onclick="caseWorkFlowActions.closeWithSTR('amlUserPendingCaseSerachResult${UNQID}','${UNQID}')">Escalate With STR</a></li>
							<li><a href="javascript:void(0)" onclick="caseWorkFlowActions.closeWithoutSTR('amlUserPendingCaseSerachResult${UNQID}','${UNQID}')">Close Without STR</a></li>
						</ul>
					</div>
