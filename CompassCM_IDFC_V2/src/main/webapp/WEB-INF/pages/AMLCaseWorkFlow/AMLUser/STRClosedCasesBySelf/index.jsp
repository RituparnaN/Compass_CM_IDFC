	...
	<div class="col-sm-12">
		<div class="card card-primary panel_amlUserPendingCase">
			<div class="card-header panelSlidingAmlUserPendingCase${UNQID} clearfix">
				<h6 class="card-title pull-${dirL}"><spring:message code="app.common.strClosedcasesBySelfSearchHeader"/></h6>
			...
			<input type="hidden" name="bottomPageUrl" value="AMLCaseWorkFlow/AMLUser/STRClosedCasesBySelf/SearchBottomPage">
		...
		<div class="card card-primary" id="amlUserPendingCaseSerachResultPanel${UNQID}" style="display: none;">
			<div class="card-header panelSlidingAmlUserPendingCase${UNQID} clearfix">
				<h6 class="card-title pull-${dirL}"><spring:message code="app.common.strClosedcasesBySelfResultHeader"/></h6>
				<div class="btn-group pull-${dirR} clearfix">
					<span class="pull-right"><i class="collapsable fa fa-chevron-up"></i></span>
				</div>
			</div>
