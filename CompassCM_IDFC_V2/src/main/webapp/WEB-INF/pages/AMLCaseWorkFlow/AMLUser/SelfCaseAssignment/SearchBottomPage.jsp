...
<script type="text/javascript">
	$(document).ready(function() {
		var id = '${UNQID}';
		var tableClass = 'selfCaseAssignment${UNQID}';
		compassDatatable.construct(tableClass, "SelfCaseAssignment", true);
		compassDatatable.enableCheckBoxSelection();
	});
</script>
<div>
	<table class="table table-bordered table-striped searchResultGenericTable selfCaseAssignment${UNQID}" style="margin-bottom: 0px;">
		<thead>
			<tr>
				<th class="info no-sort" style="text-align: center;">
					<input type="checkbox" class="checkbox-check-all" compassTable="selfCaseAssignment${UNQID}" id="selfCaseAssignment${UNQID}" />
				</th>
