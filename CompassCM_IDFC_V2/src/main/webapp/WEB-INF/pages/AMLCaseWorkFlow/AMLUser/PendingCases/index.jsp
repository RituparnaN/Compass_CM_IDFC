			...
			<div class="pull-${dirR} clearfix" style="margin:10px;">
					...
					<div class="btn-group dropdown" role="group">
						...
						<ul class="dropdown-menu" role="menu">
							<li><a class="nav-link" href="javascript:void(0)" onclick="caseWorkFlowActions.bonafideOkay('amlUserPendingCaseSerachResult${UNQID}','${UNQID}')">Bonafide Okay</a></li>
							<li><a class="nav-link" href="javascript:void(0)" onclick="caseWorkFlowActions.raisedForReviewByAMLUser('amlUserPendingCaseSerachResult${UNQID}','${UNQID}')">For Review</a></li>
							<li><a class="nav-link" href="javascript:void(0)" onclick="caseWorkFlowActions.raisedForSTRByAMLUser('amlUserPendingCaseSerachResult${UNQID}','${UNQID}')">For STR</a></li>
							<li><a class="nav-link" href="javascript:void(0)" onclick="caseWorkFlowActions.recommendForSuppressionByAMLUser('amlUserPendingCaseSerachResult${UNQID}','${UNQID}')">Recommend For Suppression</a></li>
							<!--
					...
					<div class="btn-group dropup" role="group">
						...
						<ul class="dropdown-menu" role="menu">
							...
							<li><a class="nav-link" href="javascript:void(0)" onclick="caseWorkFlowActions.viewIndianSTR('amlUserPendingCaseSerachResult${UNQID}','${UNQID}')">Indian STR-ARF</a></li>
							<li><a class="nav-link" href="javascript:void(0)" onclick="caseWorkFlowActions.viewIndianSTRTRF('amlUserPendingCaseSerachResult${UNQID}','${UNQID}')">Indian STR-TRF</a></li>
						</ul>
					</div>
					...
					<button type="button" class="btn btn-primary btn-sm" onclick="caseWorkFlowActions.assignToBranchUserByAMLuser('amlUserPendingCaseSerachResult${UNQID}','${UNQID}')">Assign to Branch</button>
					...
					<div class="btn-group dropup" role="group">
						...
						<ul class="dropdown-menu" role="menu">
						 	<li><a class="nav-link" href="javascript:void(0)" id="showEntityTabView${UNQID}">Tab View</a></li>
							<li><a class="nav-link" href="javascript:void(0)" class="showEntityGraphView" view="H">Horizontal View</a></li>
							<li><a class="nav-link" href="javascript:void(0)"  class="showEntityGraphView" view="V">Vertical View</a></li>
						</ul>
					</div>
