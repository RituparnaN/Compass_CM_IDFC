			...
			<div class="pull-${dirR} clearfix" style="margin:10px;">
					...
					<div class="btn-group dropdown" role="group">
						...
						<ul class="dropdown-menu" role="menu">
							...
							<li><a href="javascript:void(0)" onclick="caseWorkFlowActions.raisedForReviewByAMLUser('amlUserPendingCaseSerachResult${UNQID}','${UNQID}')">Raised for Review</a></li>
							<li><a href="javascript:void(0)" onclick="caseWorkFlowActions.raisedForSTRByAMLUser('amlUserPendingCaseSerachResult${UNQID}','${UNQID}')">Raised For STR</a></li>
					...
					<button type="button" class="btn btn-primary btn-sm" onclick="caseWorkFlowActions.reAllocatingToAMLUSER('amlUserPendingCaseSerachResult${UNQID}','${UNQID}')">Reallocate To Other</button>
