...
<form name = "roboScan" id = "roboScan" onsubmit = "return false" >
	...
	<div class=" col-sm-offset-1 col-sm-10" id="topheader">		
			<table class="table" style="margin-bottom: 0;margin-top: 10px;background-color: #3498DB;">
				<tr>
					<!-- <td><h3>RoboScan - Intelligent Case Summary</h3></td> -->
					<td width="90%">
						<img src="${pageContext.request.contextPath}/includes/images/roboscan_banner.jpg" style="height:60px;margin-top:5px;width:880px; " alt="RoboScan"> 
					</td>
					<td width="10%">
