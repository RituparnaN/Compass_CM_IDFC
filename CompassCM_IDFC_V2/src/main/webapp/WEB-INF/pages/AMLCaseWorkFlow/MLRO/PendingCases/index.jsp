...
<div class="row compassrow${UNQID}">
	<div class="col-sm-12">
		<div class="card card-primary panel_amlUserPendingCase">
			...
			<input type="hidden" name="bottomPageUrl" value="AMLCaseWorkFlow/MLRO/PendingCases/SearchBottomPage">
			...
			<div class="pull-${dirR} clearfix" style="margin:10px;">
					...
					<div class="btn-group dropdown" role="group">
						...
						<ul class="dropdown-menu" role="menu">
							<li><a class="nav-link" href="javascript:void(0)" onclick="caseWorkFlowActions.bonafideOkayByMLRO('amlUserPendingCaseSerachResult${UNQID}','${UNQID}')">Bonafide Okay</a></li>
							<li><a class="nav-link" href="javascript:void(0)" onclick="caseWorkFlowActions.approvedByMLRO('amlUserPendingCaseSerachResult${UNQID}','${UNQID}')">Approve</a></li>
							<li><a class="nav-link" href="javascript:void(0)" onclick="caseWorkFlowActions.rejectedByMLRO('amlUserPendingCaseSerachResult${UNQID}','${UNQID}')">Reject</a></li>
						</ul>
					</div>
					...
					<!--<button type="button" class="btn btn-primary btn-sm" id="assignToAMLO${UNQID}">Assign To AMLO</button>-->
					<%-- <button type="button" class="btn btn-primary btn-sm" onclick="caseWorkFlowActions.reAssignBackToUser('amlUserPendingCaseSerachResult${UNQID}','${UNQID}')">ReAssign To AMLO</button> --%>
