	...
	<div class="col-sm-12">
		<div class="card card-primary panel_amlUserPendingCase">
			<div class="card-header panelSlidingAmlUserPendingCase${UNQID} clearfix">
				<h6 class="card-title pull-${dirL}"><spring:message code="app.common.mlroParkedToWatchListCaseSearchHeader"/></h6>
			...
			<input type="hidden" name="bottomPageUrl" value="AMLCaseWorkFlow/MLRO/ParkedToWatchListCases/SearchBottomPage">
		...
		<div class="card card-primary" id="amlUserPendingCaseSerachResultPanel${UNQID}" style="display: none;">
			<div class="card-header panelSlidingAmlUserPendingCase${UNQID} clearfix">
				<h6 class="card-title pull-${dirL}"><spring:message code="app.common.mlroParkedToWatchListCaseResultHeader"/></h6>
				<div class="btn-group pull-${dirR} clearfix">
					<span class="pull-right"><i class="collapsable fa fa-chevron-up"></i></span>
				</div>
			</div>
			...
			<div class="card-footer action-footer clearfix">
				<div class="pull-${dirR} clearfix">
					...
					<button type="button" class="btn btn-primary btn-sm" onclick="caseWorkFlowActions.rejectSTRByMLRO('amlUserPendingCaseSerachResult${UNQID}','${UNQID}')">Reject STR</button>
					
					<button type="button" class="btn btn-primary btn-sm" onclick="caseWorkFlowActions.fileSTRByMLRO('amlUserPendingCaseSerachResult${UNQID}','${UNQID}')">File STR</button>
		            ...
		            <div class="btn-group dropup" role="group">
						...
						<ul class="dropdown-menu" role="menu">
							<li><a class="nav-link" href="javascript:void(0)" onclick="caseWorkFlowActions.viewIndianSTR('amlUserPendingCaseSerachResult${UNQID}','${UNQID}')">Indian STR</a></li>
							...
							<li><a href="javascript:void(0)" onclick="caseWorkFlowActions.viewSeychellesSTR('amlUserPendingCaseSerachResult${UNQID}','${UNQID}')">Seychelles STR</a></li>
							<li><a href="javascript:void(0)" onclick="caseWorkFlowActions.viewSingaporeSTR('amlUserPendingCaseSerachResult${UNQID}','${UNQID}')">Singapore STR</a></li>
							<li><a href="javascript:void(0)" onclick="caseWorkFlowActions.viewUSSTR('amlUserPendingCaseSerachResult${UNQID}','${UNQID}')">USA SAR</a></li>
							<li><a href="javascript:void(0)" onclick="caseWorkFlowActions.viewKENYASTR('amlUserPendingCaseSerachResult${UNQID}')">Kenya SAR</a></li>
							<li><a href="javascript:void(0)" onclick="caseWorkFlowActions.viewMauritiusSTR('amlUserPendingCaseSerachResult${UNQID}')">Mauritius STR</a></li>-->
						</ul>
					</div>
