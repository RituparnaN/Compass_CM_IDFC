...
<script type="text/javascript">
	$(document).ready(function() {
		...
		if(moduleType == 'viewCasesToBeReviewedByAMLO') {
			$('#searchMasterForm'+id).trigger('submit');
		}
	...
	<div class="col-sm-12">
		<div class="card card-primary panel_amlUserPendingCase">
			<div class="card-header panelSlidingAmlUserPendingCase${UNQID} clearfix">
				<h6 class="card-title pull-${dirL}">Search Cases</h6>
			...
			<input type="hidden" name="bottomPageUrl" value="AMLCaseWorkFlow/AMLO/CasesToBeReviewed/SearchBottomPage">
		...
		<div class="card card-primary" id="amlUserPendingCaseSerachResultPanel${UNQID}" style="display: none;">
			<div class="card-header panelSlidingAmlUserPendingCase${UNQID} clearfix">
				<h6 class="card-title pull-${dirL}">Cases result</h6>
				<div class="btn-group pull-${dirR} clearfix">
					<span class="pull-right"><i class="collapsable fa fa-chevron-up"></i></span>
				</div>
			</div>
			<div class="pull-${dirR} clearfix" style="margin:10px;">
					...
					<div class="btn-group dropdown" role="group">
						...
						<ul class="dropdown-menu" role="menu">
							<li><a class="nav-link" href="javascript:void(0)" onclick="caseWorkFlowActions.okayByAMLO('amlUserPendingCaseSerachResult${UNQID}','${UNQID}')">Review found to be ok</a></li>
							<li><a class="nav-link" href="javascript:void(0)" onclick="caseWorkFlowActions.toBeReviewedByAMLO('amlUserPendingCaseSerachResult${UNQID}','${UNQID}')">Re-open Case</a></li>
						</ul>
					</div>
