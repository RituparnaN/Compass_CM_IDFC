		...
		<div class="card card-primary panel_falsePositive">
			...
			<form action="javascript:void(0)" method="POST" id="searchMasterForm${UNQID}">
					...
					<tr>
						...
						<td width="30%">
							...
							<c:if test="${action eq 'toBeReviewedByAMLO'}">
								<option value="ICI">Investigation comments incomplete</option>
				...
				<div class="card-footer clearfix">
					<div class="pull-${dirR}">
						<input type="button" id="saveCommentsForCasesToBeReviewed${UNQID}" class="btn btn-success btn-sm" name="Save" value="Save">
					</div>
				</div>
			</form>
			</div>
