...
<div class="row compassrow${UNQID}">
	<div class="col-sm-12">
		<div class="card card-primary panel_amlUserPendingCase">
			...
			<input type="hidden" name="bottomPageUrl" value="AMLCaseWorkFlow/AMLO/PendingCases/SearchBottomPage">
			...
			<div class="pull-${dirR} clearfix" style="margin:10px;">
					...
					<div class="btn-group dropdown" role="group">
						...
						<ul class="dropdown-menu" role="menu">
							<li><a class="nav-link" href="javascript:void(0)" onclick="caseWorkFlowActions.bonafideOkayByAMLO('amlUserPendingCaseSerachResult${UNQID}','${UNQID}')">Bonafide Okay</a></li>
							<li><a class="nav-link" href="javascript:void(0)" onclick="caseWorkFlowActions.approvedByAMLO('amlUserPendingCaseSerachResult${UNQID}','${UNQID}')">Approve</a></li>
							<li><a class="nav-link" href="javascript:void(0)" onclick="caseWorkFlowActions.rejectedByAMLO('amlUserPendingCaseSerachResult${UNQID}','${UNQID}')">Reject</a></li>
							<li><a class="nav-link" href="javascript:void(0)" onclick="caseWorkFlowActions.raisedForReviewByAMLO('amlUserPendingCaseSerachResult${UNQID}','${UNQID}')">For Review</a></li>
						</ul>
					</div>
					<%-- <button type="button" class="btn btn-primary btn-sm" onclick="caseWorkFlowActions.rejectSTRByAMLO('amlUserPendingCaseSerachResult${UNQID}','${UNQID}')">Reject STR</button>
					
					<button type="button" class="btn btn-primary btn-sm" onclick="caseWorkFlowActions.approveSTRByAMLO('amlUserPendingCaseSerachResult${UNQID}','${UNQID}')">Approve STR</button> --%>
					<!-- <button type="button" class="btn btn-primary btn-sm" onclick="caseWorkFlowActions.closeWithHindSightingByAMLO('amlUserPendingCaseSerachResult${UNQID}','${UNQID}')">Close With HindSighting</button>
					<button type="button" class="btn btn-primary btn-sm" onclick="caseWorkFlowActions.closeWithoutHindSightingByAMLO('amlUserPendingCaseSerachResult${UNQID}','${UNQID}')">Close Without HindSighting</button> -->
					...
					<button type="button" class="btn btn-primary btn-sm" onclick="caseWorkFlowActions.reAssignToAMLUSER('amlUserPendingCaseSerachResult${UNQID}','${UNQID}')">ReAssign To AMLUser</button>
