...
<body>
	...
	<div class="card-body">
		<div class="errorDiv"
			...
			<div class="error" style="font-size: 50px">4<font style="color:red">0</font>5</div>
			<div class="errorDesc" style="font-size: 22px">Request method is
				not supported...</div>
