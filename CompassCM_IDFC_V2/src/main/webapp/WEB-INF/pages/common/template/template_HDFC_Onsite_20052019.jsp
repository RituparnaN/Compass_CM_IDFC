	...
	<div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0;position:fixed !important; width:100%;">
            <div class="navbar-header" style="min-height: 50px; display: inline-block;">
				...
				<a class="navbar-brand" href="javascript:navigate('Overview','Overview','common/getDashboardGraph','1')" style="margin-top: -5px; padding: 15px 0 15px 0;"> 
				...
				<span>
					...
					<img alt="HDFC" src='${pageContext.request.contextPath}/includes/images/HDFC_Logo.jpg'
						width="20px" height="20px" style="margin-top: 10px;" />
				</span>				
			</div>
