...
<script type="text/javascript">
	$(document).ready(function(){
		...
		$("#attachFile").click(function(){
			...
			$.ajax({
				url : "${pageContext.request.contextPath}/common/attachAndProcessCCRUploadedFile",
				type: "POST",
				cache : false,
...
<table class="table table-bordered table-striped">
	<tr>
		...
		<td width="25%">
			<button type="button" class="btn btn-warning btn-xs" onclick="compassFileUpload.downloadFile(this, '', '${uploadRefNo}', '${moduleRefId}', '')">Download All</button>
		</td>
	</tr>
	<c:forEach var="fileInfo" items="${FILEINFO}">
		<tr>
			...
			<td><button class="btn btn-warning btn-xs" onclick="compassFileUpload.downloadFile(this, ${fileInfo['SEQNO']},'${uploadRefNo}','${moduleRefId}', '')">Download</button></td>
		</tr>
	</c:forEach>
	<tr>
		<td colspan="4">&nbsp;</td>
