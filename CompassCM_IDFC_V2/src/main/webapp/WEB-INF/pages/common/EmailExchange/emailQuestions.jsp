...
$(document).ready(function() {
	...
	$("#openEmailQuestionModalInWindow").click(function(){
		let url = "${pageContext.request.contextPath}/common/getEmailQuestionsForNewWindow?previousQuestions="+$("#hiddenPreviousQuestions").text();
		window.open(url,"Email Questions for caseNo= ${CASENO}",'height=600px,width=1000px' );
		$("#compassEmailQuestionModal").modal("hide");
	});
...
<div class="card card-default " id="emailQuestionsMainDiv${UNQID}" style="margin-bottom: 0; height: 495px;">
	<div class="card-body" style="padding:5px 0 0 0; height: 445px;" >
		...
		<div class="table" style="padding: 0 5px 0 5px; margin: 0; display:none; max-height:290px; min-height:210px; overflow: auto;" id="tableDiv${UNQID}">
