...
<script type="text/javascript">
	$(document).ready(function() {
		...
		$("#selectValuesFromSearch").click(function(){
			var selectedValArr = [];
			var selectedVal;
			var colIndex = $("#moduleResultPanel").find("table").children("thead").children("tr").find("TH#"+serachFor.toUpperCase()).index()+1;
	...
	function searchModuleValue(){
		...
		alert("searchFieldId="+searchFieldId+"&serachFor="+serachFor+"&viewName="+viewName+"&isMultipleSelect="+isMultipleSelect+"&moduleSearchBy="+moduleSearchBy+"&moduleSearchType="+moduleSearchType+"&moduleSearchValue="+moduleSearchValue);
		$.ajax({
			url : "${pageContext.request.contextPath}/commonFromPortal/searchGenericModuleFields",
			cache : false,
