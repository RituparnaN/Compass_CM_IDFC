...
<script type="text/javascript">
	...
	function downloadGeneratedXMLFile(fileSeqNo, fileName, filePath){
		compassFileUpload.init("viewGeneratedCTRFiles","${pageContext.request.contextPath}","generatedCTRFiles","","N","N", fileSeqNo);
	}
...
<div id="searchResultGenericDiv">
	...
	<div class="card-footer clearfix">
		<div class="pull-${dirR}">
			<button type="button" class="btn btn-primary btn-sm" id="editCtr${UNQID}">Edit Details</button>
		</div>
	</div>
</div>
<script>
	...
	$("#editCtr"+id).click(function(){
		...
		if(selectedFileSeq !== undefined){
			...
			// update code
			$.ajax({
				url: "${pageContext.request.contextPath}/common/editCTRDetails",
				cache:	false,
				type: "POST",
				data: {selectedFileSeq:selectedFileSeq, viewCtrButton:viewCtrButton},
