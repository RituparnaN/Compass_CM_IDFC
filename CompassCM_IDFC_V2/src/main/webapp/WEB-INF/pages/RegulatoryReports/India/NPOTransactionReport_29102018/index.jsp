	...
	$(document).ready(function() {
		...
		$("#searchMasterForm"+id).submit(function(e){
			if(buttonId ==  "viewGeneratedNtrFiles"+id){
				var viewNtrButton = $("#viewGeneratedNtrFiles"+id);
				...
				$.ajax({
					url: "${pageContext.request.contextPath}/common/viewGeneratedNTRFilesMaster",
					data: $(this).serialize() + "&viewFilePageUrl=RegulatoryReports/India/NPOTransactionReport/ViewGeneratedFile"+"&viewNtrButton="+buttonId,
					type: "POST",
					success: function(res){
						
						$("#npoTransactionReportSerachResult"+id).html(res);
						$("#npoTransactionReportSerachResultPanel"+id).show();
						$(panelBody).slideUp();
