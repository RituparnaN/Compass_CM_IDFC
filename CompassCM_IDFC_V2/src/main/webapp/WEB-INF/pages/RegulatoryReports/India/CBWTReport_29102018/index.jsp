	...
	$(document).ready(function() {
		...
		$("#searchMasterForm"+id).submit(function(e){
			if(buttonId ==  "viewGeneratedCbwtrFiles"+id){
				var viewCbwtrButton = $("#viewGeneratedCbwtrFiles"+id);
				...
				$.ajax({
					url: "${pageContext.request.contextPath}/common/viewGeneratedCBWTRFilesMaster",
					data: $(this).serialize() + "&viewFilePageUrl=RegulatoryReports/India/CBWTReport/ViewGeneratedFile"+"&viewCbwtrButton="+buttonId,
					type: "POST",
					success: function(res){
						
						$("#cbwtReportSerachResult"+id).html(res);
						$("#cbwtReportSerachResultPanel"+id).show();
						$(panelBody).slideUp();
