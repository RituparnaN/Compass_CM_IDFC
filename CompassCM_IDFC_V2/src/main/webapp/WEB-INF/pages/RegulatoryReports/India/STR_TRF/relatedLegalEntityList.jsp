...
{
var caseNo = '<%= caseNo%>';
<%--  var win= window.open('<%=contextPath%>/IndianRegulatoryReport/str/addLegalDetails.jsp?caseNo='+caseNo,'NEWANNEXUREB',"top=150, height=600, width=750,scrollbars=yes,toolbar=yes,resizable=yes,location=no"); --%>
var win= window.open('<%=contextPath%>/common/addNewLegalDetailsInSTRTRF?caseNo='+caseNo,'NEWANNEXUREB',"top=150, height=600, width=750,scrollbars=yes,toolbar=yes,resizable=yes,location=no");
}
...
var caseNo = '<%= caseNo%>';
window.open('<%=contextPath%>/common/getNewINDSTRTRFEntities?caseNo='+caseNo+'&legalAcctNo='+strAcctNo+'&legalName='+custName+'&legalId='+custID+'&annexure='+annexure+'&CallFrom='+callfrom,'ANNEXUREB','top=150, height=600, width=750,scrollbars=yes,toolbar=yes,resizable=yes,location=no');
}
...
if(conf)
{	
	this.parent.location.replace('<%=contextPath%>/common/deleteNewINDSTRTRFEntities?caseNo='+caseNo+'&legalAcctNo='+strAcctNo+'&legalName='+custName+'&legalId='+custID+'&CallFrom='+callfrom);
}
}
-->
</script>
