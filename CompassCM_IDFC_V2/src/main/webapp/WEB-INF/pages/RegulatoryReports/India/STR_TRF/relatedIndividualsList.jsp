...
function addNewIndividual()
{
	...
	var win= window.open('<%=contextPath%>/common/addNewIndividualDetailsInSTRTRF?caseNo='+caseNo,'NEWANNEXUREA',"top=150, height=600, width=800,scrollbars=yes,toolbar=yes,resizable=yes,location=no");
}
...
function updateIndividualDetails(strName,strID,strAcct,strAnnexure)
{
	...
	var caseNo = '<%= caseNo%>';
	window.open('<%=contextPath%>/common/getNewINDSTRTRFIndividuals?indvName='+custName+'&indvId='+custID+'&acctNo='+accountNo+'&annexure='+annexure+'&CallFrom='+callfrom,'ANNEXUREA','top=150, height=600, width=750,scrollbars=yes,toolbar=yes,resizable=yes,location=no');
}
...
function deleteIndividualDetails(strName,strID,strAcct,strAnnexure,strRelationType)
{
	...
	if(conf)
	{	
		this.parent.location.replace('<%=contextPath%>/common/deleteNewINDSTRTRFIndividuals?indvName='+custName+'&indvId='+custID+'&acctNo='+accountNo+'&CallFrom='+callfrom+'&relationType='+relationType);
	}
}
-->
</script>
