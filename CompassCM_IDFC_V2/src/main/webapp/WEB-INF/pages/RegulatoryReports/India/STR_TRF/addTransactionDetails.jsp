...
String strInstrIssInstRefno = "";
String strInstrCountryCode = "";
String strPurposeCode = "";
String strRltdInstRefNo = "";
String strInstrHolderName	= "";
String strRltnshpBegDate	= "";
String strCumPurchaseTurnover	= "";
String strTxnSeqNo = "";
...
if(objISTRTranDetailsVO != null){
	...
	strCustomerId = (objISTRTranDetailsVO.getCustomerId() == null) ? "" : objISTRTranDetailsVO.getCustomerId();
	...
	strInstrIssInstRefno = (objISTRTranDetailsVO.getInstrIssInstRefno() == null) ? "" : objISTRTranDetailsVO.getInstrIssInstRefno();
	strInstrCountryCode = (objISTRTranDetailsVO.getInstrCountryCode() == null) ? "" : objISTRTranDetailsVO.getInstrCountryCode();
	strPurposeCode	= (objISTRTranDetailsVO.getPurposeCode() == null) ? "" : objISTRTranDetailsVO.getPurposeCode();
	strRltdInstRefNo	= (objISTRTranDetailsVO.getRltdInstRefNo() == null) ? "" : objISTRTranDetailsVO.getRltdInstRefNo();
	strInstrHolderName	= (objISTRTranDetailsVO.getInstrHolderName() == null) ? "" : objISTRTranDetailsVO.getInstrHolderName();
	strRltnshpBegDate	= (objISTRTranDetailsVO.getRltnshpBegDate() == null) ? "" : objISTRTranDetailsVO.getRltnshpBegDate();
	strCumPurchaseTurnover	= (objISTRTranDetailsVO.getCumPurchaseTurnover() == null) ? "" : objISTRTranDetailsVO.getCumPurchaseTurnover();
...
<div class="section" style="height : auto;">
	...
	<div class="normalTextField">
		...
		<input type="text"  name="transactionTime" placeholder="hh:mm:ss" <%=readOnly%> value="<%=strTransactionTime%>" class="topOpenTextBox" size=8 maxlength=8 id="transactionTime"/>
	</div>
	<div class="normalTextField">
	...
	<div class="normalTextField">
		...
		<select name="instrumentType" <%=disabled%>>
			...
			<option value="C" <% if(strInstrumentType.equals("C")) {%>selected<% } %>>C - Demand Draft / Pay Order</option>
	...
	<div class="normalTextField">
		<label>18. Instrument Issue Institution Ref Num</label>
		<input type="text" name="instrIssInstRefno" <%=readOnly%> class="txt2" size=30 maxlength=30 value="<%=strInstrIssInstRefno%>"/>
	</div>
	
	<div class="normalTextField">
		<label>19. Instrument Holder Name</label>
		<input type="text" name="instrHolderName" <%=readOnly%> class="txt2" size=30 maxlength=30 value="<%=strInstrHolderName%>"/>
	</div>
	
	<div class="normalTextField">
		<label>20. Relationship Beginning Date</label>
		<input type="text" name="rltnshpBegDate" <%=readOnly%> class="topOpenTextBox datepicker" placeholder="YYYY-MM-DD"  value="<%=strRltnshpBegDate%>"/>
	</div>
	
	<div class="normalTextField">
		<label>21. Cumulative Purchase Turnover</label>
		<input type="text" name="cumPurchaseTurnover" <%=readOnly%> class="txt2" size=30 maxlength=30 value="<%=strCumPurchaseTurnover%>"/>
	</div>
	
	<div class="normalTextField">
		<label>22. Instrument Country Code</label>
		<select name="instrCountryCode" <%=readOnly%>>
			<option value="">Select</option>
			<c:forEach var="countryCodesList" items="${COUNTRYCODES}">
				<option value="${countryCodesList.key}">${countryCodesList.value}</option>
			</c:forEach>
			<%-- <option value="IN" title="India" <% if(strInstrCountryCode.equals("IN") || strInstrCountryCode.equals("")) {%>selected<% } %>>IN-India</option>
			<option value="AF" title="Afghanistan" <% if(strInstrCountryCode.equals("AF")) {%>selected<% } %>>AF-Afghanistan</option>
			<option value="AX" title="Aland Islands" <% if(strInstrCountryCode.equals("AX")) {%>selected<% } %>>AX-Aland Islands</option>
			<option value="AL" title="Albania" <% if(strInstrCountryCode.equals("AL")) {%>selected<% } %>>AL-Albania</option>
			<option value="DZ" title="Algeria" <% if(strInstrCountryCode.equals("DZ")) {%>selected<% } %>>DZ-Algeria</option>
			<option value="AS" title="American Samoa" <% if(strInstrCountryCode.equals("AS")) {%>selected<% } %>>AS-American Samoa</option>
			<option value="AD" title="Andorra" <% if(strInstrCountryCode.equals("AD")) {%>selected<% } %>>AD-Andorra</option>
			<option value="AO" title="Angola" <% if(strInstrCountryCode.equals("AO")) {%>selected<% } %>>AO-Angola</option>
			<option value="AI" title="Anguilla" <% if(strInstrCountryCode.equals("AI")) {%>selected<% } %>>AI-Anguilla</option>
			<option value="AQ" title="Antarctica" <% if(strInstrCountryCode.equals("AQ")) {%>selected<% } %>>AQ-Antarctica</option>
			<option value="AG" title="Antigua And Barbuda" <% if(strInstrCountryCode.equals("AG")) {%>selected<% } %>>AG-Antigua And Barbuda</option>
			<option value="AR" title="Argentina" <% if(strInstrCountryCode.equals("AR")) {%>selected<% } %>>AR-Argentina</option>
			<option value="AM" title="Armenia" <% if(strInstrCountryCode.equals("AM")) {%>selected<% } %>>AM-Armenia</option>
			<option value="AW" title="Aruba" <% if(strInstrCountryCode.equals("AW")) {%>selected<% } %>>AW-Aruba</option>
			<option value="AU" title="Australia" <% if(strInstrCountryCode.equals("AU")) {%>selected<% } %>>AU-Australia</option>
			<option value="AT" title="Austria" <% if(strInstrCountryCode.equals("AT")) {%>selected<% } %>>AT-Austria</option>
			<option value="AZ" title="Azerbaijan" <% if(strInstrCountryCode.equals("AZ")) {%>selected<% } %>>AZ-Azerbaijan</option>
			<option value="BS" title="Bahamas" <% if(strInstrCountryCode.equals("BS")) {%>selected<% } %>>BS-Bahamas</option>
			<option value="BH" title="Bahrain" <% if(strInstrCountryCode.equals("BH")) {%>selected<% } %>>BH-Bahrain</option>
			<option value="BD" title="Bangladesh" <% if(strInstrCountryCode.equals("BD")) {%>selected<% } %>>BD-Bangladesh</option>
			<option value="BB" title="Barbados" <% if(strInstrCountryCode.equals("BB")) {%>selected<% } %>>BB-Barbados</option>
			<option value="BY" title="Belarus" <% if(strInstrCountryCode.equals("BY")) {%>selected<% } %>>BY-Belarus</option>
			<option value="BE" title="Belgium" <% if(strInstrCountryCode.equals("BE")) {%>selected<% } %>>BE-Belgium</option>
			<option value="BZ" title="Belize" <% if(strInstrCountryCode.equals("BZ")) {%>selected<% } %>>BZ-Belize</option>
			<option value="BJ" title="Benin" <% if(strInstrCountryCode.equals("BJ")) {%>selected<% } %>>BJ-Benin</option>
			<option value="BM" title="Bermuda" <% if(strInstrCountryCode.equals("BM")) {%>selected<% } %>>BM-Bermuda</option>
			<option value="BT" title="Bhutan" <% if(strInstrCountryCode.equals("BT")) {%>selected<% } %>>BT-Bhutan</option>
			<option value="BO" title="Bolivia" <% if(strInstrCountryCode.equals("BO")) {%>selected<% } %>>BO-Bolivia</option>
			<option value="BA" title="Bosnia And Herzegovina" <% if(strInstrCountryCode.equals("BA")) {%>selected<% } %>>BA-Bosnia And Herzegovina</option>
			<option value="BW" title="Botswana" <% if(strInstrCountryCode.equals("BW")) {%>selected<% } %>>BW-Botswana</option>
			<option value="BV" title="Bouvet Island" <% if(strInstrCountryCode.equals("BV")) {%>selected<% } %>>BV-Bouvet Island</option>
			<option value="BR" title="Brazil" <% if(strInstrCountryCode.equals("BR")) {%>selected<% } %>>BR-Brazil</option>
			<option value="IO" title="British Indian Ocean Territory" <% if(strInstrCountryCode.equals("IO")) {%>selected<% } %>>IO-British Indian Ocean Territory</option>
			<option value="BN" title="Brunei Darussalam" <% if(strInstrCountryCode.equals("BN")) {%>selected<% } %>>BN-Brunei Darussalam</option>
			<option value="BG" title="Bulgaria" <% if(strInstrCountryCode.equals("BG")) {%>selected<% } %>>BG-Bulgaria</option>
			<option value="BF" title="Burkina Faso" <% if(strInstrCountryCode.equals("BF")) {%>selected<% } %>>BF-Burkina Faso</option>
			<option value="BI" title="Burundi" <% if(strInstrCountryCode.equals("BI")) {%>selected<% } %>>BI-Burundi</option>
			<option value="KH" title="Cambodia" <% if(strInstrCountryCode.equals("KH")) {%>selected<% } %>>KH-Cambodia</option>
			<option value="CM" title="Cameroon" <% if(strInstrCountryCode.equals("CM")) {%>selected<% } %>>CM-Cameroon</option>
			<option value="CA" title="Canada" <% if(strInstrCountryCode.equals("CA")) {%>selected<% } %>>CA-Canada</option>
			<option value="CV" title="Cape Verde" <% if(strInstrCountryCode.equals("CV")) {%>selected<% } %>>CV-Cape Verde</option>
			<option value="KY" title="Cayman Islands" <% if(strInstrCountryCode.equals("KY")) {%>selected<% } %>>KY-Cayman Islands</option>
			<option value="CF" title="Central African Republic" <% if(strInstrCountryCode.equals("CF")) {%>selected<% } %>>CF-Central African Republic</option>
			<option value="TD" title="Chad" <% if(strInstrCountryCode.equals("TD")) {%>selected<% } %>>TD-Chad</option>
			<option value="CL" title="Chile" <% if(strInstrCountryCode.equals("CL")) {%>selected<% } %>>CL-Chile</option>
			<option value="CN" title="China" <% if(strInstrCountryCode.equals("CN")) {%>selected<% } %>>CN-China</option>
			<option value="CX" title="Christmas Island" <% if(strInstrCountryCode.equals("CX")) {%>selected<% } %>>CX-Christmas Island</option>
			<option value="CC" title="Cocos (Keeling) Islands" <% if(strInstrCountryCode.equals("CC")) {%>selected<% } %>>CC-Cocos (Keeling) Islands</option>
			<option value="CO" title="Colombia" <% if(strInstrCountryCode.equals("CO")) {%>selected<% } %>>CO-Colombia</option>
			<option value="KM" title="Comoros" <% if(strInstrCountryCode.equals("KM")) {%>selected<% } %>>KM-Comoros</option>
			<option value="CG" title="Congo" <% if(strInstrCountryCode.equals("CG")) {%>selected<% } %>>CG-Congo</option>
			<option value="CD" title="Congo,Democratic Republic" <% if(strInstrCountryCode.equals("CD")) {%>selected<% } %>>CD-Congo,Democratic Republic</option>
			<option value="CK" title="Cook Islands" <% if(strInstrCountryCode.equals("CK")) {%>selected<% } %>>CK-Cook Islands</option>
			<option value="CR" title="Costa Rica" <% if(strInstrCountryCode.equals("CR")) {%>selected<% } %>>CR-Costa Rica</option>
			<option value="CI" title="Côte D'ivoire" <% if(strInstrCountryCode.equals("CI")) {%>selected<% } %>>CI-Côte D'ivoire</option>
			<option value="HR" title="Croatia" <% if(strInstrCountryCode.equals("HR")) {%>selected<% } %>>HR-Croatia</option>
			<option value="CU" title="Cuba" <% if(strInstrCountryCode.equals("CU")) {%>selected<% } %>>CU-Cuba</option>
			<option value="CY" title="Cyprus" <% if(strInstrCountryCode.equals("CY")) {%>selected<% } %>>CY-Cyprus</option>
			<option value="CZ" title="Czech Republic" <% if(strInstrCountryCode.equals("CZ")) {%>selected<% } %>>CZ-Czech Republic</option>
			<option value="DK" title="Denmark" <% if(strInstrCountryCode.equals("DK")) {%>selected<% } %>>DK-Denmark</option>
			<option value="DJ" title="Djibouti" <% if(strInstrCountryCode.equals("DJ")) {%>selected<% } %>>DJ-Djibouti</option>
			<option value="DM" title="Dominica" <% if(strInstrCountryCode.equals("DM")) {%>selected<% } %>>DM-Dominica</option>
			<option value="DO" title="Dominican Republic" <% if(strInstrCountryCode.equals("DO")) {%>selected<% } %>>DO-Dominican Republic</option>
			<option value="EC" title="Ecuador" <% if(strInstrCountryCode.equals("EC")) {%>selected<% } %>>EC-Ecuador</option>
			<option value="EG" title="Egypt" <% if(strInstrCountryCode.equals("EG")) {%>selected<% } %>>EG-Egypt</option>
			<option value="SV" title="El Ssalvador" <% if(strInstrCountryCode.equals("SV")) {%>selected<% } %>>SV-El Ssalvador</option>
			<option value="GQ" title="Equatorial Guinea" <% if(strInstrCountryCode.equals("GQ")) {%>selected<% } %>>GQ-Equatorial Guinea</option>
			<option value="ER" title="Eritrea" <% if(strInstrCountryCode.equals("ER")) {%>selected<% } %>>ER-Eritrea</option>
			<option value="EE" title="Estonia" <% if(strInstrCountryCode.equals("EE")) {%>selected<% } %>>EE-Estonia</option>
			<option value="ET" title="Ethiopia" <% if(strInstrCountryCode.equals("ET")) {%>selected<% } %>>ET-Ethiopia</option>
			<option value="FK" title="Falkland Islands (Malvinas)" <% if(strInstrCountryCode.equals("FK")) {%>selected<% } %>>FK-Falkland Islands (Malvinas)</option>
			<option value="FO" title="Faroe Islands" <% if(strInstrCountryCode.equals("FO")) {%>selected<% } %>>FO-Faroe Islands</option>
			<option value="FJ" title="Fiji" <% if(strInstrCountryCode.equals("FJ")) {%>selected<% } %>>FJ-Fiji</option>
			<option value="FI" title="Finland" <% if(strInstrCountryCode.equals("FI")) {%>selected<% } %>>FI-Finland</option>
			<option value="FR" title="France" <% if(strInstrCountryCode.equals("FR")) {%>selected<% } %>>FR-France</option>
			<option value="GF" title="French Guiana" <% if(strInstrCountryCode.equals("GF")) {%>selected<% } %>>GF-French Guiana</option>
			<option value="PF" title="French Polynesia" <% if(strInstrCountryCode.equals("PF")) {%>selected<% } %>>PF-French Polynesia</option>
			<option value="TF" title="French Southern Territories" <% if(strInstrCountryCode.equals("TF")) {%>selected<% } %>>TF-French Southern Territories</option>
			<option value="GA" title="Gabon" <% if(strInstrCountryCode.equals("GA")) {%>selected<% } %>>GA-Gabon</option>
			<option value="GM" title="Gambia" <% if(strInstrCountryCode.equals("GM")) {%>selected<% } %>>GM-Gambia</option>
			<option value="GE" title="Georgia" <% if(strInstrCountryCode.equals("GE")) {%>selected<% } %>>GE-Georgia</option>
			<option value="DE" title="Germany" <% if(strInstrCountryCode.equals("DE")) {%>selected<% } %>>DE-Germany</option>
			<option value="GH" title="Ghana" <% if(strInstrCountryCode.equals("GH")) {%>selected<% } %>>GH-Ghana</option>
			<option value="GI" title="Gibraltar" <% if(strInstrCountryCode.equals("GI")) {%>selected<% } %>>GI-Gibraltar</option>
			<option value="GR" title="Greece" <% if(strInstrCountryCode.equals("GR")) {%>selected<% } %>>GR-Greece</option>
			<option value="GL" title="Greenland" <% if(strInstrCountryCode.equals("GL")) {%>selected<% } %>>GL-Greenland</option>
			<option value="GD" title="Grenada" <% if(strInstrCountryCode.equals("GD")) {%>selected<% } %>>GD-Grenada</option>
			<option value="GP" title="Guadeloupe" <% if(strInstrCountryCode.equals("GP")) {%>selected<% } %>>GP-Guadeloupe</option>
			<option value="GU" title="Guam" <% if(strInstrCountryCode.equals("GU")) {%>selected<% } %>>GU-Guam</option>
			<option value="GT" title="Guatemala" <% if(strInstrCountryCode.equals("GT")) {%>selected<% } %>>GT-Guatemala</option>
			<option value="GG" title="Guernsey" <% if(strInstrCountryCode.equals("GG")) {%>selected<% } %>>GG-Guernsey</option>
			<option value="GN" title="Guinea" <% if(strInstrCountryCode.equals("GN")) {%>selected<% } %>>GN-Guinea</option>
			<option value="GW" title="Guinea-Bisaau" title="Bissau" <% if(strInstrCountryCode.equals("GW")) {%>selected<% } %>>GW-Guinea-Bissau</option>
			<option value="GY" title="Guyana" <% if(strInstrCountryCode.equals("GY")) {%>selected<% } %>>GY-Guyana</option>
			<option value="HT" title="Haiti" <% if(strInstrCountryCode.equals("HT")) {%>selected<% } %>>HT-Haiti</option>
			<option value="HM" title="Heard Island And Mcdonald Islands" <% if(strInstrCountryCode.equals("HM")) {%>selected<% } %>>HM-Heard Island And Mcdonald Islands</option>
			<option value="VA" title="Vatican City State" <% if(strInstrCountryCode.equals("VA")) {%>selected<% } %>>VA-Vatican City State</option>
			<option value="HN" title="Honduras" <% if(strInstrCountryCode.equals("HN")) {%>selected<% } %>>HN-Honduras</option>
			<option value="HK" title="Hong Kong" <% if(strInstrCountryCode.equals("HK")) {%>selected<% } %>>HK-Hong Kong</option>
			<option value="HU" title="Hungary" <% if(strInstrCountryCode.equals("HU")) {%>selected<% } %>>HU-Hungary</option>
			<option value="IS" title="Iceland" <% if(strInstrCountryCode.equals("IS")) {%>selected<% } %>>IS-Iceland</option>
			<option value="ID" title="Indonesia" <% if(strInstrCountryCode.equals("ID")) {%>selected<% } %>>ID-Indonesia</option>
			<option value="IR" title="Iran" <% if(strInstrCountryCode.equals("IR")) {%>selected<% } %>>IR-Iran</option>
			<option value="IQ" title="Iraq" <% if(strInstrCountryCode.equals("IQ")) {%>selected<% } %>>IQ-Iraq</option>
			<option value="IE" title="Ireland" <% if(strInstrCountryCode.equals("IE")) {%>selected<% } %>>IE-Ireland</option>
			<option value="IM" title="Isle Of Man" <% if(strInstrCountryCode.equals("IM")) {%>selected<% } %>>IM-Isle Of Man</option>
			<option value="IL" title="Israel" <% if(strInstrCountryCode.equals("IL")) {%>selected<% } %>>IL-Israel</option>
			<option value="IT" title="Italy" <% if(strInstrCountryCode.equals("IT")) {%>selected<% } %>>IT-Italy</option>
			<option value="JM" title="Jamaica" <% if(strInstrCountryCode.equals("JM")) {%>selected<% } %>>JM-Jamaica</option>
			<option value="JP" title="Japan" <% if(strInstrCountryCode.equals("JP")) {%>selected<% } %>>JP-Japan</option>
			<option value="JE" title="Jersey" <% if(strInstrCountryCode.equals("JE")) {%>selected<% } %>>JE-Jersey</option>
			<option value="JO" title="Jordan" <% if(strInstrCountryCode.equals("JO")) {%>selected<% } %>>JO-Jordan</option>
			<option value="KZ" title="Kazakhstan" <% if(strInstrCountryCode.equals("KZ")) {%>selected<% } %>>KZ-Kazakhstan</option>
			<option value="KE" title="Kenya" <% if(strInstrCountryCode.equals("KE")) {%>selected<% } %>>KE-Kenya</option>
			<option value="KI" title="Kiribati" <% if(strInstrCountryCode.equals("KI")) {%>selected<% } %>>KI-Kiribati</option>
			<option value="KP" title="Korea, Democratic People's Republic" <% if(strInstrCountryCode.equals("KP")) {%>selected<% } %>>KP-Korea, Democratic People's Republic</option>
			<option value="KR" title="Korea" <% if(strInstrCountryCode.equals("KR")) {%>selected<% } %>>KR-Korea</option>
			<option value="KW" title="Kuwait" <% if(strInstrCountryCode.equals("KW")) {%>selected<% } %>>KW-Kuwait</option>
			<option value="KG" title="Kyrgyzstan" <% if(strInstrCountryCode.equals("KG")) {%>selected<% } %>>KG-Kyrgyzstan</option>
			<option value="LA" title="Lao People's Democratic Republic" <% if(strInstrCountryCode.equals("LA")) {%>selected<% } %>>LA-Lao People's Democratic Republic</option>
			<option value="LV" title="Latvia" <% if(strInstrCountryCode.equals("LV")) {%>selected<% } %>>LV-Latvia</option>
			<option value="LB" title="Lebanon" <% if(strInstrCountryCode.equals("LB")) {%>selected<% } %>>LB-Lebanon</option>
			<option value="LS" title="Lesotho" <% if(strInstrCountryCode.equals("LS")) {%>selected<% } %>>LS-Lesotho</option>
			<option value="LR" title="Liberia" <% if(strInstrCountryCode.equals("LR")) {%>selected<% } %>>LR-Liberia</option>
			<option value="LY" title="Libyan Arab Jamahiriya" <% if(strInstrCountryCode.equals("LY")) {%>selected<% } %>>LY-Libyan Arab Jamahiriya</option>
			<option value="LI" title="Liechtenstein" <% if(strInstrCountryCode.equals("LI")) {%>selected<% } %>>LI-Liechtenstein</option>
			<option value="LT" title="Lithuania" <% if(strInstrCountryCode.equals("LT")) {%>selected<% } %>>LT-Lithuania</option>
			<option value="LU" title="Luxembourg" <% if(strInstrCountryCode.equals("LU")) {%>selected<% } %>>LU-Luxembourg</option>
			<option value="MO" title="Macao" <% if(strInstrCountryCode.equals("MO")) {%>selected<% } %>>MO-Macao</option>
			<option value="MK" title="Macedonia, The Former Yugoslav Repub" <% if(strInstrCountryCode.equals("MK")) {%>selected<% } %>>MK-Macedonia, The Former Yugoslav Repub</option>
			<option value="MG" title="Madagascar" <% if(strInstrCountryCode.equals("MG")) {%>selected<% } %>>MG-Madagascar</option>
			<option value="MW" title="Malawi" <% if(strInstrCountryCode.equals("MW")) {%>selected<% } %>>MW-Malawi</option>
			<option value="MY" title="Malaysia" <% if(strInstrCountryCode.equals("MY")) {%>selected<% } %>>MY-Malaysia</option>
			<option value="MV" title="Maldives" <% if(strInstrCountryCode.equals("MV")) {%>selected<% } %>>MV-Maldives</option>
			<option value="ML" title="Mali" <% if(strInstrCountryCode.equals("ML")) {%>selected<% } %>>ML-Mali</option>
			<option value="MT" title="Malta" <% if(strInstrCountryCode.equals("MT")) {%>selected<% } %>>MT-Malta</option>
			<option value="MH" title="Marshall Islands" <% if(strInstrCountryCode.equals("MH")) {%>selected<% } %>>MH-Marshall Islands</option>
			<option value="MQ" title="Martinique" <% if(strInstrCountryCode.equals("MQ")) {%>selected<% } %>>MQ-Martinique</option>
			<option value="MR" title="Mauritania" <% if(strInstrCountryCode.equals("MR")) {%>selected<% } %>>MR-Mauritania</option>
			<option value="MU" title="Mauritius" <% if(strInstrCountryCode.equals("MU")) {%>selected<% } %>>MU-Mauritius</option>
			<option value="YT" title="Mayotte" <% if(strInstrCountryCode.equals("YT")) {%>selected<% } %>>YT-Mayotte</option>
			<option value="MX" title="Mexico" <% if(strInstrCountryCode.equals("MX")) {%>selected<% } %>>MX-Mexico</option>
			<option value="FM" title="Micronesia" <% if(strInstrCountryCode.equals("FM")) {%>selected<% } %>>FM-Micronesia</option>
			<option value="MD" title="Moldova" <% if(strInstrCountryCode.equals("MD")) {%>selected<% } %>>MD-Moldova</option>
			<option value="MC" title="Monaco" <% if(strInstrCountryCode.equals("MC")) {%>selected<% } %>>MC-Monaco</option>
			<option value="MN" title="Mongolia" <% if(strInstrCountryCode.equals("MN")) {%>selected<% } %>>MN-Mongolia</option>
			<option value="ME" title="Montenegro" <% if(strInstrCountryCode.equals("ME")) {%>selected<% } %>>ME-Montenegro</option>
			<option value="MS" title="Montserrat" <% if(strInstrCountryCode.equals("MS")) {%>selected<% } %>>MS-Montserrat</option>
			<option value="MA" title="Morocco" <% if(strInstrCountryCode.equals("MA")) {%>selected<% } %>>MA-Morocco</option>
			<option value="MZ" title="Mozambique" <% if(strInstrCountryCode.equals("MZ")) {%>selected<% } %>>MZ-Mozambique</option>
			<option value="MM" title="Myanmar" <% if(strInstrCountryCode.equals("MM")) {%>selected<% } %>>MM-Myanmar</option>
			<option value="NA" title="Namibia" <% if(strInstrCountryCode.equals("NA")) {%>selected<% } %>>NA-Namibia</option>
			<option value="NR" title="Nauru" <% if(strInstrCountryCode.equals("NR")) {%>selected<% } %>>NR-Nauru</option>
			<option value="NP" title="Nepal" <% if(strInstrCountryCode.equals("NP")) {%>selected<% } %>>NP-Nepal</option>
			<option value="NL" title="Netherlands" <% if(strInstrCountryCode.equals("NL")) {%>selected<% } %>>NL-Netherlands</option>
			<option value="AN" title="Netherlands Antilles" <% if(strInstrCountryCode.equals("AN")) {%>selected<% } %>>AN-Netherlands Antilles</option>
			<option value="NC" title="New Caledonia" <% if(strInstrCountryCode.equals("NC")) {%>selected<% } %>>NC-New Caledonia</option>
			<option value="NZ" title="New Zealand" <% if(strInstrCountryCode.equals("NZ")) {%>selected<% } %>>NZ-New Zealand</option>
			<option value="NI" title="Nicaragua" <% if(strInstrCountryCode.equals("NI")) {%>selected<% } %>>NI-Nicaragua</option>
			<option value="NE" title="Niger" <% if(strInstrCountryCode.equals("NE")) {%>selected<% } %>>NE-Niger</option>
			<option value="NG" title="Nigeria" <% if(strInstrCountryCode.equals("NG")) {%>selected<% } %>>NG-Nigeria</option>
			<option value="NU" title="Niue" <% if(strInstrCountryCode.equals("NU")) {%>selected<% } %>>NU-Niue</option>
			<option value="NF" title="Norfolk Island" <% if(strInstrCountryCode.equals("NF")) {%>selected<% } %>>NF-Norfolk Island</option>
			<option value="MP" title="Northern Mariana Islands" <% if(strInstrCountryCode.equals("MP")) {%>selected<% } %>>MP-Northern Mariana Islands</option>
			<option value="NO" title="Norway" <% if(strInstrCountryCode.equals("NO")) {%>selected<% } %>>NO-Norway</option>
			<option value="OM" title="Oman" <% if(strInstrCountryCode.equals("OM")) {%>selected<% } %>>OM-Oman</option>
			<option value="PK" title="Pakistan" <% if(strInstrCountryCode.equals("PK")) {%>selected<% } %>>PK-Pakistan</option>
			<option value="PW" title="Palau" <% if(strInstrCountryCode.equals("PW")) {%>selected<% } %>>PW-Palau</option>
			<option value="PS" title="Palestinian Territory, Occupied" <% if(strInstrCountryCode.equals("PS")) {%>selected<% } %>>PS-Palestinian Territory, Occupied</option>
			<option value="PA" title="Panama" <% if(strInstrCountryCode.equals("PA")) {%>selected<% } %>>PA-Panama</option>
			<option value="PG" title="Papua New Guinea" <% if(strInstrCountryCode.equals("PG")) {%>selected<% } %>>PG-Papua New Guinea</option>
			<option value="PY" title="Paraguay" <% if(strInstrCountryCode.equals("PY")) {%>selected<% } %>>PY-Paraguay</option>
			<option value="PE" title="Peru" <% if(strInstrCountryCode.equals("PE")) {%>selected<% } %>>PE-Peru</option>
			<option value="PH" title="Philippines" <% if(strInstrCountryCode.equals("PH")) {%>selected<% } %>>PH-Philippines</option>
			<option value="PN" title="Pitcairn" <% if(strInstrCountryCode.equals("PN")) {%>selected<% } %>>PN-Pitcairn</option>
			<option value="PL" title="Poland" <% if(strInstrCountryCode.equals("PL")) {%>selected<% } %>>PL-Poland</option>
			<option value="PT" title="Portugal" <% if(strInstrCountryCode.equals("PT")) {%>selected<% } %>>PT-Portugal</option>
			<option value="PR" title="Puerto Rico" <% if(strInstrCountryCode.equals("PR")) {%>selected<% } %>>PR-Puerto Rico</option>
			<option value="QA" title="Qatar" <% if(strInstrCountryCode.equals("QA")) {%>selected<% } %>>QA-Qatar</option>
			<option value="RE" title="Réunion" <% if(strInstrCountryCode.equals("RE")) {%>selected<% } %>>RE-Réunion</option>
			<option value="RO" title="Romania" <% if(strInstrCountryCode.equals("RO")) {%>selected<% } %>>RO-Romania</option>
			<option value="RU" title="Russian Federation" <% if(strInstrCountryCode.equals("RU")) {%>selected<% } %>>RU-Russian Federation</option>
			<option value="RW" title="Rwanda" <% if(strInstrCountryCode.equals("RW")) {%>selected<% } %>>RW-Rwanda</option>
			<option value="BL" title="Saint Barthélemy" <% if(strInstrCountryCode.equals("BL")) {%>selected<% } %>>BL-Saint Barthélemy</option>
			<option value="SH" title="Saint Helena, Ascension And Tristan" <% if(strInstrCountryCode.equals("SH")) {%>selected<% } %>>SH-Saint Helena, Ascension And Tristan</option>
			<option value="KN" title="Saint Kitts And Nevis" <% if(strInstrCountryCode.equals("KN")) {%>selected<% } %>>KN-Saint Kitts And Nevis</option>
			<option value="LC" title="Saint Lucia" <% if(strInstrCountryCode.equals("LC")) {%>selected<% } %>>LC-Saint Lucia</option>
			<option value="MF" title="Saint Martin" <% if(strInstrCountryCode.equals("MF")) {%>selected<% } %>>MF-Saint Martin</option>
			<option value="PM" title="Saint Pierre And Miquelon" <% if(strInstrCountryCode.equals("PM")) {%>selected<% } %>>PM-Saint Pierre And Miquelon</option>
			<option value="VC" title="Saint Vincent And The Grenadines" <% if(strInstrCountryCode.equals("VC")) {%>selected<% } %>>VC-Saint Vincent And The Grenadines</option>
			<option value="WS" title="Samoa" <% if(strInstrCountryCode.equals("WS")) {%>selected<% } %>>WS-Samoa</option>
			<option value="SM" title="San Marino" <% if(strInstrCountryCode.equals("SM")) {%>selected<% } %>>SM-San Marino</option>
			<option value="ST" title="Sao Tome And Principe" <% if(strInstrCountryCode.equals("ST")) {%>selected<% } %>>ST-Sao Tome And Principe</option>
			<option value="SA" title="Saudi Arabia" <% if(strInstrCountryCode.equals("SA")) {%>selected<% } %>>SA-Saudi Arabia</option>
			<option value="SN" title="Senegal" <% if(strInstrCountryCode.equals("SN")) {%>selected<% } %>>SN-Senegal</option>
			<option value="RS" title="Serbia" <% if(strInstrCountryCode.equals("RS")) {%>selected<% } %>>RS-Serbia</option>
			<option value="SC" title="Seychelles" <% if(strInstrCountryCode.equals("SC")) {%>selected<% } %>>SC-Seychelles</option>
			<option value="SL" title="Sierra Leone" <% if(strInstrCountryCode.equals("SL")) {%>selected<% } %>>SL-Sierra Leone</option>
			<option value="SG" title="Singapore" <% if(strInstrCountryCode.equals("SG")) {%>selected<% } %>>SG-Singapore</option>
			<option value="SK" title="Slovakia" <% if(strInstrCountryCode.equals("SK")) {%>selected<% } %>>SK-Slovakia</option>
			<option value="SI" title="Slovenia" <% if(strInstrCountryCode.equals("SI")) {%>selected<% } %>>SI-Slovenia</option>
			<option value="SB" title="Solomon Islands" <% if(strInstrCountryCode.equals("SB")) {%>selected<% } %>>SB-Solomon Islands</option>
			<option value="SO" title="Somalia" <% if(strInstrCountryCode.equals("SO")) {%>selected<% } %>>SO-Somalia</option>
			<option value="ZA" title="South Africa" <% if(strInstrCountryCode.equals("ZA")) {%>selected<% } %>>ZA-South Africa</option>
			<option value="GS" title="South Georgia And The South Sandwich" <% if(strInstrCountryCode.equals("GS")) {%>selected<% } %>>GS-South Georgia And The South Sandwich</option>
			<option value="ES" title="Spain" <% if(strInstrCountryCode.equals("ES")) {%>selected<% } %>>ES-Spain</option>
			<option value="LK" title="Sri Lanka" <% if(strInstrCountryCode.equals("LK")) {%>selected<% } %>>LK-Sri Lanka</option>
			<option value="SD" title="Sudan" <% if(strInstrCountryCode.equals("SD")) {%>selected<% } %>>SD-Sudan</option>
			<option value="SR" title="Suriname" <% if(strInstrCountryCode.equals("SR")) {%>selected<% } %>>SR-Suriname</option>
			<option value="SJ" title="Svalbard And Jan Mayen" <% if(strInstrCountryCode.equals("SJ")) {%>selected<% } %>>SJ-Svalbard And Jan Mayen</option>
			<option value="SZ" title="Swaziland" <% if(strInstrCountryCode.equals("SZ")) {%>selected<% } %>>SZ-Swaziland</option>
			<option value="SE" title="Sweden" <% if(strInstrCountryCode.equals("SE")) {%>selected<% } %>>SE-Sweden</option>
			<option value="CH" title="Switzerland" <% if(strInstrCountryCode.equals("CH")) {%>selected<% } %>>CH-Switzerland</option>
			<option value="SY" title="Syrian Arab Republic" <% if(strInstrCountryCode.equals("SY")) {%>selected<% } %>>SY-Syrian Arab Republic</option>
			<option value="TW" title="Taiwan, Province Of China" <% if(strInstrCountryCode.equals("TW")) {%>selected<% } %>>TW-Taiwan, Province Of China</option>
			<option value="TJ" title="Tajikistan" <% if(strInstrCountryCode.equals("TJ")) {%>selected<% } %>>TJ-Tajikistan</option>
			<option value="TZ" title="Tanzania" <% if(strInstrCountryCode.equals("TZ")) {%>selected<% } %>>TZ-Tanzania</option>
			<option value="TH" title="Thailand" <% if(strInstrCountryCode.equals("TH")) {%>selected<% } %>>TH-Thailand</option>
			<option value="TL" title="Timor" title="Leste" <% if(strInstrCountryCode.equals("TL")) {%>selected<% } %>>TL-Timor-Leste</option>
			<option value="TG" title="Togo" <% if(strInstrCountryCode.equals("TG")) {%>selected<% } %>>TG-Togo</option>
			<option value="TK" title="Tokelau" <% if(strInstrCountryCode.equals("TK")) {%>selected<% } %>>TK-Tokelau</option>
			<option value="TO" title="Tonga" <% if(strInstrCountryCode.equals("TO")) {%>selected<% } %>>TO-Tonga</option>
			<option value="TT" title="Trinidad And Tobago" <% if(strInstrCountryCode.equals("TT")) {%>selected<% } %>>TT-Trinidad And Tobago</option>
			<option value="TN" title="Tunisia" <% if(strInstrCountryCode.equals("TN")) {%>selected<% } %>>TN-Tunisia</option>
			<option value="TR" title="Turkey" <% if(strInstrCountryCode.equals("TR")) {%>selected<% } %>>TR-Turkey</option>
			<option value="TM" title="Turkmenistan" <% if(strInstrCountryCode.equals("TM")) {%>selected<% } %>>TM-Turkmenistan</option>
			<option value="TC" title="Turks And Caicos Islands" <% if(strInstrCountryCode.equals("TC")) {%>selected<% } %>>TC-Turks And Caicos Islands</option>
			<option value="TV" title="Tuvalu" <% if(strInstrCountryCode.equals("TV")) {%>selected<% } %>>TV-Tuvalu</option>
			<option value="UG" title="Uganda" <% if(strInstrCountryCode.equals("UG")) {%>selected<% } %>>UG-Uganda</option>
			<option value="UA" title="Ukraine" <% if(strInstrCountryCode.equals("UA")) {%>selected<% } %>>UA-Ukraine</option>
			<option value="AE" title="United Arab Emirates" <% if(strInstrCountryCode.equals("AE")) {%>selected<% } %>>AE-United Arab Emirates</option>
			<option value="GB" title="United Kingdom" <% if(strInstrCountryCode.equals("GB")) {%>selected<% } %>>GB-United Kingdom</option>
			<option value="US" title="United States" <% if(strInstrCountryCode.equals("US")) {%>selected<% } %>>US-United States</option>
			<option value="UM" title="United States Minor Outlying Islands" <% if(strInstrCountryCode.equals("UM")) {%>selected<% } %>>UM-United States Minor Outlying Islands</option>
			<option value="UY" title="Uruguay" <% if(strInstrCountryCode.equals("UY")) {%>selected<% } %>>UY-Uruguay</option>
			<option value="UZ" title="Uzbekistan" <% if(strInstrCountryCode.equals("UZ")) {%>selected<% } %>>UZ-Uzbekistan</option>
			<option value="VU" title="Vanuatu" <% if(strInstrCountryCode.equals("VU")) {%>selected<% } %>>VU-Vanuatu</option>
			<option value="VE" title="Venezuela" <% if(strInstrCountryCode.equals("VE")) {%>selected<% } %>>VE-Venezuela</option>
			<option value="VN" title="Viet Nam" <% if(strInstrCountryCode.equals("VN")) {%>selected<% } %>>VN-Viet Nam</option>
			<option value="VG" title="Virgin Islands, British" <% if(strInstrCountryCode.equals("VG")) {%>selected<% } %>>VG-Virgin Islands, British</option>
			<option value="VI" title="Virgin Islands, U.S." <% if(strInstrCountryCode.equals("VI")) {%>selected<% } %>>VI-Virgin Islands, U.S.</option>
			<option value="WF" title="Wallis And Futuna" <% if(strInstrCountryCode.equals("WF")) {%>selected<% } %>>WF-Wallis And Futuna</option>
			<option value="EH" title="Western Sahara" <% if(strInstrCountryCode.equals("EH")) {%>selected<% } %>>EH-Western Sahara</option>
			<option value="YE" title="Yemen" <% if(strInstrCountryCode.equals("YE")) {%>selected<% } %>>YE-Yemen</option>
			<option value="ZM" title="Zambia" <% if(strInstrCountryCode.equals("ZM")) {%>selected<% } %>>ZM-Zambia</option>
			<option value="ZW" title="Zimbabwe" <% if(strInstrCountryCode.equals("ZW")) {%>selected<% } %>>ZW-Zimbabwe</option>
			<option value="SS" title="South Sudan" <% if(strInstrCountryCode.equals("SS")) {%>selected<% } %>>SS-South Sudan</option>
			<option value="CW" title="Curacao" <% if(strInstrCountryCode.equals("CW")) {%>selected<% } %>>CW-Curacao</option>
			<option value="BQ" title="Bonaire, Sint Eustatius and Saba" <% if(strInstrCountryCode.equals("BQ")) {%>selected<% } %>>BQ-Bonaire, Sint Eustatius and Saba</option>
			<option value="SX" title="Sint Marteen" <% if(strInstrCountryCode.equals("SX")) {%>selected<% } %>>SX-Sint Marteen</option> --%>
			<option value="XX" title="Not available " <% if(strInstrCountryCode.equals("XX")) {%>selected<% } %>>XX-Not available </option>
			<option value="ZZ" title="Others" <% if(strInstrCountryCode.equals("ZZ")) {%>selected<% } %>>ZZ-Others</option>
		</select>
	</div>
	
	<div class="normalTextField">
		<label>20. Purpose Code</label>
		<%-- <input type="text" name="purposeCode" <%=readOnly%> class="txt2" size=30 maxlength=30 value="<%=strPurposeCode%>"/> --%>
		<select class="form-control input-sm" name="purposeCode" id="purposeCode${UNQID}" <%=readOnly%>>
			<option value="">Select</option>
			<c:forEach var="purposeCodesList" items="${PURPOSECODES}">
				<option value="${purposeCodesList.key}">${purposeCodesList.value}</option>
			</c:forEach>
		</select>
	</div>
	
	<div class="normalTextField">
		<label>21. Related Institution Reference Number</label>
		<input type="text" name="rltdInstRefNo" <%=readOnly%> class="txt2" size=30 maxlength=30 value="<%=strRltdInstRefNo%>"/>
	</div>
	
	<div><p style="font-weight: bolder; font-size: x-large;">Customer Details</p></div>
	<div class="normalTextField">
		<label>22. Customer Id</label>
		<input type="text" name="customerId" <%=readOnly%> class="txt2" size=30 maxlength=30 value="<%=strCustomerId%>"/>
	</div>
	<div class="normalTextField">
		<label>23. Customer Name</label>
		<input type="text" name="customerName" <%=readOnly%> class="txt2" size=30 maxlength=30 value="<%=strCustomerName%>"/>
	</div>
	<div class="normalTextField">
		<label>24. Occupation</label>
		<input type="text" name="occupation" <%=readOnly%> class="txt2" size=30 maxlength=30 value="<%=strOccupation%>"/>
	</div>
	<div class="normalTextField">
		<label>25. Date of Birth</label>
		<input type="text" class="topOpenTextBox datepicker" id="dob" name="dob" placeholder="YYYY-MM-DD" <%=readOnly%> value="<%=strDateofBirth%>" />
	</div>
	<div class="normalTextField">
		<label>26. Gender</label>
		<select name="gender">
	...
	<div class="normalTextField">
		<label>31. ID Issuing Place</label>
	...
	<div class="normalTextField">
		<label>48. Transaction Remarks</label>
