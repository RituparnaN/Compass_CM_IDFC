			...
			$(document).ready(function(){
				...
				$("#generateGOS").click(function(){
					...
					if(templateID != "" && accountNumbers.length > 0){
						window.open('<%=contextPath%>/GroundOfSuspicionForSTRTemplateDOC?primaryCustomerId='+primaryCustomerId+'&secondaryCustomerId='+secondaryCustomerId+'&accountNumbers='+accountNumbers+'&templateId='+templateID+'&fromDate='+fromDate+'&toDate='+toDate,'GOSDOC','height=200, width=200, resizable=Yes, scrollbars=Yes');
					}else{
			...
			<div class="row">
				<div class="col-xs-12">
					<div class="card card-info">
					  ...
					  <form action="<%=contextPath%>/generateAutoSTR" method="post">
						...
						<tr>
					  	...
					  	<tr>
					  		<td colspan="2" style="text-align: center">
					  			...
					  			<button type="submit" class="btn btn-success btn-sm">Generate STR</button>
					  		</td>
					  	</tr>
					  </table>
					  </form>
