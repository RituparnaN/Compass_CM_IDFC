...
<script type="text/javascript">
	$(document).ready(function() {
		...
		$("#cbwtrManualUpload"+id).click(function(){
			compassFileUpload.init("uploadFile","${pageContext.request.contextPath}","cbwtrManualUpload","0","Y","N","");
		});
	});
		...
		<div class="card card-primary panel_cbwtReport">
			...
			<div class="card-footer clearfix">
				<div class="pull-${dirR}">
					...
					<button type="button" id="cbwtrManualUpload${UNQID}" class="btn btn-warning btn-sm">CBWTR Manual Upload</button>
