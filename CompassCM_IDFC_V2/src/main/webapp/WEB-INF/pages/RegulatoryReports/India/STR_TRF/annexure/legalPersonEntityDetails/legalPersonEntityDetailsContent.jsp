...
<div class="section">
	...
	<div class="normalTextField">
		...
		<input type="text" name="registrationPlace" readonly value="<%=strPlaceOfRegistration%>" />
	</div>
	<div class="normalTextField">
		<label>10. Country of Registration</label><br/>
		<input type="text" name="registrationCountry" class="medium" readonly value="<%=strRegisteringAuthority%>"/>
	</div>
	...
	<div class="normalTextField">
		...
		<textarea name="address" readonly><%=strAddressBuildingNo+", "+strAddressStreet+", "+strAddressLocality%></textarea>
	</div>
	<div class="normalTextField">
		<label>14. City</label>
	...
	<div class="normalTextField left">
		...
		<input type="text" name="mobile" readonly value="<%=strAddressTelephoneNo%>"/>
	</div>
	<div class="normalTextField right">
		<label>20. FAX</label>
