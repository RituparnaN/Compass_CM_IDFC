...
var win= window.open('<%=contextPath%>/common/addNewLegalDetails?caseNo='+caseNo,'NEWANNEXUREB',"top=150, height=600, width=750,scrollbars=yes,toolbar=yes,resizable=yes,location=no");
}
...
var caseNo = '<%= caseNo%>';
window.open('<%=contextPath%>/common/getNewINDSTREntities?caseNo='+caseNo+'&legalAcctNo='+strAcctNo+'&legalName='+custName+'&legalId='+custID+'&annexure='+annexure+'&CallFrom='+callfrom,'ANNEXUREB','top=150, height=600, width=750,scrollbars=yes,toolbar=yes,resizable=yes,location=no');
}
...
if(conf)
{	
	this.parent.location.replace('<%=contextPath%>/common/deleteNewINDSTREntities?caseNo='+caseNo+'&legalAcctNo='+strAcctNo+'&legalName='+custName+'&legalId='+custID+'&CallFrom='+callfrom);
}
}
-->
</script>
