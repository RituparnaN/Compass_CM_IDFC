...
<script type="text/javascript">
	$(document).ready(function(){
		...
		var viewCtrButton = '${viewCtrButton}';
		//alert(viewCtrButton);
		
		
		$("#closeCTRFilesModal").click(function(){
			$("#compassGenericModal").modal("hide");
		});

		
		$("#updateCTRFilesModal").click(function(){
			var formObj = $("#ctrFilesForm"+id);
			...
			if(flag==0){
				$.ajax({
					url: "${pageContext.request.contextPath}/common/updateCTRDetails",
					cache: false,
					type: "POST",
...
<div class="row compassrow${UNQID}">
	<div class="col-sm-12">
	<div class="card card-primary ctrFilesModalForm">
		<form action="javascript:void(0)" method="POST" id="ctrFilesForm${UNQID}">
			...
			<div class="card-footer clearfix">
				<div class="pull-${dirR}">
					<button type="button" id="updateCTRFilesModal" class="btn btn-success btn-sm">Update</button>
					<button type="button" id="closeCTRFilesModal" class="btn btn-primary btn-sm">Close</button>
				</div>
			</div>
		</form>
	</div>
