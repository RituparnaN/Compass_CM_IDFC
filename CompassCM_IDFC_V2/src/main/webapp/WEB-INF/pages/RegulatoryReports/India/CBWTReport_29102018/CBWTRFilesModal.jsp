...
<script type="text/javascript">
	$(document).ready(function(){
		...
		$("#closeCBWTRFilesModal").click(function(){
			$("#compassGenericModal").modal("hide");
		});

		
		$("#updateCBWTRFilesModal").click(function(){
			var formObj = $("#cbwtrFilesForm"+id);
			...
			if(flag==0){
				$.ajax({
					url: "${pageContext.request.contextPath}/common/updateCBWTRDetails",
					cache: false,
					type: "POST",
...
<div class="row compassrow${UNQID}">
	<div class="col-sm-12">
	<div class="card card-primary cbwtrFilesModalForm">
		<form action="javascript:void(0)" method="POST" id="cbwtrFilesForm${UNQID}">
			...
			<div class="card-footer clearfix">
				<div class="pull-${dirR}">
					<button type="button" id="updateCBWTRFilesModal" class="btn btn-success btn-sm">Update</button>
					<button type="button" id="closeCBWTRFilesModal" class="btn btn-primary btn-sm">Close</button>
				</div>
			</div>
		</form>
	</div>
