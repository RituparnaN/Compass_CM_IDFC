...
<div class="section">
	...
	<table class="info-table">
		...
		<tr>
			...
			<td class="leftAligned" <%if(canUpdated.equals("N")){%> hidden="hidden" <%}%> >
				<a href="#1" onclick="updateTransactionDetails('<%=strAccountNo%>','<%=strArrayTransacdetailsNo[i]%>')"><img alt="update details" title="Update Details" src="${pageContext.request.contextPath}/includes/images/edit.png"/></a>
				<a href="#1" onclick="deleteTransactionDetails('<%=strAccountNo%>','<%=strArrayTransacdetailsNo[i]%>')"><img alt="delete details" title="Delete Details" src="${pageContext.request.contextPath}/includes/images/delete.png"/></a>
			</td>
		</tr>
		<% }
		else
