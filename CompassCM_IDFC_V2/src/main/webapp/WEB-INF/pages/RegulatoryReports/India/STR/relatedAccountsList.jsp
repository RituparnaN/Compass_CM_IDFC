...
{
var caseNo = '<%= caseNo%>';
// var win= window.open('<%=contextPath%>/IndianRegulatoryReport/str/addAccountDetails.jsp?caseNo='+caseNo,'NEWANNEXUREC',"top=150, height=600, width=800,scrollbars=yes,toolbar=yes,resizable=yes,location=no");
var win= window.open('<%=contextPath%>/common/addNewAccountDetails?caseNo='+caseNo,'NEWANNEXUREC',"top=150, height=600, width=800,scrollbars=yes,toolbar=yes,resizable=yes,location=no");
}
