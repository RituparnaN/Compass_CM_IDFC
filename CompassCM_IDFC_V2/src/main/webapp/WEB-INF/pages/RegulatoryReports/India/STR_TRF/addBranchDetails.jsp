...
try{
	...
	if(objBranchDetailsVO != null){
		...
		strBICCode              = (objBranchDetailsVO.getBiccode() == null) ? "" : objBranchDetailsVO.getBiccode();
...
<div class="section" style="height : auto;">
	...
	<div class="normalTextField">
		<label>5. BIC Code</label><br />
		<input type="text" name=bicCode <%=readOnly%> value="<%=strBICCode%>"/>
	</div>
	<div class="normalTextField">
