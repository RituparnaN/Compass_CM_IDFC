...
<div class="section">
	...
	<div class="normalTextField left">
		...
		<select name="txnStateCode" <%=readOnly%>>
			<option value="AN" title="Andaman & Nicobar" <% if(strBankAddressState.equals("AN")) {%>selected<% } %>>AN- Andaman & Nicobar </option>
			<option value="AP" title="Andhra Pradesh" <% if(strBankAddressState.equals("AP")) {%>selected<% } %>>AP- Andhra Pradesh</option>
			<option value="AR" title="Arunachal Pradesh" <% if(strBankAddressState.equals("AR")) {%>selected<% } %>>AR- Arunachal Pradesh</option>
			<option value="AS" title="Assam" <% if(strBankAddressState.equals("AS")) {%>selected<% } %>>AS- Assam</option>
			<option value="BR" title="Bihar" <% if(strBankAddressState.equals("BR")) {%>selected<% } %>>BR- Bihar</option>
			<option value="CH" title="Chandigarh" <% if(strBankAddressState.equals("CH")) {%>selected<% } %>>CH- Chandigarh</option>
			<option value="CG" title="Chattisgarh" <% if(strBankAddressState.equals("CG")) {%>selected<% } %>>CG- Chattisgarh</option>
			<option value="DN" title="Dadra and Nagar Haveli" <% if(strBankAddressState.equals("DN")) {%>selected<% } %>>DN- Dadra and Nagar Haveli</option>
			<option value="DD" title="Daman & Diu" <% if(strBankAddressState.equals("DD")) {%>selected<% } %>>DD- Daman & Diu</option>
			<option value="DL" title="Delhi" <% if(strBankAddressState.equals("DL")) {%>selected<% } %>>DL- Delhi</option>
			<option value="GA" title="Goa" <% if(strBankAddressState.equals("GA")) {%>selected<% } %>>GA- Goa</option>
			<option value="GJ" title="Gujarat" <% if(strBankAddressState.equals("GJ")) {%>selected<% } %>>GJ- Gujarat</option>
			<option value="HR" title="Haryana" <% if(strBankAddressState.equals("HR")) {%>selected<% } %>>HR- Haryana</option>
			<option value="HP" title="Himachal Pradesh" <% if(strBankAddressState.equals("HP")) {%>selected<% } %>>HP- Himachal Pradesh</option>
			<option value="JK" title="Jammu & Kashmir" <% if(strBankAddressState.equals("JK")) {%>selected<% } %>>JK- Jammu & Kashmir</option>
			<option value="JH" title="Jharkhand" <% if(strBankAddressState.equals("JH")) {%>selected<% } %>>JH- Jharkhand</option>
			<option value="KA" title="Karnataka" <% if(strBankAddressState.equals("KA")) {%>selected<% } %>>KA- Karnataka</option>
			<option value="KL" title="Kerala" <% if(strBankAddressState.equals("KL")) {%>selected<% } %>>KL- Kerala</option>
			<option value="LD" title="Lakshadweep" <% if(strBankAddressState.equals("LD")) {%>selected<% } %>>LD- Lakshadweep</option>
			<option value="MP" title="Madhya Pradesh" <% if(strBankAddressState.equals("MP")) {%>selected<% } %>>MP- Madhya Pradesh</option>
			<option value="MH" title="Maharashtra" <% if(strBankAddressState.equals("MH")) {%>selected<% } %>>MH- Maharashtra</option>
			<option value="MN" title="Manipur" <% if(strBankAddressState.equals("MN")) {%>selected<% } %>>MN- Manipur</option>
			<option value="ML" title="Meghalaya" <% if(strBankAddressState.equals("ML")) {%>selected<% } %>>ML- Meghalaya</option>
			<option value="MZ" title="Mizoram" <% if(strBankAddressState.equals("MZ")) {%>selected<% } %>>MZ- Mizoram</option>
			<option value="NL" title="Nagaland" <% if(strBankAddressState.equals("NL")) {%>selected<% } %>>NL- Nagaland</option>
			<option value="OR" title="Orissa" <% if(strBankAddressState.equals("OR")) {%>selected<% } %>>OR- Orissa</option>
			<option value="PY" title="Pondicherry" <% if(strBankAddressState.equals("PY")) {%>selected<% } %>>PY- Pondicherry</option>
			<option value="PB" title="Punjab" <% if(strBankAddressState.equals("PB")) {%>selected<% } %>>PB- Punjab</option>
			<option value="RJ" title="Rajasthan" <% if(strBankAddressState.equals("RJ")) {%>selected<% } %>>RJ- Rajasthan</option>
			<option value="SK" title="Sikkim" <% if(strBankAddressState.equals("SK")) {%>selected<% } %>>SK- Sikkim</option>
			<option value="TN" title="Tamil Nadu" <% if(strBankAddressState.equals("TN")) {%>selected<% } %>>TN- Tamil Nadu</option>
			<option value="TR" title="Tripura" <% if(strBankAddressState.equals("TR")) {%>selected<% } %>>TR- Tripura</option>
			<option value="UP" title="Uttar Pradesh" <% if(strBankAddressState.equals("UP")) {%>selected<% } %>>UP- Uttar Pradesh</option>
			<option value="UA" title="Uttarakhand" <% if(strBankAddressState.equals("UA")) {%>selected<% } %>>UA- Uttarakhand</option>
			<option value="WB" title="West Bengal" <% if(strBankAddressState.equals("WB")) {%>selected<% } %>>WB- West Bengal</option>
			<option value="ZZ" title="Others" <% if(strBankAddressState.equals("ZZ")) {%>selected<% } %>>ZZ- Others</option>
			<option value="XX" title="Not Applicable" <% if(strBankAddressState.equals("XX")) {%>selected<% } %>>XX -Not Applicable</option>
		</select>
	</div>
