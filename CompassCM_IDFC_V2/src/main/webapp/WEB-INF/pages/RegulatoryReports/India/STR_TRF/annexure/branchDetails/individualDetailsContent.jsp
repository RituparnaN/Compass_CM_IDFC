...
<% 
 try{
	...
	if(objIndividualDetailsVO!=null){
		...
		strSecondAddressCountry		= (objIndividualDetailsVO.getSecaddCountry() == null) ? "" : objIndividualDetailsVO.getSecaddState();
...
<div class="section">
	...
	<div class="normalTextField right">
		<label>15. UIN</label>
		<input type="text" name="uin" readonly value="" />
	</div>
	...
	<div class="normalTextField">
		...
		<textarea name="communicationAddress" readonly><%=strAddressBuildingNo+", "+strAddressStreet+", "+strAddressLocality%></textarea>
	</div>
	<div class="normalTextField">
	...
	<div class="normalTextField right">
		<label>24. FAX</label>
		<input type="text" name="stateCode" readonly value="<%=strAddressTelNo%>" />
	</div>
	<div class="normalTextField">
	...
	<div class="normalTextField">
		...
		<textarea name="placeOfWork" readonly><%=strSecondAddressBuildingNo+", "+strSecondAddressStreet+", "+strSecondAddressLocality%></textarea>
	</div>
	<div class="normalTextField">
