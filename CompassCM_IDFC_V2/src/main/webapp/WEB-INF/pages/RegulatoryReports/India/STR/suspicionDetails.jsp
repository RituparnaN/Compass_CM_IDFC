...
<%@ page import = "java.util.HashMap, java.util.ArrayList, com.quantumdataengines.app.compass.model.regulatoryReports.india.*" %>
...
<% 
	...
	if(objManualDetailsVO!=null){
		...
		System.out.println("strProceedsOfCrime: "+strProceedsOfCrime);
		System.out.println("strUnusualComplexTransaction: "+strUnusualComplexTransaction);
		System.out.println("strNoEcoRatBonPurpose: "+strNoEcoRatBonPurpose);
		System.out.println("strFinancialTerrorism: "+strFinancialTerrorism);
...
<div class="section">
	...
	<div class="normalTextField">
		...
		<select name="sourceOfAlert" tabindex="5" <%=disabled%> >
			...
			<option value="" <% if(strSourceOfAlert.equals("")) {%>selected<% } %> > </option>
		</select>
	</div>
	<div class="normalTextField">
		<label>7.3.1 Alert Indicator</label>
		...
		<label>7.3.2 Alert Indicator</label>
		<select name="alertIndicators1" tabindex="7" <%=disabled%> >
		<% for(int i = 0; i < alertIndicatorsList.size(); i++) { 
			strAlertIndicator = alertIndicatorsList.get(i).toString();
		...
		<label>7.3.3 Alert Indicator</label>
	...
	<!-- 
	<div class="normalTextField">
		<label>7.3 Alert Indicator(s)</label>
	...
	<div class="normalTextField">
		<label>7.4 Suspicion Due To</label>
		<div class="checkBoxDiv">
			...
			<!-- <span> -->		
				<select name="proceedsOfCrime" id="proceedsOfCrime" style="width: 10%" <%=disabled%>>
					...
					<option value="N" <% if(strProceedsOfCrime.equals("N")) {%>selected<% } %> >N - No</option>
			...
			<!-- <span> -->
				...
				<select name="unusualComplexTransaction" id="unusualComplexTransaction" style="width: 10%" <%=disabled%>>
					...
					<option value="N" <% if(strUnusualComplexTransaction.equals("N")) {%>selected<% } %> >N - No</option>
			...
			<!-- <span> -->
				...
				<select name="noEcoRatBonPurpose" id="noEcoRatBonPurpose" style="width: 10%" <%=disabled%>>
					...
					<option value="N" <% if(strNoEcoRatBonPurpose.equals("N")) {%>selected<% } %> >N - No</option>
			...
			<!-- <span> -->
				...
				<select name="financialTerrorism" id="financialTerrorism" style="width: 10%" <%=disabled%>>
					...
					<option value="N" <% if(strFinancialTerrorism.equals("N")) {%>selected<% } %> >N - No</option>
	...
	<div class="normalTextField left">
		<label>7.5 Attempted Transactions</label>
		<div class="checkBoxDiv">
			<span>
	...
	<label>7.6 Priority Rating</label>
	...
	<br/><br/><br/><br/><br/>
	<div class="normalTextField left">
		<label>7.7 Report Coverage</label>
		<div class="checkBoxDiv">
			<span>
	...
	<div class="normalTextField right">
		<label>7.8 Additional Documents</label>
		<div class="checkBoxDiv">
			<span>
	...
	<br/><br/><br/><br/><br/>
	<div class="normalTextField">
		<label>7.9 Grounds of Suspicion</label>
		<textarea id="Part7susGrounds0" onkeyup="countChar(this,'Part7susGrounds0')" name="Part7susGrounds0" <%=readOnly%> 
		 ...
		 <span id="charsGOS" style="margin-left: 4px;"><%= ( 4000 - (strSuspiciousGroundsArray[0] == null ? 0 :strSuspiciousGroundsArray[0].length() + 1)) %> characters remaining out of 4000</span> 
	</div>
</div>
