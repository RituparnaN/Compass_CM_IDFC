...
<div id="content" class="container col-sm-12" style="width:1510px; padding-left: 0; margin-left: 0; padding-right: 40px; margin-top: 5px;">
...
for(int m=0;m < alAccountDetails.size();m++){				
	...
	request.setAttribute("AnnCNo", (m+1)+"");
		...
		%>
				<li><a class="nav-link" data-toggle="tab" href="#accountDetails<%=annxNo%>">Account Details<%=annxNo%></a></li>
			<% 
		}
		%>
		<% }
...
%>
	  ...
	  <jsp:include page="annexureHeader.jsp"/>
		<ul class="nav nav-tabs compass-nav-tabs" role="tablist" >
			<li class="active"><a class="nav-link active" data-toggle="tab" href="#branchDetails<%=annxNo1%>">Branch Details</a></li>
	    	<li><a class="nav-link" data-toggle="tab" href="#accountHolderList<%=annxNo1%>">Account Holder List</a></li>
	    	<li><a class="nav-link" data-toggle="tab" href="#relatedPersonList<%=annxNo1%>">Related Person List</a></li>
	    	<li><a class="nav-link" data-toggle="tab" href="#cumulativeDetails<%=annxNo1%>">Cumulative Details</a></li>
	    	<li><a class="nav-link" data-toggle="tab" href="#transactionDetails<%=annxNo1%>">Transaction Details</a></li>
		</ul>
		<div class="tab-content compass-tab-content">
			<div role="tabpanel" class="tab-pane fade in active show" id="branchDetails<%=annxNo1%>" >
				<div class="row">
					<div class="col-sm-12">
