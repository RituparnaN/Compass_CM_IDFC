...
function setValues()
{
	...
	var alertno = '<%=(String)(request.getSession(true).getAttribute("alertNo"))%>';	
...
function autoSaveTransaction(actionType){
	...
	/*
	var AlertNo = form.AlertNo.value;
...
<input type="hidden"  name="TransactionNo"  value='<%=strTransactionNo%>'>
	...
	<div class="normalTextField">
		...
		<input type="text"  name="chTransactionDate" <%=readOnly%> value="<%=(objISTRTranDetailsVO==null || objISTRTranDetailsVO.getTransactiondetailsdate()==null)?"":objISTRTranDetailsVO.getTransactiondetailsdate()%>" class="topOpenTextBox" size=12 maxlength=12 id="chTransactionDate"/>
	</div>
	<div class="normalTextField">
	...
	<div class="mainButtons">
		...
		<input type="button" value="Post" <%=disabled%> onclick="setValues()"  class="diffButton"/>
...
<div class="normalTextField left">
		...
		<input type="hidden" name="l_strAlertNo" value="<%=l_strAlertNo%>"/>
...
<form name="AutoSaveTransaction" action="<%=contextPath%>/common/autoSaveINDSTRTransactions?${_csrf.parameterName}=${_csrf.token}" method="post">
	<div class="normalTextField">
		...
		<input type="text"  name="fromDate" id="fromDate" class="txt2"/>
	</div>
	<div class="normalTextField">
		<label>To Date</label>
		<input type="text"  name="toDate" id="toDate" class="txt2"/>
	</div>
	<div class="normalTextField">
		<label>Account Number</label>
	...
	<div class="mainButtons">
		...
		<input type="hidden" name="AlertNo" value="<%=(String)(request.getSession(true).getAttribute("alertNo"))%>"/>
		<input type="button" name="SaveButton" value="Post" <%=disabled%> onclick="autoSaveTransaction('Save')" class="diffButton"/>
