	...
	$(document).ready(function() {
		...
		$("#searchMasterForm"+id).submit(function(e){	
			if(buttonId ==  "viewGeneratedCtrFiles"+id){
				...
				var submitButton = $("#viewGeneratedCtrFiles"+id);
				let buttonTextDuringOperation = "Getting Generated Files..";
				compassTopFrame.submitFormInsteadOfSearch(id, e, submitButton, 'cashTransactionReportSerachResultPanel',
						'cashTransactionReportSerachResult', '${pageContext.request.contextPath}/common/viewGeneratedCTRFilesMaster?viewFilePageUrl=RegulatoryReports/India/CashTransactionReport/ViewGeneratedFile'+'&viewCtrButton='+buttonId,
