...
<script type="text/javascript">
	...
	function downloadGeneratedXMLFile(fileSeqNo, fileName, filePath){
		compassFileUpload.init("viewGeneratedNTRFiles","${pageContext.request.contextPath}","generatedNTRFiles","","N","N", fileSeqNo);
	}
...
<div id="searchResultGenericDiv">
	...
	<div class="card-footer clearfix">
		<div class="pull-${dirR}">
			<button type="button" class="btn btn-primary btn-sm" id="editNtr${UNQID}">Edit Details</button>
		</div>
	</div>
</div>
<script>
	...
	$("#editNtr"+id).click(function(){
		...
		if(selectedFileSeq !== undefined){
			...
			// update code
			$.ajax({
				url: "${pageContext.request.contextPath}/common/editNTRDetails",
				cache:	false,
				type: "POST",
				data: {selectedFileSeq:selectedFileSeq, viewNtrButton:viewNtrButton},
