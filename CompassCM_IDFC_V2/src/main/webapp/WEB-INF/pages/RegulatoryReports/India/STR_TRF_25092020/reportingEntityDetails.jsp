...
<div class="section" style="height: 225px;">
...
<div class="section" style="height: 230px;">
	<div class="mainHeader">
	2. Batch Details
	</div>
	<div class="normalTextField left">
		<label>2.1 Batch Number</label>
		<input type="text" name="reportingBatchNo" value="<%=strBatchNo%>"/>
	</div>
	<div class="normalTextField right">
		<label>2.2 Batch Date</label>
		<input type="text" class="datepicker" name="reportingBatchDate" id="batchDate" value="<%=strDefaultDate1%>"/>
	</div>
	<div class="normalTextField left">
