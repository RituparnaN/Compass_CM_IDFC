...
<table>
	...
	<fieldset class="appendix2a">
		...
		<table class="table appendix2" style="margin-bottom: 0px; margin-top: 0px; border: none;">
			...
			<tr>
				...
				<td width="70%">
					&nbsp;
					PoCA 2002:	<input type="checkbox" class="  alignCheckbox"  id="PoCA2002" value="PoCA 2002" name="DISCLOSUREREASON1"
					<c:if test="${RECORD['DISCLOSUREREASON1'] eq 'PoCA 2002'}">checked="checked"</c:if>>
					&nbsp;
					Terrorism Act 2000:<input type="checkbox" class="  alignCheckbox"  id="TerrorismAct2000" value="Terrorism Act 2000" name="DISCLOSUREREASON1"
			...
			<tr>
				...
				<td width="10%">&nbsp;</td>
				<td width="75%">
					<input type="checkbox" class=" alignCheckbox"  id="isConsentReq" value="Yes" name="isConsentReq"	
			...
			<tr>
				...
				<td width="70%">
					&nbsp;
					New:	<input type="checkbox" class="  alignCheckbox"  id="newType" value="New" name="DISCLOSUREREPORTTYPE"
							<c:if test="${RECORD['DISCLOSUREREPORTTYPE'] eq 'New'}">checked="checked"</c:if>>		
					&nbsp;
					OR &nbsp; Update:		<input type="checkbox" class="  alignCheckbox"  id="updateType" value="Update" name="DISCLOSUREREPORTTYPE"
				...
				<td width="85%">
					<table>
						<tr>
							...
							<td width="5%" >
								<input type="checkbox" class="alignCheckbox"  id="mainSubject" value="Main Subject" name="SUBJECTTYPE"
							...
							<td width="5%" style="text-align: right;">
								<input type="checkbox" class="alignCheckbox" id="associatedSubject" value="Associated Subject" name="SUBJECTTYPE"
	 ...
	 <fieldset class="appendix3b">
		...
		<table class="table appendix3" style="margin-bottom: 0px; margin-top: 0px; border: none;">	 
				...
				<td width="75%">
					<table>
						<tr>
							...
							<td width="5%">&nbsp;</td>
							<td width="10%">
								<input type="checkbox" class=" alignCheckbox"  id="indvSubStatusSuspect" value="Suspect" name="INDVSUBSTATUS"
							...
							<td width="10%">
								<input type="checkbox" class="  alignCheckbox" id="indvSubStatusVictim" value="Victim" name="INDVSUBSTATUS"
			...
			<tr>
				...
				<td width="70%">
					&nbsp;
					Male  <input type="checkbox" class="  alignCheckbox"  id="male" value="Male" name="GENDER"
					<c:if test="${RECORD['GENDER'] eq 'Male'}">checked="checked"</c:if>>		
					&nbsp;
					Female	<input type="checkbox" class="  alignCheckbox"  id="female" value="Female" name="GENDER"
			...
			<tr>
				...
				<td width="70%">
					&nbsp;
					Mr  <input type="checkbox" class="  alignCheckbox"  id="mr" value="Mr" name="TITLE"
					<c:if test="${RECORD['TITLE'] eq 'Mr'}">checked="checked"</c:if>>		
					&nbsp;
					Mrs	<input type="checkbox" class="  alignCheckbox"  id="mrs" value="Mrs" name="TITLE"
					<c:if test="${RECORD['TITLE'] eq 'Mrs'}">checked="checked"</c:if>>
					&nbsp;
					Miss	<input type="checkbox" class="  alignCheckbox"  id="miss" value="Miss" name="TITLE"
					<c:if test="${RECORD['TITLE'] eq 'Miss'}">checked="checked"</c:if>>
					&nbsp;
					Ms	<input type="checkbox" class="  alignCheckbox"  id="ms" value="Ms" name="TITLE"
				...
				<td width="75%">
					<table>
						<tr>
							...
							<td width="5%">&nbsp;</td>
							<td width="10%">
								<input type="checkbox" class="  alignCheckbox"  id="legalEntityStatusSuspect" value="Suspect" name="LEGALENTITYSTATUS"
							...
							<td width="15%">Victim:</td>
							<td width="10%">
								<input type="checkbox" class="  alignCheckbox" id="legalEntityStatusVictim" value="Victim" name="LEGALENTITYSTATUS"
	...
	<fieldset class="appendix4a">
			...
			<tr>
			    ...
			    <td width="70%">
			    	<table>
			    		<tr>
				    		<td width="10%">
								<input type="checkbox" class="  alignCheckbox"  id="referToMainSubject" value="Main Subject" name="subjectRefTo"
							...
							<td width="10%">
								<input type="checkbox" class="  alignCheckbox" id="referToAssoSubject" value="Associated Subject" name="subjectRefTo"
		...
		<table class="table appendix" style="margin-bottom: 0px; margin-top: 0px; border: none;">
			...
			<tr>
				...
				<td width="10%">&nbsp;</td>
				<td width="75%">
					<input type="checkbox" class=" alignCheckbox"  id="currentPremise1" value="Yes" name="currentPremise1"
	...
	<fieldset class="appendix4d">
		<table class="table appendix" style="margin-bottom: 0px; margin-top: 0px; border: none;">
			...
			<tr>
				...
				<td width="10%">&nbsp;</td>
				<td width="75%">
					<input type="checkbox" class="alignCheckbox"  id="currentPremise2" value="Yes" name="CURRENTPREMISE2"
	...
	<fieldset class="appendix4e">
		<table class="table appendix" style="margin-bottom: 0px; margin-top: 0px; border: none;">
			...
			<tr>
				...
				<td width="10%">&nbsp;</td>
				<td width="75%">
					<input type="checkbox" class="  alignCheckbox"  id="currentPremise3" value="Yes" name="CURRENTPREMISE3"
			...
			<tr>
				...
				<td width="75%">
					<table>
						<tr>
							<td width="20%">
								<input type="checkbox" class="  alignCheckbox"  id="tnxCredit1" value="Credit" name="TNXCREDITDEBIT1"
							...
							<td width="10%">&nbsp;</td>
							<td width="20%">
								<input type="checkbox" class="  alignCheckbox"  id="tnxDebit1" value="Debit" name="TNXCREDITDEBIT1"
			...
			<tr>
				...
				<td width="75%">
					<table>
						<tr>
							<td width="20%">
								<input type="checkbox" class="  alignCheckbox"  id="tnxCredit2" value="Credit2" name="tnxCreditDebit2"
							...
							<td width="10%">&nbsp;</td>
							<td width="20%">
								<input type="checkbox" class="  alignCheckbox"  id="tnxDebit2" value="Debit" name="tnxCreditDebit2"
			...
			<tr>
				...
				<td width="75%">
					<table>
						<tr>
							<td width="20%">
								<input type="checkbox" class="  alignCheckbox"  id="tnxCredit3" value="Credit" name="tnxCreditDebit3"
							...
							<td width="10%">&nbsp;</td>
							<td width="20%">
								<input type="checkbox" class="  alignCheckbox"  id="tnxDebit3" value="Debit" name="tnxCreditDebit3"
			...
			<tr>
				...
				<td width="75%">
					<table>
						<tr>
							<td width="20%">
								<input type="checkbox" class="alignCheckbox"  id="tnxCredit4" value="Credit" name="tnxCreditDebit4"
							...
							<td width="10%">&nbsp;</td>
							<td width="20%">
								<input type="checkbox" class="alignCheckbox"  id="tnxDebit4" value="Debit" name="tnxCreditDebit4"
	...
	<table class="table appendix" style="margin-bottom: 0px; margin-top: 0px; border: none;">	
			<tr>
				...
				<td width="10%">
					<input type="checkbox" class="  alignCheckbox"  id="drugs" value="Drugs" name="DRUGS"
					<c:if test="${RECORD['DRUGS'] eq 'Drugs'}">checked="checked"</c:if>>
	    		</td>
			    <td width="20%">Missing Trader, Inter Community (VAT) Fraud:</td>
				<td width="10%">
					<input type="checkbox" class="  alignCheckbox"  id="missingTrader" value="Missing Trader" name="MISSINGTRADER"
					<c:if test="${RECORD['MISSINGTRADER'] eq 'Missing Trader'}">checked="checked"</c:if>>
				</td>
				<td width="10%">Immigration:</td>
				<td width="10%">
					<input type="checkbox" class="  alignCheckbox"  id="immigration" value="Immigration" name="IMMIGRATION"
					<c:if test="${RECORD['IMMIGRATION'] eq 'Missing Trader'}">checked="checked"</c:if>>
				</td>
				<td width="20%">Tobacco/Alcohol Excise Fraud:</td>
				<td width="10%">
					<input type="checkbox" class="  alignCheckbox"  id="tobaccoExciseFraud" value="Tobacco Excise Fraud" name="TOBACCOEXCISEFRAUD"
			...
			<tr>
				...
				<td width="10%">
					<input type="checkbox" class="  alignCheckbox"  id="personalTaxFraud" value="Personal Tax Fraud" name="PERSONALTAXFRAUD"
					<c:if test="${RECORD['PERSONALTAXFRAUD'] eq 'Personal Tax Fraud'}">checked="checked"</c:if>>
				</td>
			    <td width="10%">Corporate Tax Fraud:</td>
				<td width="10%">
					<input type="checkbox" class="  alignCheckbox"  id="corporateTaxFraud" value="Corporate Tax Fraud" name="CORPORATETAXFRAUD"
