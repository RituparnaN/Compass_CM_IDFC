...
%>
	...
	//window.opener.location.replace('<%=contextPath%>/IndianRegulatoryReport/str/strMain.jsp?l_strAlertNo='+l_strAlertNo);
...
<body>
<div class="content">
<form name="NewLegalDetails" action="<%=contextPath%>/common/saveNewINDSTREntity?${_csrf.parameterName}=${_csrf.token}" method="post">
...
<!--<%=strRegisteringAuthority%>-->
	...
	<div class="normalTextField">
		...
		<!-- 03042018 -Value changed to strSecondAddressLocality-->
		<input type="text" name="repSecAddressCity" <%=readOnly%> value="<%=strSecondAddressLocality%>"/>
