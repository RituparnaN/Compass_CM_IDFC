...
<script type="text/javascript">
	...
	function openReportWidgetsIdDetails(elm){
		var reportId = $(elm).html();
		var l_strAction = "Create";
		var mywin = window.open("${pageContext.request.contextPath}/admin/updateReport?reportID="+reportId,'ReportWidgetsUpdateFrame','height=700,width=1320,scrollbars=1,Full=Y,resizable=Yes');
		mywin.moveTo(10,02);
	}	
</script>

<style type="text/css">
	.reportWidgetsIdHyperlink{
