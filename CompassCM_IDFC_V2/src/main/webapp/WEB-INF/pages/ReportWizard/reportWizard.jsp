   ...
   <body>
    <div class="card-body">
		<div class="row row-xs-height">
			...
			<div class="col-xs-9">
				<div class="card card-info" id="columnsPanel" style="border-color: #bce8f1;">
					<div class='card-header' style="height: 45px; font-size: 16px;">
	...
	<div class="modal fade bs-example-modal-lg" id="setJoinModal" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
		...
		<div class="modal-content">
			<div class="modal-header" style="diaplay: flex; flex-direction: row-reverse; ">
	...
	<div class="modal fade bs-example-modal-lg" id="setConditionModal" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
		...
		<div class="modal-content">
			...
			<div class="modal-footer">
				<button type="button" class="btn btn-primary btn-sm" id="addConditionRow">Add Row</button>
				<button type="button" class="btn btn-success btn-sm" id="saveConditionRow">Save Conditions</button>
				<button type="button" class="btn btn-danger btn-sm" data-dismiss="modal">Close</button>
			</div>
		</div>
