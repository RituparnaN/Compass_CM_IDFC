...
<script type="text/javascript">
	$(document).ready(function() {
		var id = '${UNQID}';
		var tableClass = 'checkLEAList${UNQID}';
		compassDatatable.construct(tableClass, "CheckLEAList", true);
		compassDatatable.enableCheckBoxSelection();
		
		 $(".checkLEAList"+id).children("tbody").children("tr").each(function(){
		 ...
		 $(".listCodeLink").click(function(){
			...
			var url = "${pageContext.request.contextPath}/common/showLEAListDetails?listCode="+listCode;
			window.open(url,'LEA List Details','height=600px,width=1000px');
		}); 
	});
</script>
<style type="text/css">
...
<table class="table table-bordered table-striped checkLEAList${UNQID}" style="margin-bottom: 0px;">
	<thead>
		<tr>
			<th class="info no-sort" style="text-align: center;">
				<input type="checkbox" class="checkbox-check-all" compassTable="checkLEAList${UNQID}" id="checkLEAList${UNQID}" />
			</th>
