...
<script type="text/javascript">
	$(document).ready(function() {
		var id = '${UNQID}';
		compassTopFrame.init(id, 'actionedFilesTable'+id, 'dd/mm/yy');

		$('.panelSlidingActionedFiles'+id).on("click", function (e) {
			var mainRow = $(this).parents(".compassrow"+id);
			compassTopFrame.searchPanelSliding(id, mainRow, 'actionedFilesSerachResultPanel');
	    });
		
		$("#searchMasterForm"+id).submit(function(e){
			var submitButton = $("#searchActionedFiles"+id);
			compassTopFrame.submitForm(id, e, submitButton, 'actionedFilesSerachResultPanel', 
					'actionedFilesSerachResult', '${pageContext.request.contextPath}/common/searchGenericMaster',
...
<div class="row compassrow${UNQID}">
	<div class="col-sm-12">
		<div class="card card-primary panel_actionedFiles">
			<div class="card-header panelSlidingActionedFiles${UNQID} clearfix">
				<h6 class="card-title pull-${dirL}"><spring:message code="app.common.actionedFilesSearchHeader"/></h6>
			...
			<input type="hidden" name="bottomPageUrl" value="ManualFileUpload/ActionedFiles/SearchBottomPage">
			<div class="card-search-card" >
				<table class="table table-striped formSearchTable actionedFilesTable${UNQID}" style="margin-bottom: 0px;">
					<tbody>
			...
			<div class="card-footer clearfix">
				<div class="pull-${dirR}">
					<button  type="submit" id="searchActionedFiles${UNQID}" class="btn btn-primary btn-sm"><spring:message code="app.common.searchButton"/></button>
				</div>
			</div>
			</form>
			</div>
		</div>
		<div class="card card-primary" id="actionedFilesSerachResultPanel${UNQID}" style="display: none;">
			<div class="card-header panelSlidingActionedFiles${UNQID} clearfix">
				<h6 class="card-title pull-${dirL}"><spring:message code="app.common.actionedFilesResultHeader"/></h6>
				<div class="btn-group pull-${dirR} clearfix">
					<span class="pull-right"><i class="collapsable fa fa-chevron-up"></i></span>
				</div>
			</div>
			<div id="actionedFilesSerachResult${UNQID}"></div>
		</div>
	</div>
</div>	