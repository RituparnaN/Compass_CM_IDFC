...
<script type="text/javascript">
	$(document).ready(function() {
		...
		$("#scanDetails").click(function(){
			...
			var scanDrivingLicenseNo = $("#scanDrivingLicenseNo").val();
			var scanBirthCertificateNo = $("#scanBirthCertificateNo").val();
			...
			if(blackList == "N" && rejectList == "N" && customerDatabase == "N" && employeeDatabase == "N" && selectedBlackList == "N")
				...
				if(scanName1 == "" && scanName2 == "" && scanName3 == "" && scanName4 == "" && scanName5 == "" && 
						...
						scanDrivingLicenseNo == "" && scanBirthCertificateNo == ""){
					...
					var fullData = "NAME1="+scanName1+"&NAME2="+scanName2+"&NAME3="+scanName3+"&NAME4="+scanName4+"&NAME5="+scanName5+"&DATEOFBIRTH="+scanDOB+
					   "&PASSPORTNO="+scanPassportNo+"&PANNO="+scanPanNo+"&DRIVINGLICENSENO="+scanDrivingLicenseNo+"&BIRTHCERTIFICATENO="+scanBirthCertificateNo+
					   "&ACCOUNTNO="+scanAccountNo+"&CUSTOMERID="+scanCustomerId+"&userCode=NA&BlackListCheck="+blackList+
...
<div class="row compassrow${UNQID}">
	<div class="col-sm-12">
		...
		<div class="card card-primary" id="realTimeScanningFileAttachPanel${UNQID}">
			<div class="card-header panelSlidingRealTimeScanning${UNQID} clearfix">
				<h6 class="card-title pull-${dirL}">DataEntry Form &nbsp;<font color="#fad9d9" size="1px"><b>(Note: Only the star marked fields are available for the screening, others are for the record purpose only)</b></font></h6>
			</div>
			<div class="panelSearchForm">
			<form action="javascript:void(0)" method="POST" id="searchMasterForm${UNQID}">
				<table class="table table-bordered table-striped" style="margin-bottom: 0px;">
					<tr>
						<td width="15%">Name 1 <font color="red" size="4px"><b>*</b></font></td>
						<td width="30%">
							<input type="text" class="form-control input-sm replaceSplChar" id="scanName1" >
						</td>
						<td width="10%"></td>
						<td width="15%">Name 2 <font color="red" size="4px"><b>*</b></font></td>
						<td width="30%">
							<input type="text" class="form-control input-sm replaceSplChar" id="scanName2">
						</td>
					</tr>
					<tr>
						<td width="15%">Name 3 <font color="red" size="4px"><b>*</b></font></td>
						<td width="30%">
							<input type="text" class="form-control input-sm replaceSplChar" id="scanName3">
						</td>
						<td width="10%"></td>
						<td width="15%">Name 4 <font color="red" size="4px"><b>*</b></font></td>
						<td width="30%">
							<input type="text" class="form-control input-sm replaceSplChar" id="scanName4">
						</td>
					</tr>
					<tr>
						<td width="15%">Name 5 <font color="red" size="4px"><b>*</b></font></td>
						<td width="30%">
							<input type="text" class="form-control input-sm replaceSplChar" id="scanName5">
						</td>
						<td width="10%"></td>
					...
					<tr>
						<td width="15%">Passport No <font color="red" size="4px"><b>*</b></font></td>
						<td width="30%">
							<input type="text" class="form-control input-sm" id="scanPassportNo">
						</td>
						<td width="10%"></td>
						<td width="15%">Pan No <font color="red" size="4px"><b>*</b></font></td>
						<td width="30%">
							<input type="text" class="form-control input-sm" id="scanPanNo">
						</td>
					</tr>
					<tr>
						<td width="15%">DrivingLicenseNo <font color="red" size="4px"><b>*</b></font></td>
						<td width="30%">
							<input type="text" class="form-control input-sm" id="scanDrivingLicenseNo">
						</td>
						<td width="10%"></td>
						<td width="15%">BirthCertificateNo <font color="red" size="4px"><b>*</b></font></td>
						<td width="30%">
							<input type="text" class="form-control input-sm" id="scanBirthCertificateNo">
						</td>
					</tr>
					<tr>
