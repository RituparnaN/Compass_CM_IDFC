...
<TITLE>ListDetails</TITLE>
  <head>
	...
	<meta http-equiv="description" content="This is my page">
	   ...
	   <link type="text/css" href="/scripts/QDECommon.css" rel="stylesheet">
...
<tr valign="middle">
  ...
  <tr>
	   ...
	   if(!l_Column_Name[i].toString().equals("FURTHERINFORMATION1") && !l_Column_Name[i].toString().equals("FURTHERINFORMATION2") && !l_Column_Name[i].toString().equals("FURTHERINFORMATION3"))
	   {
		 ...
		 {  
		   %>
			...
			<TD align='left' wrap width='25%'><!--<font face="verdana" size="2" color="#FF0000">-->
		   <% 
   ...
   <br>
   <center>
   <input type='button' name='Print' value='PRINT' class="but1" onClick="printDetails('entriesDiv');">
