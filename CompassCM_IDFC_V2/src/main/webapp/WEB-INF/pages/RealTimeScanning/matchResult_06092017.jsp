...
<!--
	...
	function openPreviousComments(uniqueNumber){
		//alert(comment);
		var action = 'view';
		window.open('<%=contextPath%>/common/viewRTComments?action='+action+'&uniqueNumber='+uniqueNumber,'viewComments','width=600,height=200,left=300,top=350,screenX=250,screenY=300,OuterWidth=370,OuterHeight=150,resizable=yes,scrollbars=yes');
	}
...
<div class="row">
	<div class="col-sm-12">
							...
							<tr>
								<td width="50%">
									<table class="table table-bordered table-striped" style="margin-bottom: 0px;">
									    ...
									    %>
										<tr>
										  <td width="50%"><%=arrayParamsPart1Name[i].toString().equals("NAME1")?"NAME1":arrayParamsPart1Name[i].toString().equals("NAME2")?"NAME2":arrayParamsPart1Name[i].toString().equals("NAME3")?"NAME3":arrayParamsPart1Name[i].toString().equals("NAME4")?"NAME4":arrayParamsPart1Name[i].toString().equals("NAME5")?"NAME5":arrayParamsPart1Name[i].toString()%></td>
								...
								<td width="50%">
									<table class="table table-bordered table-striped" style="margin-bottom: 0px">		
										<% 
									      ...
									      %>
										<tr>
										  <td width="50%"><%=arrayParamsPart2Name[i].toString().equals("NAME1")?"NAME1":arrayParamsPart2Name[i].toString().equals("NAME2")?"NAME2":arrayParamsPart2Name[i].toString().equals("NAME3")?"NAME3":arrayParamsPart2Name[i].toString().equals("NAME4")?"NAME4":arrayParamsPart2Name[i].toString().equals("NAME5")?"NAME5":arrayParamsPart2Name[i].toString()%></td>
							...
							<tr>
								...
								<td width="30%">
									<div class="input-group" style="z-index: 1">
										...
										<span class="input-group-addon" id="basic-addon-filename${UNQID}" 
		...
		<div class="card card-primary">
						...
						<td width="20%">
							<table>
								<tr>
									...
									<td>&nbsp;&nbsp;</td>
									<td> 
										<input type=text name="EnterValue" size=2 maxsize =2><INPUT TYPE='button' NAME='callnextvalue' VALUE='GO' class="but" onClick="javascript:getAndSetNextValue()">
									</td>
									<% } %>
								</tr>
							</table>
			...
			String strUserComments = rtMatchResultVO.getUserComments();
			%>	
				<tr>
				<%
				...
				<td <%=strTempColumn%> width='5%' align='center' >
					<font size="2">
						<a href= "javascript:openSelectedListDetails('<%=rtMatchResultVO.getListName()+'~'+strNewMatchScore%>','<%=rtMatchResultVO.getListId()%>','<%=rtMatchResultVO.getUniqueNumber() == null ? "NA":rtMatchResultVO.getUniqueNumber().trim()%>')" title="click to view comments" >
				...
				<td <%=strTempColumn%> width='5%' align='center' data-toggle="tooltip" data-placement="auto"  title="<%=strNewMatchScore%>" data-container="body">
					<font size="2">
					<a href= "javascript:openPreviousComments('<%=rtMatchResultVO.getUniqueNumber()%>')">
					<%=strNewMatchScore%>
					</font>
				</td>
				<% } else { %>
