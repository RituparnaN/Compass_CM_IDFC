...
<script type="text/javascript">
	$(document).ready(function(){
		...
		compassDatatable.construct(tableClass, "TransactionDetails", true);
		...
		$("#generateSubjectiveAlert"+id).click(function(){
			var tnxNo = $("#moduleValue"+id).val();
			window.open("${pageContext.request.contextPath}/common/openSubjectiveAlertWindow?transactionNo="+tnxNo,
						"Generate_Subjective_Alert","height=500,width=1250,scrollbars=1,resizable=Yes");
		});
					...
					<div class="col-sm-6">
						<div class="card-body" style="text-align: center; padding: 5px 0px;">
							...
							<table class="table compassModuleDetailsSearchTable" style="margin-bottom: 0px;">
								<tr>
									<td width="30%"><spring:message code="app.common.TRANSACTIONNO"/></td>
									<td width="30%"><input type="text" class="form-control input-sm" name="moduleValue" id="moduleValue${UNQID}" value="${moduleValue}"/></td>
									...
									<td width="20%"><button type="button" class="btn btn-warning btn-sm" id="generateSubjectiveAlert${UNQID}"><spring:message code="app.common.generateSubjectiveAlert"/></button></td>
								</tr>
							</table>
						</div>
					</div>
