								...
								<c:when test="${LABELSITRCOUNT % 2 == 0}">
									<tr>
										...
										<td width="30%">
											...
											<c:choose>
												<c:when test="${CALLFROMACCOUNTSMASTER == 'Yes'}">
													<div class="input-group" style="z-index: 1">
														...
														onclick="moduleSearch('${ALLLABELSMAP['MODULEPARAMIDNAME']}_${UNQID}','${ALLLABELSMAP['MODULEPARAMIDNAME']}','${ALLLABELSMAP['MODULEPARAMVIEWNAME']}','${ALLLABELSMAP['SEARCHMULTIPLESELECT']}','${pageContext.request.contextPath}')" style="cursor: pointer;" title="Search">
