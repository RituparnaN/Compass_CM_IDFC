...
<script type="text/javascript">
	$(document).ready(function() {
		var id = '${UNQID}';
		compassTopFrame.init(id, 'productsMasterTable', 'dd/mm/yy');
		
		$('.panelSlidingProductsMaster'+id).on("click", function (e) {
			var mainRow = $(this).parents(".compassrow"+id);
			compassTopFrame.searchPanelSliding(id, mainRow, 'productsMasterSearchResultPanel');
	    });
		
		$("#searchMasterForm"+id).submit(function(e){
			var submitButton = $("#searchProductsMaster"+id);
			compassTopFrame.submitForm(id, e, submitButton, 'productsMasterSearchResultPanel', 
					'productsMasterSearchResult', '${pageContext.request.contextPath}/common/searchGenericMaster',
...
<div class="row compassrow${UNQID}">
	<div class="col-sm-12">
		<div class="card card-primary panel_productsMaster">
			<div class="card-header panelSlidingProductsMaster${UNQID} clearfix">
				<h6 class="card-title pull-${dirL}"><spring:message code="app.common.productSearchHeader"/></h6>
			...
			<input type="hidden" name="bottomPageUrl" value="MasterModules/ProductsMaster/SearchBottomPage">
			<div class="card-search-card" >
				<table class="table table-striped formSearchTable productsMasterTable" style="margin-bottom: 0px;">
					<tbody>
			...
			<div class="card-footer clearfix">
				<div class="pull-${dirR}">
					<button type="submit" id="searchProductsMaster${UNQID}" class="btn btn-success btn-sm"><spring:message code="app.common.searchButton"/></button>
					<!--  28.05.2019 -->
		...
		<div class="card card-primary" id="productsMasterSearchResultPanel${UNQID}" style="display: none;">
			<div class="card-header panelSlidingProductsMaster${UNQID} clearfix">
				<h6 class="card-title pull-${dirL}"><spring:message code="app.common.productResultHeader"/></h6>
				<div class="btn-group pull-${dirR} clearfix">
					<span class="pull-right"><i class="collapsable fa fa-chevron-up"></i></span>
				</div>
			</div>
			<div id="productsMasterSearchResult${UNQID}"></div>
		</div>
	</div>
</div>
