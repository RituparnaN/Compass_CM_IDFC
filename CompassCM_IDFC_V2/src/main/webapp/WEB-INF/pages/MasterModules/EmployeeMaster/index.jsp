...
<script type="text/javascript">
	$(document).ready(function() {
		var id = '${UNQID}';
		compassTopFrame.init(id, 'employeeMasterTable', 'dd/mm/yy');
		
		$('.panelSlidingEmployeeMaster'+id).on("click", function (e) {
			var mainRow = $(this).parents(".compassrow"+id);
			compassTopFrame.searchPanelSliding(id, mainRow, 'employeeMasterSearchResultPanel');
		});
		
		$("#searchEmployeeMaster"+id).click(function(e){
			var submitButton = $("#searchEmployeeMaster"+id);
			compassTopFrame.submitForm(id, e, submitButton, 'employeeMasterSearchResultPanel', 'employeeMasterSearchResult',
...
<div class="row compassrow${UNQID}">
	<div class="col-sm-12">
		<div class="card card-primary panel_employeeMaster">
			<div class="card-header panelSlidingEmployeeMaster${UNQID} clearfix">
				<h6 class="card-title pull-${dirL}"><spring:message code="app.common.EmployeeMasterSearchHeader"/></h6>
			...
			<input type="hidden" name="bottomPageUrl" value="MasterModules/EmployeeMaster/SearchBottomPage">
			<div class="card-search-card" >
				<table class="table table-striped formSearchTable employeeMasterTable" style="margin-bottom: 0px;">
					<tbody>
			...
			<div class="card-footer clearfix">
				<div class="pull-${dirR}">
					<button  type="submit" id="searchEmployeeMaster${UNQID}" class="btn btn-success btn-sm"><spring:message code="app.common.searchButton"/></button>
					<!--  28.05.2019 -->
		...
		<div class="card card-primary" id="employeeMasterSearchResultPanel${UNQID}" style="display: none;">
			<div class="card-header panelSlidingEmployeeMaster${UNQID} clearfix">
				<h6 class="card-title pull-${dirL}">Employee Master Result</h6>
				<div class="btn-group pull-${dirR} clearfix">
					<span class="pull-right"><i class="collapsable fa fa-chevron-up"></i></span>
				</div>
			</div>
			<div id="employeeMasterSearchResult${UNQID}"></div>
		</div>
	</div>
</div>
