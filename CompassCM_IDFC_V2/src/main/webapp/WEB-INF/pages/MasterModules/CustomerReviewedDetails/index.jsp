...
<script type="text/javascript">
	$(document).ready(function() {
		var id = '${UNQID}';
		compassTopFrame.init(id, 'customerReviewedDetailsTable', 'dd/mm/yy');
		
		$('.panelSlidingCustomerReviewedDetails'+id).on("click", function (e) {
			var mainRow = $(this).parents(".compassrow"+id);
			compassTopFrame.searchPanelSliding(id, mainRow, 'customerReviewedDetailsSerachResultPanel');
		});
		
		$("#searchMasterForm"+id).submit(function(e){
			var submitButton = $("#searchCustomerReviewedDetails"+id);
			compassTopFrame.submitForm(id, e, submitButton, 'customerReviewedDetailsSerachResultPanel',
					'customerReviewedDetailsSerachResult', '${pageContext.request.contextPath}/common/searchGenericMaster', 
...
<div class="row compassrow${UNQID}">
	<div class="col-sm-12">
		<div class="card card-primary panel_customerReviewedDetails">
			<div class="card-header panelSlidingCustomerReviewedDetails${UNQID} clearfix">
				<h6 class="card-title pull-${dirL}"><spring:message code="app.common.CustomerReviewedDetailsSearchHeader"/></h6>
			...
			<input type="hidden" name="bottomPageUrl" value="MasterModules/CustomerReviewedDetails/SearchBottomPage">
			<div class="card-search-card" >
				<table class="table table-striped formSearchTable customerReviewedDetailsTable" style="margin-bottom: 0px;">
					<tbody>
			...
			<div class="card-footer clearfix">
				<div class="pull-${dirR}">
					<button  type="submit" id="searchCustomerReviewedDetails${UNQID}" class="btn btn-success btn-sm"><spring:message code="app.common.searchButton"/></button>
					<!--  28.05.2019 -->
		...
		<div class="card card-primary" id="customerReviewedDetailsSerachResultPanel${UNQID}" style="display: none;">
			<div class="card-header panelSlidingCustomerReviewedDetails${UNQID} clearfix">
				<h6 class="card-title pull-${dirL}">Customer Reviewed Details Result</h6>
				<div class="btn-group pull-${dirR} clearfix">
					<span class="pull-right"><i class="collapsable fa fa-chevron-up"></i></span>
				</div>
			</div>
			<div id="customerReviewedDetailsSerachResult${UNQID}"></div>
		</div>
	</div>
</div>
