...
<script type="text/javascript">
	$(document).ready(function() {
		var id = '${UNQID}';
		compassTopFrame.init(id, 'instrumentMasterTable', 'dd/mm/yy');
		
		$('.panelSlidingInstrumentMaster'+id).on("click", function (e) {
			var mainRow = $(this).parents(".compassrow"+id);
			compassTopFrame.searchPanelSliding(id, mainRow, 'instrumentMasterSearchResultPanel');
	    });
		
		$("#searchMasterForm"+id).submit(function(e){
			var submitButton = $("#searchInstrumentMaster"+id);
			compassTopFrame.submitForm(id, e, submitButton, 'instrumentMasterSearchResultPanel', 
					'instrumentMasterSearchResult', '${pageContext.request.contextPath}/common/searchGenericMaster',
...
<div class="row compassrow${UNQID}">
	<div class="col-sm-12">
		<div class="card card-primary panel_instrumentMaster">
			<div class="card-header panelSlidingInstrumentMaster${UNQID} clearfix">
				<h6 class="card-title pull-${dirL}"><spring:message code="app.common.instrumentSearchHeader"/></h6>
			...
			<input type="hidden" name="bottomPageUrl" value="MasterModules/InstrumentMaster/SearchBottomPage">
			<div class="card-search-card" >
				<table class="table table-striped formSearchTable instrumentMasterTable" style="margin-bottom: 0px;">
					<tbody>
			...
			<div class="card-footer clearfix">
				<div class="pull-${dirR}">
					<button type="submit" id="searchInstrumentMaster${UNQID}" class="btn btn-success btn-sm">Search</button>
					<!--  28.05.2019 -->
		...
		<div class="card card-primary" id="instrumentMasterSearchResultPanel${UNQID}" style="display: none;">
			<div class="card-header panelSlidingInstrumentMaster${UNQID} clearfix">
				<h6 class="card-title pull-${dirL}"><spring:message code="app.common.instrumentResultHeader"/></h6>
				<div class="btn-group pull-${dirR} clearfix">
					<span class="pull-right"><i class="collapsable fa fa-chevron-up"></i></span>
				</div>
			</div>
			<div id="instrumentMasterSearchResult${UNQID}"></div>
		</div>
	</div>
</div>
