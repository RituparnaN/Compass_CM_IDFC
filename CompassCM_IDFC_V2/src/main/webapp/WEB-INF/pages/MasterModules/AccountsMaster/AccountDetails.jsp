...
<script type="text/javascript">
	$(document).ready(function(){
		...
		compassDatatable.construct(tableClass, "AccountDetails", true);
		...
		$("#transactionButton").click(function(){
			...
			var accountNo = $(".compassModuleDetailsSearchTable").find("input#moduleValue"+id).val();
		...
		<div class="col-sm-12">
			<div class="card card-primary">
				<div class="row">
					...
					<div class="col-sm-6">
						<div class="card-body" style="text-align: center; padding: 5px 0px;">
							...
							<table class="table compassModuleDetailsSearchTable" style="margin-bottom: 0px;">
								<tr>
									<td width="30%"><spring:message code="app.common.ACCOUNTNO"/></td>
					...
					<div class="col-sm-3" style="padding: 13px 0px;">
						<button type="button" class="btn btn-primary btn-sm" id="transactionButton">View Transactions</button>
					</div>
				</div>
			</div>
		</div>
