...
<script type="text/javascript">
	$(document).ready(function() {
		...
		$('.panelSlidingAccountsMaster'+id).on("click", function (e) {
			var mainRow = $(this).parents(".compassrow"+id);
			compassTopFrame.searchPanelSliding(id, mainRow, 'accountsMasterSearchResultPanel');
	    });
		
		$("#searchMasterForm"+id).submit(function(e){
			var submitButton = $("#searchAccountsMaster"+id);
			compassTopFrame.submitForm(id, e, submitButton, 'accountsMasterSearchResultPanel', 
...
<div class="row compassrow${UNQID}">
	<div class="col-sm-12">
		<div class="card card-primary panel_accountsMaster">
			<div class="card-header panelSlidingAccountsMaster${UNQID} clearfix">
				<h6 class="card-title pull-${dirL}"><spring:message code="app.common.accountSearchHeader"/></h6>
			...
			<input type="hidden" name="bottomPageUrl" value="MasterModules/AccountsMaster/SearchBottomPage">
			<div class="card-search-card" >
				<table class="table table-striped formSearchTable accountsMasterTable" style="margin-bottom: 0px;">
					<tbody>
			...
			<div class="card-footer clearfix">
				<div class="pull-${dirR}">
					<button  type="submit" id="searchAccountsMaster${UNQID}" class="btn btn-success btn-sm"><spring:message code="app.common.searchButton"/></button>
					<!--  28.05.2019 -->
		...
		<div class="card card-primary" id="accountsMasterSearchResultPanel${UNQID}" style="display: none;">
			<div class="card-header panelSlidingAccountsMaster${UNQID} clearfix">
