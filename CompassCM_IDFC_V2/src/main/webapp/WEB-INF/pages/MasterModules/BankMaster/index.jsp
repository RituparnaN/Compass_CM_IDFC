...
<script type="text/javascript">
	$(document).ready(function() {
		var id = '${UNQID}';
		compassTopFrame.init(id, 'bankMasterTable', 'dd/mm/yy');
		
		$('.panelSlidingBankMaster'+id).on("click", function (e) {
			var mainRow = $(this).parents(".compassrow"+id);
			compassTopFrame.searchPanelSliding(id, mainRow, 'bankMasterSearchResultPanel');
	    });
		
		$("#searchMasterForm"+id).submit(function(e){
			var submitButton = $("#searchBankMaster"+id);
			compassTopFrame.submitForm(id, e, submitButton, 'bankMasterSearchResultPanel', 
					'bankMasterSearchResult', '${pageContext.request.contextPath}/common/searchGenericMaster',
...
<div class="row compassrow${UNQID}">
	<div class="col-sm-12">
		<div class="card card-primary panel_bankMaster">
			<div class="card-header panelSlidingBankMaster${UNQID} clearfix">
				<h6 class="card-title pull-${dirL}">Bank Master</h6>
			...
			<input type="hidden" name="bottomPageUrl" value="MasterModules/BankMaster/SearchBottomPage">
			<div class="card-search-card" >
				<table class="table table-striped formSearchTable bankMasterTable" style="margin-bottom: 0px;">
					<tbody>
			...
			<div class="card-footer clearfix">
				<div class="pull-${dirR}">
					<button type="submit" id="searchBankMaster${UNQID}" class="btn btn-success btn-sm">Search</button>
					<!--  28.05.2019 -->
		...
		<div class="card card-primary" id="bankMasterSearchResultPanel${UNQID}" style="display: none;">
			<div class="card-header panelSlidingBankMaster${UNQID} clearfix">
				<h6 class="card-title pull-${dirL}">Bank Master Result</h6>
				<div class="btn-group pull-${dirR} clearfix">
					<span class="pull-right"><i class="collapsable fa fa-chevron-up"></i></span>
				</div>
			</div>
			<div id="bankMasterSearchResult${UNQID}"></div>
		</div>
	</div>
</div>
