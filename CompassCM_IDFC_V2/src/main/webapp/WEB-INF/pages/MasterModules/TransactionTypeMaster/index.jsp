...
<script type="text/javascript">
	$(document).ready(function() {
		var id = '${UNQID}';
		compassTopFrame.init(id, 'transactionTypeMasterTable', 'dd/mm/yy');
		
		$('.panelSlidingTransactionTypeMaster'+id).on("click", function (e) {
			var mainRow = $(this).parents(".compassrow"+id);
			compassTopFrame.searchPanelSliding(id, mainRow, 'transactionTypeMasterSearchResultPanel');
	    });
		
		$("#searchMasterForm"+id).submit(function(e){
			var submitButton = $("#searchTransactionTypeMaster"+id);
			compassTopFrame.submitForm(id, e, submitButton, 'transactionTypeMasterSearchResultPanel', 
					'transactionTypeMasterSearchResult', '${pageContext.request.contextPath}/common/searchGenericMaster',
...
<div class="row compassrow${UNQID}">
	<div class="col-sm-12">
		<div class="card card-primary panel_transactionTypeMaster">
			<div class="card-header panelSlidingTransactionTypeMaster${UNQID} clearfix">
				<h6 class="card-title pull-${dirL}"><spring:message code="app.common.transactionTypeSearchHeader"/></h6>
			...
			<input type="hidden" name="bottomPageUrl" value="MasterModules/TransactionTypeMaster/SearchBottomPage">
			<div class="card-search-card" >
				<table class="table table-striped formSearchTable transactionTypeMasterTable" style="margin-bottom: 0px;">
					<tbody>
			...
			<div class="card-footer clearfix">
				<div class="pull-${dirR}">
					<button type="submit" id="searchTransactionTypeMaster${UNQID}" class="btn btn-success btn-sm"><spring:message code="app.common.searchButton"/></button>
					<!--  28.05.2019 -->
		...
		<div class="card card-primary" id="transactionTypeMasterSearchResultPanel${UNQID}" style="display: none;">
			<div class="card-header panelSlidingTransactionTypeMaster${UNQID} clearfix">
				<h6 class="card-title pull-${dirL}"><spring:message code="app.common.transactionTypeResultHeader"/></h6>
				<div class="btn-group pull-${dirR} clearfix">
					<span class="pull-right"><i class="collapsable fa fa-chevron-up"></i></span>
				</div>
			</div>
			<div id="transactionTypeMasterSearchResult${UNQID}"></div>
		</div>
	</div>
</div>
