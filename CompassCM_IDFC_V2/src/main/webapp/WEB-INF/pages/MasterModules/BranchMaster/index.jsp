...
<script type="text/javascript">
	$(document).ready(function() {
		var id = '${UNQID}';
		compassTopFrame.init(id, 'branchMasterTable', 'dd/mm/yy');
		
		$('.panelSlidingBranchMaster'+id).on("click",function (e) {
			var mainRow=$(this).parents(".compassrow"+id);
			compassTopFrame.searchPanelSliding(id, mainRow, 'branchMasterSearchResultPanel');
		});
		
		$("#searchMasterForm"+id).submit(function(e){
			var submitButton = $("#searchBranchMaster"+id);
			compassTopFrame.submitForm(id, e, submitButton, 'branchMasterSearchResultPanel',
					'branchMasterSearchResult','${pageContext.request.contextPath}/common/searchGenericMaster',
...
<div class="row compassrow${UNQID}">
	<div class="col-sm-12">
		<div class="card card-primary panel_branchMaster">
			<div class="card-header panelSlidingBranchMaster${UNQID} clearfix">
				<h6 class="card-title pull-${dirL}"><spring:message code="app.common.branchSearchHeader"/></h6>
			...
			<input type="hidden" name="bottomPageUrl" value="MasterModules/BranchMaster/SearchBottomPage">
			<div class="card-search-card" >
				<table class="table table-striped formSearchTable branchMasterTable" style="margin-bottom: 0px;">
					<tbody>
			...
			<div class="card-footer clearfix">
				<div class="pull-${dirR}">
					<button  type="submit" id="searchBranchMaster${UNQID}" class="btn btn-success btn-sm"><spring:message code="app.common.searchButton"/></button>
					<!--  28.05.2019 -->
		...
		<div class="card card-primary" id="branchMasterSearchResultPanel${UNQID}" style="display: none;">
			<div class="card-header panelSlidingBranchMaster${UNQID} clearfix">
				<h6 class="card-title pull-${dirL}"><spring:message code="app.common.branchResultHeader"/></h6>
				<div class="btn-group pull-${dirR} clearfix">
					<span class="pull-right"><i class="collapsable fa fa-chevron-up"></i></span>
				</div>
			</div>
			<div id="branchMasterSearchResult${UNQID}"></div>
		</div>
	</div>
</div>
