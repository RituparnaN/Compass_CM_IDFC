...
<script type="text/javascript">
	$(document).ready(function() {
		var id = '${UNQID}';
		compassTopFrame.init(id, 'customerTypeMasterTable', 'dd/mm/yy');		
		
		$('.panelSlidingCustomerTypeMaster'+id).on("click", function (e) {
			var mainRow = $(this).parents(".compassrow"+id);
			compassTopFrame.searchPanelSliding(id, mainRow, 'customerTypeMasterSearchResultPanel');
		});
		
		$("#searchMasterForm"+id).submit(function(e){
			var submitButton = $('#searchCustomerTypeMaster'+id);		
			compassTopFrame.submitForm(id, e, submitButton, 'customerTypeMasterSearchResultPanel', 
					'customerTypeMasterSearchResult', '${pageContext.request.contextPath}/common/searchGenericMaster', 
...
<div class="row compassrow${UNQID}">
	<div class="col-sm-12">
		<div class="card card-primary panel_customerTypeMaster">
			<div class="card-header panelSlidingCustomerTypeMaster${UNQID} clearfix">
				<h6 class="card-title pull-${dirL}"><spring:message code="app.common.CustomerTypeSearchHeader"/></h6>
			...
			<input type="hidden" name="bottomPageUrl" value="MasterModules/CustomerTypeMaster/SearchBottomPage">
			<div class="card-search-card" >
				<table class="table table-striped formSearchTable customerTypeMasterTable" style="margin-bottom: 0px;">
					<tbody>
			...
			<div class="card-footer clearfix">
				<div class="pull-${dirR}">
					<button  type="submit" id="searchCustomerTypeMaster${UNQID}" class="btn btn-success btn-sm"><spring:message code="app.common.searchButton"/></button>
					<!--  28.05.2019 -->
		...
		<div class="card card-primary" id="customerTypeMasterSearchResultPanel${UNQID}" style="display: none;">
			<div class="card-header panelSlidingCustomerTypeMaster${UNQID} clearfix">
				<h6 class="card-title pull-${dirL}">CustomerType Master Result</h6>
				<div class="btn-group pull-${dirR} clearfix">
					<span class="pull-right"><i class="collapsable fa fa-chevron-up"></i></span>
				</div>
			</div>
			<div id="customerTypeMasterSearchResult${UNQID}"></div>
		</div>
	</div>
</div>
