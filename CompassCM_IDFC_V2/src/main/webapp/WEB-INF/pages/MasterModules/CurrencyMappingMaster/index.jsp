...
<script type="text/javascript">
	$(document).ready(function() {
		var id = '${UNQID}';
		compassTopFrame.init(id, 'currencyMappingMasterTable', 'dd/mm/yy');
		
		$('.panelSlidingCurrencyMappingMaster'+id).on("click", function(e){
			var mainRow = $(this).parents(".compassrow"+id);
			compassTopFrame.searchPanelSliding(id, mainRow, 'currencyMappingMasterSearchResultPanel');		
		});
		
		$("#searchMasterForm"+id).submit(function(e){
			var submitButton = $("#searchCurrencyMappingMaster"+id);
			compassTopFrame.submitForm(id, e, submitButton,'currencyMappingMasterSearchResultPanel',
					'currencyMappingMasterSearchResult','${pageContext.request.contextPath}/common/searchGenericMaster',
...
<div class="row compassrow${UNQID}">
	<div class="col-sm-12">
		<div class="card card-primary panel_currencyMappingMaster">
			<div class="card-header panelSlidingCurrencyMappingMaster${UNQID} clearfix">
				<h6 class="card-title pull-${dirL}"><spring:message code="app.common.currencyMappingSearchHeader"/></h6>
			...
			<input type="hidden" name="bottomPageUrl" value="MasterModules/CurrencyMappingMaster/SearchBottomPage">
			<div class="card-search-card" >
				<table class="table table-striped formSearchTable currencyMappingMasterTable" style="margin-bottom: 0px;">
					<tbody>
			...
			<div class="card-footer clearfix">
				<div class="pull-${dirR}">
					<button  type="submit" id="searchCurrencyMappingMaster${UNQID}" class="btn btn-success btn-sm"><spring:message code="app.common.searchButton"/></button>
					<!--  28.05.2019 -->
		...
		<div class="card card-primary" id="currencyMappingMasterSearchResultPanel${UNQID}" style="display: none;">
			<div class="card-header panelSlidingCurrencyMappingMaster${UNQID} clearfix">
				<h6 class="card-title pull-${dirL}">CurrencyMapping Master Result</h6>
				<div class="btn-group pull-${dirR} clearfix">
					<span class="pull-right"><i class="collapsable fa fa-chevron-up"></i></span>
				</div>
			</div>
			<div id="currencyMappingMasterSearchResult${UNQID}"></div>
		</div>
	</div>
</div>
