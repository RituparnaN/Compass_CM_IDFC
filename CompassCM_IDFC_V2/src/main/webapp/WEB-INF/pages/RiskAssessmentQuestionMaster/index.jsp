...
<script type="text/javascript">
	$(document).ready(function() {
		...
		$("#searchMasterForm"+id).submit(function(e){
			var submitButton = $("#searchQuestionButton"+id);
			//console.log(submitButton);
			compassTopFrame.submitForm(id, e, submitButton, 'riskAssesssmentQuestionListmaster', 
					'riskAssessmentQuestionSearchResult', '${pageContext.request.contextPath}/common/searchGenericMaster',
	...
	<div class="col-sm-12">
		<div class="card card-primary panel_riskAssessmentQuestionList">
			<div class="card-header panelSlidingQuestionList${UNQID} clearfix">
				<h6 class="card-title pull-${dirL}">Question List</h6>
			...
			<input type="hidden" name="bottomPageUrl" value="RiskAssessmentQuestionMaster/SearchBottomPage">
			<div class="card-search-card" >
				<table class="table table-striped formSearchTable riskAssessmentQuestionList" style="margin-bottom: 0px;">
					<tbody>
			...
			<div class="card-footer clearfix">
				<div class="pull-${dirR}">
					<button type="submit" id="searchQuestionButton${UNQID}" class="btn btn-success btn-sm">Search</button>
				</div>
			</div>
			</form>
			</div>
		</div>
		<div class="card card-primary" id="riskAssesssmentQuestionListmaster${UNQID}" style="display: none;">
			<div class="card-header panelSlidingQuestionList${UNQID} clearfix">
				<h6 class="card-title pull-${dirL}">Question List Result</h6>
				<div class="btn-group pull-${dirR} clearfix">
					<span class="pull-right"><i class="collapsable fa fa-chevron-up"></i></span>
				</div>
			</div>
			<div id="riskAssessmentQuestionSearchResult${UNQID}"></div>
		</div>
	</div>
</div>
