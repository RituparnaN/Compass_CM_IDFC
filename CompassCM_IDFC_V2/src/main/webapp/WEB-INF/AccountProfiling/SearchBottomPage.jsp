...
<div id="searchResultGenericDiv">
	...
	<div>
		<input type="hidden" name="1_FROMDATE" id="AP_FROMDATE" value="${FROMDATE}">
		<input type="hidden" name="2_TODATE" id="AP_TODATE" value="${TODATE}">
		<input type="hidden" name="4_CUSTOMERID" id="AP_CUSTOMERID" value="${CUSTOMERID}">
	</div>
</div>