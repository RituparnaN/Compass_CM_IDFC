...
<script type="text/javascript">
	$(document).ready(function(){
		var id = '${UNQID}';
		var tableClass = 'nonCashTxnDetailsTable'+id;
		compassDatatable.construct(tableClass, "AccountProfileDetails_Non_Cash_Txn_Details", true);
	...
	<div class="row">
		<div class="col-sm-12">
			<div class="card card-primary">
				<div class="card-header panelSlidingAccountProfileNonCash${UNQID} clearfix">
					<h6 class="card-title pull-${dirL}">${COUNTERPARTYNAME}</h6>
				</div>
				<table class="table table-bordered">
					<c:set var="RECORDCOUNT" value="${f:length(WHOLEDATA)}" scope="page"/>
					<c:choose>
						<c:when test="${RECORDCOUNT > 0}">
							<table class="table table-striped table-bordered searchResultGenericTable nonCashTxnDetailsTable${UNQID}">
								<thead>
