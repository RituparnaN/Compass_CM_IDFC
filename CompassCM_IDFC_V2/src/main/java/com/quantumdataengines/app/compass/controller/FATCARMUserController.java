...
@Controller
@RequestMapping(value="/fatcarmuser")
public class FATCARMUserController {
private static final Logger log = LoggerFactory.getLogger(AdminController.class);
	...
	public String getUserIndex(HttpServletRequest request, HttpServletResponse response, 
		...
		log.info("Opening FATCARMUser index for : "+domainUser.getFirstName()+" "+domainUser.getLastName());
		return "fatcaRMUserIndexTemplete";
	}
}
