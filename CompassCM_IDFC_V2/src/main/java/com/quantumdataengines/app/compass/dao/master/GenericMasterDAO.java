...
public interface GenericMasterDAO {
	...
	//for enable and disable columns..
	...
	public Map<String, Object> fetchAlertNoTxnNoMappings(String alertNo, String userCode, String userRole,
			String ipAddress);
	public Map<String, Object> fetchAccountNoBasedTransactions(String accountNo, String fromDate, String toDate,
