...
@Component
public class CompassAuthenticationProvider_Correct_11022019_ToRevertAfterLoadTesting implements AuthenticationProvider{

	private static final Logger log = LoggerFactory.getLogger(CompassAuthenticationProvider_Correct_11022019_ToRevertAfterLoadTesting.class);
	@Autowired
