...
public interface FalsePositiveService {
	...
	public Map<String, Object> addFalsePositive(String custId, String accNo, String alertCode, String alertMsg, 
			String activeFrom, String activeTo, String isEnabled, String reason, String adminComments, String toleranceLevel, String status, String userCode, String CURRENTROLE);
	...
	public String approveFalsePositive(String selectedCustId, String selectedAccNo, String selectedAlertCode, String selectedAlertMessage, String selectedActiveFrom, String selectedActiveTo,
