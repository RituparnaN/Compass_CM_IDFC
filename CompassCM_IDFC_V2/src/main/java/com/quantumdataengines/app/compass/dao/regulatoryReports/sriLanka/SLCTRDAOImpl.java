...
@Repository
public class SLCTRDAOImpl implements SLCTRDAO{
	private static final Logger log = LoggerFactory.getLogger(SLCTRDAOImpl.class);
	@Autowired
	...
	public Connection getConnection(){
		...
		try{
			...
			log.error("Error in creating db connection : SLCTRDAOImpl -> "+e.getMessage());
			e.printStackTrace();
		}
		return connection;
	}
	...
	public String generateSLCTRReportingFile(String reportType, String reportingFileType, String fortNightOfReporting, String monthOfReporting, String yearOfReporting, String thresholdAmount, String userId){
        ...
        try {
        	...
        	log.error("Error in SLCTRDAOImpl->generateSLRegulatoryXML "+reportType+" : "+e.getMessage());
        	e.printStackTrace();
        }finally{
	...
	public List<String> getSLRegReportFileData(String tableName){
    	...
    	try{
    		...
    		log.error("Error in SLCTRDAOImpl->getSLRegReportFileData "+tableName+" : "+e.getMessage());
        	e.printStackTrace();
    	}finally{
