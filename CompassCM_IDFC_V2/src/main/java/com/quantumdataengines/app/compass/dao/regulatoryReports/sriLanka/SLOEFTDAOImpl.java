...
@Repository
public class SLOEFTDAOImpl implements SLOEFTDAO{
	private static final Logger log = LoggerFactory.getLogger(SLOEFTDAOImpl.class);
	@Autowired
	...
	public Connection getConnection(){
		...
		try{
			...
			log.error("Error in creating db connection : SLOEFTDAOImpl -> "+e.getMessage());
			e.printStackTrace();
		}
		return connection;
	}
	...
	public String generateSLOEFTReportingFile(String reportType, String reportingFileType, String fortNightOfReporting, String monthOfReporting, String yearOfReporting, String thresholdAmount, String userId){
        ...
        try {
        	...
        	log.error("Error in SLOEFTDAOImpl->generateSLRegulatoryXML "+reportType+" : "+e.getMessage());
        	e.printStackTrace();
        }finally{
	...
	public List<String> getSLRegReportFileData(String tableName){
    	...
    	try{
    		...
    		log.error("Error in SLOEFTDAOImpl->getSLRegReportFileData "+tableName+" : "+e.getMessage());
        	e.printStackTrace();
    	}finally{
