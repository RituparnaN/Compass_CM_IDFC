...
@Controller
@RequestMapping(value="/fatcamanager")
public class FATCAManagerController {
private static final Logger log = LoggerFactory.getLogger(AdminController.class);
	...
	public String getUserIndex(HttpServletRequest request, HttpServletResponse response, 
		...
		log.info("Opening FATCAManager index for : "+domainUser.getFirstName()+" "+domainUser.getLastName());
		return "fatcaManagerIndexTemplete";
	}
}
