...
public interface AdminMakerService {
	...
	public List<Map<String, String>> createIPAddress(String ipAddress, String systemName, String createdBy);
	...
	public List<Map<String, String>> getAllUserForGroupMapping(String loggedInUsercodes);
	...
	public String assignRoleModules(String userCode, List<String> roles, Map<String, List<String>> modules, String createdBy);
	
	public Map<String, Map<String, Map<String, Object>>> getAllUserForRoleMapping(String roleId);
	public Map<String, String> assingRoleToUserByRole(String roleId, List<String> selectedUser, List<String> unSelectedUser, String createdBy);
	...
	public String createUserWithRole(String userCode, String userPass, String firstName, String lastName,
			...
			String accessStartTime, String accessEndTime, String passwordExpiry, String accountExpiryDate, 
			String chatEnabled, String BRANCHCODE, String ISETLUSER, String groupCode, String createdBy);
