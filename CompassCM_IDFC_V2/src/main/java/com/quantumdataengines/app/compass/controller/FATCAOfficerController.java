...
@Controller
@RequestMapping(value="/fatcaofficer")
public class FATCAOfficerController {
private static final Logger log = LoggerFactory.getLogger(AdminController.class);
	...
	public String getUserIndex(HttpServletRequest request, HttpServletResponse response, 
		...
		log.info("Opening FATCAOfficer index for : "+domainUser.getFirstName()+" "+domainUser.getLastName());
		return "fatcaOfficerIndexTemplete";
	}
}
