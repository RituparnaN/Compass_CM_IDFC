...
@Controller
@RequestMapping(value="/amlrep")
public class AMLRepController {
private static final Logger log = LoggerFactory.getLogger(AdminController.class);
	...
	public String getUserIndex(HttpServletRequest request, HttpServletResponse response, 
		...
		log.info("Opening AMLRep index for : "+domainUser.getFirstName()+" "+domainUser.getLastName());
		return "amlRepIndexTemplete";
	}
}
