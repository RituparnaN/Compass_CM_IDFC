...
@Controller
@RequestMapping(value="/leachecker")
public class LEACheckerController {
private static final Logger log = LoggerFactory.getLogger(AdminController.class);
	...
	public String getUserIndex(HttpServletRequest request, HttpServletResponse response, 
		...
		log.info("Opening LEAChecker index for : "+domainUser.getFirstName()+" "+domainUser.getLastName());
		return "leaCheckerIndexTemplete";
	}
}
