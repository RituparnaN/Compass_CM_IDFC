...
public class CompassEncryptorDecryptorNew {
	
	private static final Logger log = LoggerFactory.getLogger(CompassEncryptorDecryptorNew.class);
    ...
    public static void main(String args[]){
    	...
    	System.out.println(decryptor.decrypt("oTklmelMcPJQgZ8AgHi+qbcEv7mEhGwc"));
